...
!(function (t, e) {
  ...
  ((e = w.prototype).axisX = function (t, e, i) {
    ...
    (e.generateTicks = function (t) {
      ...
      return n.length > 0 && n[0] > 0 && n.unshift(n[0] - (n[1] - n[0])), n;
    }),
    ...
    (e.tspanData = function (t, e, i) {
      var n = this,
        a = n.params.tickMultiline
          ? n.splitTickText(t, i)
          : [].concat(n.textFormatted(t));
      return (
        n.params.tickMultiline &&
          n.params.tickMultilineMax > 0 &&
          (a = n.ellipsify(a, n.params.tickMultilineMax)),
        a.map(function (t) {
    ...
    (e.splitTickText = function (t, e) {
      var i,
        ...
        r = this,
        s = r.textFormatted(t),
        o = r.params.tickWidth;
      if ("[object Array]" === Object.prototype.toString.call(s)) return s;
      return (
        (!o || o <= 0) &&
          (o = r.isVertical()
            ? 95
        ...
        (function t(e, s) {
          ...
          for (var c = 1; c < s.length; c++)
            if (
              (" " === s.charAt(c) && (n = c),
              (i = s.substr(0, c + 1)),
              (a = r.tickTextCharSize.w * i.length),
              o < a)
            )
              return t(e.concat(s.substr(0, n || c)), s.slice(n ? n + 1 : c));
          return e.concat(s);
        })([], s + "")
      );
    }),
    (e.ellipsify = function (t, e) {
      ...
      for (var i = t.slice(0, e), n = 3, a = e - 1; a >= 0; a--) {
        var r = i[a].length;
        if (((i[a] = i[a].substr(0, r - n).padEnd(r, ".")), (n -= r) <= 0))
          break;
      }
      return i;
    }),
    ...
    (e.generateAxis = function () {
        ...
        return (
          a.each(function () {
            var a,
              ...
              c,
              d = (n.g = e.select(this)),
              u = this.__chart__ || t.scale,
              l = (this.__chart__ = t.copyScale()),
              h = t.tickValues ? t.tickValues : t.generateTicks(l),
              g = d.selectAll(".tick").data(h, l),
              f = g
                .enter()
                .insert("g", ".domain")
                .attr("class", "tick")
              ...
              _ = g.merge(f);
            i.isCategory
              ? ((t.tickOffset = Math.ceil((l(1) - l(0)) / 2)),
                (o = t.tickCentered ? 0 : t.tickOffset),
                (c = t.tickCentered ? t.tickOffset : 0))
              : (t.tickOffset = o = 0),
              t.updateRange(),
              t.updateTickLength(),
              t.updateTickTextCharSize(d.select(".tick"));
            var x = _.select("line").merge(f.append("line")),
              y = _.select("text").merge(f.append("text")),
              m = _.selectAll("text")
                .selectAll("tspan")
                .data(function (e, i) {
                  return t.tspanData(e, i, l);
                }),
              S = m
                .enter()
                .append("tspan")
            ...
            m.exit().remove();
            var w = d.selectAll(".domain").data([0]),
              v = w.enter().append("path").merge(w).attr("class", "domain");
            switch (t.orient) {
              case "bottom":
                (a = t.axisX),
                  x
                  ...
                  y
                    ...
                    .attr("transform", function (e, i) {
                      return t.textTransform(e, i);
                    })
                    .style("text-anchor", function (e, i) {
                      return t.textTextAnchor(e, i);
                    }),
                  S.attr("x", 0)
                    .attr("dy", function (e, i) {
                      return t.tspanDy(e, i);
                    })
                    .attr("dx", function (e, i) {
                      return t.tspanDx(e, i);
                    }),
                  v.attr(
                    "d",
                    "M" +
              ...
              case "left":
                (a = t.axisY),
                  x.attr("x2", -t.innerTickSize).attr("y1", c).attr("y2", c),
                  y
                    .attr("x", -t.tickLength)
                    .attr("y", t.tickOffset)
                    .style("text-anchor", "end"),
                  S.attr("x", -t.tickLength).attr("dy", function (e, i) {
                    return t.tspanDy(e, i);
                  }),
                  v.attr(
                    "d",
            ...
            } else u.rangeBand ? (u = l) : p.call(a, l, t.tickOffset);
            f.call(a, u, t.tickOffset),
              (s = (r ? _.transition(r) : _)
                .style("opacity", 1)
                .call(a, l, t.tickOffset));
          }),
          s
        );
      }
      return (
        (n.scale = function (e) {
          return arguments.length ? ((t.scale = e), n) : t.scale;
        }),
        (n.orient = function (e) {
          return arguments.length
            ? ((t.orient =
                e in { top: 1, right: 1, bottom: 1, left: 1 }
                  ? e + ""
                  : "bottom"),
              n)
            : t.orient;
        ...
        (n.tickFormat = function (e) {
          return arguments.length ? ((t.tickFormat = e), n) : t.tickFormat;
        }),
        (n.tickCentered = function (e) {
          return arguments.length ? ((t.tickCentered = e), n) : t.tickCentered;
        }),
        (n.tickOffset = function () {
          return t.tickOffset;
        }),
        (n.tickInterval = function () {
          var e;
          return (e = i.isCategory
            ? 2 * t.tickOffset
            : (n.g.select("path.domain").node().getTotalLength() -
                2 * t.outerTickSize) /
              n.g.selectAll("line").size()) ===
            1 / 0
            ? 0
            : e;
        }),
        (n.ticks = function () {
          return arguments.length
            ? ((t.tickArguments = arguments), n)
            : t.tickArguments;
        }),
        (n.tickCulling = function (e) {
          return arguments.length ? ((t.tickCulling = e), n) : t.tickCulling;
        }),
        (n.tickValues = function (e) {
          if ("function" == typeof e)
            t.tickValues = function () {
  ...
  var v = (function (i) {
    function n(i) {
      a(this, n);
      var s = { fn: t, internal: { fn: e } },
        o = r(
          this,
          (n.__proto__ || Object.getPrototypeOf(n)).call(this, i, "axis", s)
        );
      return (o.d3 = i.d3), (o.internal = w), o;
    }
    return (
      (function (t, e) {
  ...
  ((t = v.prototype).init = function () {
    var t = this.owner,
      e = t.config,
      n = t.main;
    (t.axes.x = n
      .append("g")
      .attr("class", i.axis + " " + i.axisX)
      ...
      t.axes.y
        .append("text")
        .attr("class", i.axisYLabel)
        .attr("transform", e.axis_rotated ? "" : "rotate(-90)")
        .style("text-anchor", this.textAnchorForYAxisLabel.bind(this)),
      (t.axes.y2 = n
        .append("g")
        .attr("class", i.axis + " " + i.axisY2)
        .attr("transform", t.getTranslate("y2"))
        .style("visibility", e.axis_y2_show ? "visible" : "hidden")),
      t.axes.y2
        .append("text")
        .attr("class", i.axisY2Label)
        .attr("transform", e.axis_rotated ? "" : "rotate(-90)")
        .style("text-anchor", this.textAnchorForY2AxisLabel.bind(this));
  }),
    (t.getXAxis = function (t, e, i, n, a, r, s) {
      var o = this.owner,
        c = o.config,
        d = {
        ...
        u = new this.internal(this, d).axis.scale(t).orient(e);
      return (
        o.isTimeSeries() &&
          n &&
          "function" != typeof n &&
        ...
        o.isCategorized() &&
          ...
          p(c.axis_x_tick_culling) && (c.axis_x_tick_culling = !1)),
        u
      );
    }),
    ...
    (t.getYAxis = function (t, e, i, n, a, r, s) {
      var o = this.owner,
        c = o.config,
        d = {
          withOuterTick: a,
        ...
        u = new this.internal(this, d).axis.scale(t).orient(e).tickFormat(i);
      return (
        o.isTimeSeriesY()
          ? u.ticks(c.axis_y_tick_time_type, c.axis_y_tick_time_interval)
          : u.tickValues(n),
        u
      );
    }),
    ...
    (t.getLabelPosition = function (t, e) {
      var i = this.getLabelOptionByAxisId(t),
        a =
          i && "object" === (void 0 === i ? "undefined" : n(i)) && i.position
            ? i.position
            : e;
      return {
    ...
    (t.getMaxTickWidth = function (t, e) {
      var i,
        ...
        o = s.config,
        c = 0;
      return e && s.currentMaxTickWidths[t]
        ? s.currentMaxTickWidths[t]
        : (s.svg &&
            ((i = s.filterTargetsToShow(s.data.targets)),
            "y" === t
              ? ((n = s.y.copy().domain(s.getYDomain(i, "y"))),
                (a = this.getYAxis(
                  n,
                  s.yOrient,
                  o.axis_y_tick_format,
                  s.yAxisTickValues,
                  !1,
                  !0,
                  !0
              ...
              : "y2" === t
              ? ((n = s.y2.copy().domain(s.getYDomain(i, "y2"))),
                (a = this.getYAxis(
                  n,
                  s.y2Orient,
              ...
              : ((n = s.x.copy().domain(s.getXDomain(i))),
                (a = this.getXAxis(
                  n,
                  s.xOrient,
                  s.xAxisTickFormat,
            ...
            (r = s.d3.select("body").append("div").classed("c3", !0))
              .append("svg")
          ...
          (s.currentMaxTickWidths[t] = c <= 0 ? s.currentMaxTickWidths[t] : c),
          s.currentMaxTickWidths[t]);
    }),
    ...
    (t.generateTickValues = function (t, e, i) {
      var n,
        a,
        r,
        s,
        ...
        l = t;
      if (e)
        if (1 === (n = o(e) ? e() : e)) l = [t[0]];
        else if (2 === n) l = [t[0], t[t.length - 1]];
        else if (n > 2) {
          for (
            s = n - 2,
              a = t[0],
              c = ((r = t[t.length - 1]) - a) / (s + 1),
              l = [a],
              d = 0;
            d < s;
            d++
          )
            (u = +a + c * (d + 1)), l.push(i ? new Date(u) : u);
          l.push(r);
        }
      return (
        i ||
  ...
  var b,
    ...
    A = { version: "0.6.2" };
  function P(t, e, i) {
    (this.owner = t), (A.chart.internal[e] = i);
  }
  function C(t) {
    var e = (this.internal = new L(this));
    e.loadConfig(t),
      e.beforeInit(t),
      e.init(),
      e.afterInit(t),
  ...
  return (
    ...
    (A.chart = { fn: C.prototype, internal: { fn: L.prototype } }),
    (b = A.chart.fn),
    ((T = A.chart.internal.fn).beforeInit = function () {}),
    ...
    (T.initWithData = function (t) {
      ...
      (a.axis = new v(a)),
        s.bindto
          ? "function" == typeof s.bindto.node
            ? (a.selectChart = s.bindto)
            : (a.selectChart = r.select(s.bindto))
          : (a.selectChart = r.selectAll([])),
        a.selectChart.empty() &&
          ((a.selectChart = r
            .select(document.createElement("div"))
            .style("opacity", 0)),
          a.observeInserted(a.selectChart),
          (o = !1)),
        a.selectChart.html("").classed("c3", !0),
        (a.data.xs = {}),
        (a.data.targets = a.convertDataToTargets(t)),
        s.data_filter &&
          (a.data.targets = a.data.targets.filter(s.data_filter)),
        s.data_hide &&
          a.addHiddenTargetIds(
            !0 === s.data_hide ? a.mapToIds(a.data.targets) : s.data_hide
          ),
        s.legend_hide &&
          a.addHiddenLegendIds(
            !0 === s.legend_hide ? a.mapToIds(a.data.targets) : s.legend_hide
          ),
        a.updateSizes(),
        a.updateScales(),
        a.x.domain(r.extent(a.getXDomain(a.data.targets))),
        a.y.domain(a.getYDomain(a.data.targets, "y")),
        a.y2.domain(a.getYDomain(a.data.targets, "y2")),
        a.subX.domain(a.x.domain()),
        a.subY.domain(a.y.domain()),
        a.subY2.domain(a.y2.domain()),
        (a.orgXDomain = a.x.domain()),
        (a.svg = a.selectChart
          .append("svg")
          .style("overflow", "hidden")
          .on("mouseenter", function () {
            return s.onmouseover.call(a);
          })
          .on("mouseleave", function () {
            return s.onmouseout.call(a);
          })),
        a.config.svg_classname && a.svg.attr("class", a.config.svg_classname),
        (e = a.svg.append("defs")),
        (a.clipChart = a.appendClip(e, a.clipId)),
        (a.clipXAxis = a.appendClip(e, a.clipIdForXAxis)),
        (a.clipYAxis = a.appendClip(e, a.clipIdForYAxis)),
        (a.clipGrid = a.appendClip(e, a.clipIdForGrid)),
        (a.clipSubchart = a.appendClip(e, a.clipIdForSubchart)),
        a.updateSvgSize(),
        (n = a.main =
          a.svg.append("g").attr("transform", a.getTranslate("main"))),
        a.initPie && a.initPie(),
        a.initSubchart && a.initSubchart(),
        a.initTooltip && a.initTooltip(),
        a.initLegend && a.initLegend(),
        a.initTitle && a.initTitle(),
        a.initZoom && a.initZoom(),
        a.initSubchartBrush && a.initSubchartBrush(),
        n
          .append("text")
          .attr("class", i.text + " " + i.empty)
          .attr("text-anchor", "middle")
          .attr("dominant-baseline", "middle"),
        a.initRegion(),
        a.initGrid(),
        n.append("g").attr("clip-path", a.clipPath).attr("class", i.chart),
        s.grid_lines_front && a.initGridLines(),
        a.initChartElements(),
        a.axis.init(),
        a.updateTargets(a.data.targets),
        a.initEventRect(),
        s.axis_x_selection && a.brush.selectionAsValue(a.getDefaultSelection()),
        o &&
          (a.updateDimension(),
          a.config.oninit.call(a),
          a.redraw({
            withTransition: !1,
            withTransform: !0,
            withUpdateXDomain: !0,
        ...
        a.bindResize(),
        (a.api.element = a.selectChart.node());
    }),
      ...
      (t.currentWidth = t.getCurrentWidth()),
        ...
        (t.margin = e.axis_rotated
          ...
          : {
              ...
              right: r ? 0 : t.getCurrentPaddingRight(),
              bottom: s + o + a + t.getCurrentPaddingBottom(),
    ...
    (T.redraw = function (t, e) {
      var n,
        ...
        F = k.d3,
        X = k.config,
        M = k.getShapeIndices(k.isAreaType),
        z = k.getShapeIndices(k.isBarType),
        H = k.getShapeIndices(k.isLineType),
        B = k.hasArcType(),
        Y = k.filterTargetsToShow(k.data.targets),
        N = k.xv.bind(k);
      if (
        ((n = x((t = t || {}), "withY", !0)),
        (a = x(t, "withSubchart", !0)),
        (r = x(t, "withTransition", !0)),
        (c = x(t, "withTransform", !1)),
        (d = x(t, "withUpdateXDomain", !1)),
        (u = x(t, "withUpdateOrgXDomain", !1)),
        (l = x(t, "withTrimXDomain", !0)),
        (p = x(t, "withUpdateXAxis", d)),
        (h = x(t, "withLegend", !1)),
        (g = x(t, "withEventRect", !0)),
        (f = x(t, "withDimension", !0)),
        (s = x(t, "withTransitionForExit", r)),
        (o = x(t, "withTransitionForAxis", r)),
        (v = r ? X.transition_duration : 0),
        (b = s ? v : 0),
        (T = o ? v : 0),
        (e = e || k.axis.generateTransitions(T)),
        h && X.legend_show
          ? k.updateLegend(k.mapToIds(k.data.targets), t, e)
          : f && k.updateDimension(!0),
        k.isCategorized() &&
          0 === Y.length &&
          k.x.domain([0, k.axes.x.selectAll(".tick").size()]),
        Y.length
          ? (k.updateXDomain(Y, d, u, l),
            X.axis_x_tick_values || (V = k.axis.updateXAxisTickValues(Y)))
          : (k.xAxis.tickValues([]), k.subXAxis.tickValues([])),
        X.zoom_rescale && !t.flow && (O = k.x.orgDomain()),
        k.y.domain(k.getYDomain(Y, "y", O)),
        k.y2.domain(k.getYDomain(Y, "y2", O)),
        !X.axis_y_tick_values &&
          X.axis_y_tick_count &&
          k.yAxis.tickValues(
            k.axis.generateTickValues(k.y.domain(), X.axis_y_tick_count)
          ),
        !X.axis_y2_tick_values &&
          X.axis_y2_tick_count &&
          k.y2Axis.tickValues(
            k.axis.generateTickValues(k.y2.domain(), X.axis_y2_tick_count)
          ),
        k.axis.redraw(T, B),
        k.axis.updateLabels(r),
        (d || p) && Y.length)
      )
        if (X.axis_x_tick_culling && V) {
          for (G = 1; G < V.length; G++)
            if (V.length / G < X.axis_x_tick_culling_max) {
              E = G;
              break;
            }
          k.svg.selectAll("." + i.axisX + " .tick text").each(function (t) {
            var e = V.indexOf(t);
            e >= 0 && F.select(this).style("display", e % E ? "none" : "block");
          });
        } else
          k.svg
            .selectAll("." + i.axisX + " .tick text")
            .style("display", "block");
      (_ = k.generateDrawArea ? k.generateDrawArea(M, !1) : void 0),
        (y = k.generateDrawBar ? k.generateDrawBar(z) : void 0),
        (m = k.generateDrawLine ? k.generateDrawLine(H, !1) : void 0),
        (S = k.generateXYForText(M, z, H, !0)),
        (w = k.generateXYForText(M, z, H, !1)),
        k.updateCircleY(),
        (I = (k.config.axis_rotated ? k.circleY : k.circleX).bind(k)),
        (R = (k.config.axis_rotated ? k.circleX : k.circleY).bind(k)),
        n &&
          (k.subY.domain(k.getYDomain(Y, "y")),
          k.subY2.domain(k.getYDomain(Y, "y2"))),
        k.updateXgridFocus(),
        D.select("text." + i.text + "." + i.empty)
          .attr("x", k.width / 2)
          .attr("y", k.height / 2)
          .text(X.data_empty_label_text)
          .transition()
          .style("opacity", Y.length ? 0 : 1),
        g && k.redrawEventRect(),
        k.updateGrid(v),
        k.updateRegion(v),
        k.updateBar(b),
        ...
        k.updateArea(b),
        k.updateCircle(I, R),
        k.hasDataLabel() && k.updateText(S, w, b),
        k.redrawTitle && k.redrawTitle(),
        k.redrawArc && k.redrawArc(v, b, c),
        k.redrawSubchart && k.redrawSubchart(a, e, v, b, M, z, H),
        D.selectAll("." + i.selectedCircles)
          .filter(k.isBarType.bind(k))
          .selectAll("circle")
          .remove(),
        t.flow &&
          (C = k.generateFlow({
        ...
        k.isTabVisible() &&
          (v
            ? ((L = F.transition().duration(v)),
              (A = []),
              [
                k.redrawBar(y, !0, L),
                k.redrawLine(m, !0, L),
                k.redrawArea(_, !0, L),
                k.redrawCircle(I, R, !0, L),
                k.redrawText(S, w, t.flow, !0, L),
                k.redrawRegion(!0, L),
                k.redrawGrid(!0, L),
              ].forEach(function (t) {
              ...
              P(function () {
                C && C(), X.onrendered && X.onrendered.call(k);
              }))
            : (k.redrawBar(y),
              k.redrawLine(m),
              k.redrawArea(_),
              k.redrawCircle(I, R),
              k.redrawText(S, w, t.flow),
              k.redrawRegion(),
              k.redrawGrid(),
              C && C(),
              X.onrendered && X.onrendered.call(k))),
        k.mapToIds(k.data.targets).forEach(function (t) {
          k.withoutFadeIn[t] = !0;
        });
    }),
    (T.updateAndRedraw = function (t) {
      var e,
        i = this,
        n = i.config;
      ((t = t || {}).withTransition = x(t, "withTransition", !0)),
        (t.withTransform = x(t, "withTransform", !1)),
        (t.withLegend = x(t, "withLegend", !1)),
        (t.withUpdateXDomain = x(t, "withUpdateXDomain", !0)),
        (t.withUpdateOrgXDomain = x(t, "withUpdateOrgXDomain", !0)),
        (t.withTransitionForExit = !1),
        (t.withTransitionForTransform = x(
          t,
    ...
    (T.isCustomX = function () {
      var t = this.config;
      return !this.isTimeSeries() && (t.data_x || _(t.data_xs));
    }),
    ...
    (T.getTranslate = function (t) {
      ...
      return (
        "main" === t
          ? ((e = g(n.margin.left)), (i = g(n.margin.top)))
          : "context" === t
          ? ((e = g(n.margin2.left)), (i = g(n.margin2.top)))
          : "legend" === t
    ...
    (T.opacityForCircle = function (t) {
      var e = (
        ...
        ? 1
        : 0;
      return s(t.value) ? (this.isScatterType(t) ? 0.5 : e) : 0;
    }),
    ...
    (T.transformMain = function (t, e) {
      ...
      e && e.axisX
        ? (n = e.axisX)
        : ((n = s.main.select("." + i.axisX)), t && (n = n.transition())),
        e && e.axisY
          ? (a = e.axisY)
          : ((a = s.main.select("." + i.axisY)), t && (a = a.transition())),
        e && e.axisY2
          ? (r = e.axisY2)
          : ((r = s.main.select("." + i.axisY2)), t && (r = r.transition())),
        (t ? s.main.transition() : s.main).attr(
          "transform",
          s.getTranslate("main")
        ),
        n.attr("transform", s.getTranslate("x")),
        a.attr("transform", s.getTranslate("y")),
        r.attr("transform", s.getTranslate("y2")),
        s.main
          .select("." + i.chartArcs)
          .attr("transform", s.getTranslate("arc"));
    }),
        ...
        e = function (e) {
          var i = setInterval(function () {
            ...
            t.forEach(function (t) {
              ...
              n === t.length && (clearInterval(i), e && e());
          }, 50);
        };
      return (
        (e.add = function (e) {
    ...
    "SVGPathSeg" in window ||
      ...
      (window.SVGPathSegCurvetoCubicAbs = function (t, e, i, n, a, r, s) {
        window.SVGPathSeg.call(
          this,
      ...
      (window.SVGPathSegCurvetoCubicRel = function (t, e, i, n, a, r, s) {
        window.SVGPathSeg.call(
          this,
      ...
      (window.SVGPathSegArcAbs = function (t, e, i, n, a, r, s, o) {
      ...
      (window.SVGPathSegArcRel = function (t, e, i, n, a, r, s, o) {
      ...
      (window.SVGPathElement.prototype.createSVGPathSegArcAbs = function (
        ...
        return new window.SVGPathSegArcAbs(void 0, t, e, i, n, a, r, s);
      }),
      (window.SVGPathElement.prototype.createSVGPathSegArcRel = function (
        ...
        return new window.SVGPathSegArcRel(void 0, t, e, i, n, a, r, s);
      }),
          ...
          (n.prototype._parseNumber = function () {
            ...
            if (
              ...
              for (
                ...
                this._currentIndex++;
              if (this._currentIndex != o)
                for (var c = this._currentIndex - 1, d = 1; c >= o; )
    ...
    (b.axis.max = function (t) {
      var e = this.internal,
        i = e.config;
      if (!arguments.length)
        return { x: i.axis_x_max, y: i.axis_y_max, y2: i.axis_y2_max };
      "object" === (void 0 === t ? "undefined" : n(t))
        ? (s(t.x) && (i.axis_x_max = t.x),
          s(t.y) && (i.axis_y_max = t.y),
          s(t.y2) && (i.axis_y2_max = t.y2))
        : (i.axis_y_max = i.axis_y2_max = t),
        e.redraw({ withUpdateOrgXDomain: !0, withUpdateXDomain: !0 });
    }),
    (b.axis.min = function (t) {
      var e = this.internal,
        i = e.config;
      if (!arguments.length)
        return { x: i.axis_x_min, y: i.axis_y_min, y2: i.axis_y2_min };
      "object" === (void 0 === t ? "undefined" : n(t))
        ? (s(t.x) && (i.axis_x_min = t.x),
          s(t.y) && (i.axis_y_min = t.y),
          s(t.y2) && (i.axis_y2_min = t.y2))
        : (i.axis_y_min = i.axis_y2_min = t),
        e.redraw({ withUpdateOrgXDomain: !0, withUpdateXDomain: !0 });
    }),
    (b.axis.range = function (t) {
      if (!arguments.length)
        return { max: this.axis.max(), min: this.axis.min() };
      l(t.max) && this.axis.max(t.max), l(t.min) && this.axis.min(t.min);
    }),
    (b.category = function (t, e) {
      var i = this.internal,
        n = i.config;
      return (
    ...
    (b.destroy = function () {
      ...
      if (
        ...
        window.detachEvent("onresize", t.resizeIfElementDisplayed);
      else if (window.removeEventListener)
        window.removeEventListener("resize", t.resizeIfElementDisplayed);
      else {
        var e = window.onresize;
        e && e.add && e.remove && e.remove(t.resizeFunction);
      }
      return (
        t.resizeFunction.remove(),
      ...
      (e = d.convertDataToTargets(i, !0)),
              ...
              for (
                a = !0,
                  t.values[t.values.length - 1] &&
                    (f = t.values[t.values.length - 1].index + 1),
                  g = e[i].values.length,
                  n = 0;
                n < g;
                n++
              )
                (e[i].values[n].index = f + n),
                  d.isTimeSeries() || (e[i].values[n].x = f + n);
        ...
        d.data.targets.forEach(function (t) {
          ...
          for (e = 0; e < u.length; e++)
            if (t.id === u[e])
              for (
                f = t.values[t.values.length - 1].index + 1, i = 0;
                i < g;
                i++
              )
                t.values.push({
        ...
        d.data.targets.length &&
          e.forEach(function (t) {
            var e,
              i = [];
            for (e = d.data.targets[0].values[0].index; e < f; e++)
              i.push({
                id: t.id,
                index: e,
        ...
        (d.data.targets = d.data.targets.concat(e)),
        d.getMaxDataCount(),
        (r = (a = d.data.targets[0]).values[0]),
        l(t.to)
          ? ((g = 0),
            (c = d.isTimeSeries() ? d.parseDate(t.to) : t.to),
            a.values.forEach(function (t) {
              t.x < c && g++;
            }))
          : l(t.length) && (g = t.length),
        h
          ? 1 === h &&
            d.isTimeSeries() &&
            ((o = (a.values[a.values.length - 1].x - r.x) / 2),
            (n = [new Date(+r.x - o), new Date(+r.x + o)]),
            d.updateXDomain(null, !0, !0, !1, n))
          : ((o = d.isTimeSeries()
              ? a.values.length > 1
                ? a.values[a.values.length - 1].x - r.x
                : r.x - d.getXDomain(d.data.targets)[0]
              : 1),
            (n = [r.x - o, r.x]),
            d.updateXDomain(null, !0, !0, !1, n)),
        ...
        d.redraw({
          flow: {
            index: r.index,
            length: g,
            duration: s(t.duration) ? t.duration : d.config.transition_duration,
            done: t.done,
            orgDataCount: h,
          },
          withLegend: !0,
    ...
    (T.generateFlow = function (t) {
      ...
      return function () {
        var r,
          ...
          L = y.index,
          V = y.length,
          G = e.getValueOnIndex(e.data.targets[0].values, L),
          E = e.getValueOnIndex(e.data.targets[0].values, L + V),
          O = e.x.domain(),
          I = y.duration || C,
          R = y.done || function () {},
          k = e.generateWait();
        (e.flowing = !0),
          ...
          (o = e.updateXDomain(x, !0, !0)),
          e.updateXGrid && e.updateXGrid(!0),
          (c = e.xgrid || a.selectAll([])),
          (d = e.xgridLines || a.selectAll([])),
          (u = e.mainRegion || a.selectAll([])),
          (l = e.mainText || a.selectAll([])),
          (h = e.mainBar || a.selectAll([])),
          (g = e.mainLine || a.selectAll([])),
          (p = e.mainArea || a.selectAll([])),
          (_ = e.mainCircle || a.selectAll([])),
          y.orgDataCount
            ? (r =
                1 === y.orgDataCount || (G && G.x) === (E && E.x)
                  ? e.x(O[0]) - e.x(o[0])
                  : e.isTimeSeries()
                  ? e.x(O[0]) - e.x(o[0])
                  : e.x(G.x) - e.x(E.x))
            ...
            ? (r = e.x(O[0]) - e.x(o[0]))
            : e.isTimeSeries()
            ? ((G = e.getValueOnIndex(e.data.targets[0].values, 0)),
              (E = e.getValueOnIndex(
              ...
              (r = e.x(G.x) - e.x(E.x)))
            : (r = f(o) / 2),
          (s = "translate(" + r + ",0) scale(" + f(O) / f(o) + ",1)"),
          e.hideXGridFocus();
        var D = a.transition().ease(a.easeLinear).duration(I);
        k.add(e.xAxis(e.axes.x, D)),
          k.add(h.transition(D).attr("transform", s)),
          k.add(g.transition(D).attr("transform", s)),
          k.add(p.transition(D).attr("transform", s)),
          k.add(_.transition(D).attr("transform", s)),
          k.add(l.transition(D).attr("transform", s)),
          k.add(u.filter(e.isRegionOnX).transition(D).attr("transform", s)),
          k.add(c.transition(D).attr("transform", s)),
          k.add(d.transition(D).attr("transform", s)),
          k(function () {
            var t,
              a = [],
              r = [];
            ...
            c
              ...
              d.attr("transform", null),
              d
                .select("line")
                .attr("x1", n.axis_rotated ? 0 : T)
                .attr("x2", n.axis_rotated ? e.width : T),
              d
                .select("text")
                .attr("x", n.axis_rotated ? e.width : 0)
                .attr("y", T),
              h.attr("transform", null).attr("d", m),
              g.attr("transform", null).attr("d", S),
              p.attr("transform", null).attr("d", w),
              _.attr("transform", null).attr("cx", v).attr("cy", b),
              l
                .attr("transform", null)
                .attr("x", A)
                .attr("y", P)
                .style("fill-opacity", e.opacityForText.bind(e)),
              u.attr("transform", null),
              u
    ...
    (b.focus = function (t) {
      ...
      (t = n.mapToTargetIds(t)),
        (e = n.svg.selectAll(n.selectorTargets(t.filter(n.isTargetToShow, n)))),
        this.revert(),
        this.defocus(),
        e.classed(i.focused, !0).classed(i.defocused, !1),
        n.hasArcType() && n.expandArc(t),
        n.toggleFocusLegend(t, !0),
        (n.focusedTargetIds = t),
        (n.defocusedTargetIds = n.defocusedTargetIds.filter(function (e) {
          return t.indexOf(e) < 0;
        }));
    }),
    (b.defocus = function (t) {
      var e = this.internal;
      (t = e.mapToTargetIds(t)),
        e.svg
          .selectAll(e.selectorTargets(t.filter(e.isTargetToShow, e)))
          .classed(i.focused, !1)
          .classed(i.defocused, !0),
    ...
    (b.xgrids.add = function (t) {
      var e = this.internal;
      return this.xgrids(e.config.grid_x_lines.concat(t || []));
    }),
    (b.xgrids.remove = function (t) {
    ...
    (b.ygrids.add = function (t) {
      var e = this.internal;
      return this.ygrids(e.config.grid_y_lines.concat(t || []));
    }),
    (b.ygrids.remove = function (t) {
    ...
    (b.load = function (t) {
      var e = this.internal,
        i = e.config;
      t.xs && e.addXs(t.xs),
        "names" in t && b.data.names.bind(this)(t.names),
        "classes" in t &&
    ...
    (b.regions.remove = function (t) {
      ...
      return (
        (t = t || {}),
        (e = r.getOption(t, "duration", s.transition_duration)),
        (n = r.getOption(t, "classes", [i.region])),
        (a = r.main.select("." + i.regions).selectAll(
          n.map(function (t) {
            return "." + t;
          })
        )),
        (e ? a.transition().duration(e) : a).style("opacity", 0).remove(),
        (s.regions = s.regions.filter(function (t) {
          var e = !1;
          return (
            !t.class ||
    ...
    (b.selected = function (t) {
      var e = this.internal,
        n = e.d3;
      return n.merge(
        e.main
          .selectAll("." + i.shapes + e.getTargetSelectorSuffix(t))
          .selectAll("." + i.shape)
          .filter(function () {
    ...
    (b.select = function (t, e, n) {
      var a = this.internal,
        r = a.d3,
        s = a.config;
      s.data_selection_enabled &&
        a.main
          .selectAll("." + i.shapes)
          .selectAll("." + i.shape)
          .each(function (o, c) {
            var d = r.select(this),
              u = o.data ? o.data.id : o.id,
              h = a.getToggle(this, o).bind(a),
              g = s.data_selection_grouped || !t || t.indexOf(u) >= 0,
              f = !e || e.indexOf(c) >= 0,
              p = d.classed(i.SELECTED);
            d.classed(i.line) ||
              d.classed(i.area) ||
              (g && f
                ? s.data_selection_isselectable(o) &&
                  !p &&
                  h(!0, d.classed(i.SELECTED, !0), o, c)
                : l(n) && n && p && h(!1, d.classed(i.SELECTED, !1), o, c));
          });
    }),
    (b.unselect = function (t, e) {
      var n = this.internal,
        a = n.d3,
        r = n.config;
      r.data_selection_enabled &&
        n.main
          .selectAll("." + i.shapes)
          .selectAll("." + i.shape)
          .each(function (s, o) {
            var c = a.select(this),
              ...
              l = r.data_selection_grouped || !t || t.indexOf(d) >= 0,
              h = !e || e.indexOf(o) >= 0,
            ...
            c.classed(i.line) ||
              ...
              (l &&
                h &&
                r.data_selection_isselectable(s) &&
                g &&
                u(!1, c.classed(i.SELECTED, !1), s, o));
          });
    }),
    (b.show = function (t, e) {
      var i,
    ...
    (b.tooltip.show = function (t) {
      ...
      t.mouse
        ...
        : (t.data
            ...
            : void 0 !== t.x &&
              ((e = t.id
                ? n.data.targets.filter(function (e) {
                    return e.id === t.id;
                  })
                : n.data.targets),
              (i = n.filterByX(e, t.x).slice(0, 1)[0])),
          (a = i ? n.getMousePosition(i) : null)),
        n.dispatchEvent("mousemove", a),
        n.config.tooltip_onshow.call(n, i);
    }),
    (b.tooltip.hide = function () {
      this.internal.dispatchEvent("mouseout", 0),
        this.internal.config.tooltip_onhide.call(this);
    }),
    (b.transform = function (t, e) {
      var i = this.internal,
        n = ["pie", "donut"].indexOf(t) >= 0 ? { withTransform: !0 } : null;
      i.transformTo(e, t, n);
    }),
    (T.transformTo = function (t, e, i) {
      var n = this,
        a = !n.hasArcType(),
    ...
    (b.zoom.range = function (t) {
      if (!arguments.length)
        return { max: this.domain.max(), min: this.domain.min() };
      l(t.max) && this.domain.max(t.max), l(t.min) && this.domain.min(t.min);
    }),
    (T.initPie = function () {
      var t = this,
        e = t.d3;
    ...
    (T.updateAngle = function (t) {
      ...
      return s
        ? (r.pie(r.filterTargetsToShow(r.data.targets)).forEach(function (e) {
            o || e.data.id !== t.data.id || ((o = !0), ((t = e).index = c)),
              c++;
          }),
          ...
          r.isGaugeType(t.data) &&
            ((e = s.gauge_min),
            (i = s.gauge_max),
            (n = (Math.PI * (s.gauge_fullCircle ? 2 : 1)) / (i - e)),
            (a = t.value < e ? 0 : t.value < i ? t.value - e : i - e),
            (t.startAngle = s.gauge_startingAngle),
    ...
    (T.getSvgArc = function () {
      var t = this,
        e = t.hasType("gauge"),
        i = t.gaugeArcWidth / t.filterTargetsToShow(t.data.targets).length,
        n = t.d3
          .arc()
          .outerRadius(function (n) {
            return e ? t.radius - i * n.index : t.radius;
          })
          .innerRadius(function (n) {
            return e ? t.radius - i * (n.index + 1) : t.innerRadius;
          }),
        a = function (e, i) {
          var a;
          return i ? n(e) : (a = t.updateAngle(e)) ? n(a) : "M 0 0";
        };
      return (a.centroid = n.centroid), a;
    }),
    (T.getSvgArcExpanded = function (t) {
      t = t || 1;
      var e = this,
        i = e.hasType("gauge"),
        n = e.gaugeArcWidth / e.filterTargetsToShow(e.data.targets).length,
        a = Math.min(e.radiusExpanded * t - e.radius, 0.8 * n - 100 * (1 - t)),
        r = e.d3
          .arc()
          .outerRadius(function (r) {
            return i ? e.radius - n * r.index + a : e.radiusExpanded * t;
          })
          .innerRadius(function (t) {
            return i ? e.radius - n * (t.index + 1) : e.innerRadius;
          });
      return function (t) {
      ...
      if (d && !l)
        (e = this.svgArc.centroid(d)),
          ...
          (u =
            ...
            i *
              (r =
                s.hasType("donut") && c.donut_label_ratio
                  ? o(c.donut_label_ratio)
                    ? c.donut_label_ratio(t, s.radius, a)
                    : c.donut_label_ratio
                  : s.hasType("pie") && c.pie_label_ratio
                  ? o(c.pie_label_ratio)
                    ? c.pie_label_ratio(t, s.radius, a)
                    : c.pie_label_ratio
                  : s.radius && a
                  ? ((36 / s.radius > 0.375 ? 1.175 - 36 / s.radius : 0.8) *
                      s.radius) /
                    a
                  : 0) +
            "," +
            n * r +
            ")");
      else if (d && l && s.filterTargetsToShow(s.data.targets).length > 1) {
        var h = Math.sin(d.endAngle - Math.PI / 2);
        u =
          "translate(" +
          (i = Math.cos(d.endAngle - Math.PI / 2) * (s.radiusExpanded + 25)) +
          "," +
          (n = h * (s.radiusExpanded + 15 - Math.abs(10 * h)) + 3) +
          ")";
      }
      return u;
    }),
    ...
    (T.textForArcLabel = function (t) {
      var e,
        ...
        r,
        s = this;
      return s.shouldShowArcLabel()
        ? ((i = (e = s.updateAngle(t)) ? e.value : null),
          (n = s.getArcRatio(e)),
          (a = t.data.id),
          s.hasType("gauge") || s.meetsArcLabelThreshold(n)
            ? (r = s.getArcLabelFormat())
              ? r(i, n, a)
              : s.defaultArcValueFormat(i, n)
            : "")
        : "";
    }),
      ...
      n.transiting
        ? (e = window.setInterval(function () {
            n.transiting ||
              ...
              n.legend.selectAll(".c3-legend-item-focused").size() > 0 &&
                n.expandArc(t));
          }, 10))
        : ((t = n.mapToTargetIds(t)),
          n.svg
            .selectAll(n.selectorTargets(t, "." + i.chartArc))
            .each(function (t) {
    ...
    (T.unexpandArc = function (t) {
      ...
      e.transiting ||
        ((t = e.mapToTargetIds(t)),
        e.svg
          .selectAll(e.selectorTargets(t, "." + i.chartArc))
          .selectAll("path")
          .transition()
          .duration(function (t) {
    ...
    (T.updateTargetsForArc = function (t) {
      var e,
        ...
        s = n.classArcs.bind(n),
        o = n.classFocus.bind(n);
      (e = a
        .select("." + i.chartArcs)
        .selectAll("." + i.chartArc)
        .data(n.pie(t))
    ...
    (T.initArc = function () {
      ...
      (t.arcs = t.main
        .select("." + i.chart)
        .append("g")
        .attr("class", i.chartArcs)
        .attr("transform", t.getTranslate("arc"))),
        t.arcs
          .append("text")
          .attr("class", i.chartArcsTitle)
          .style("text-anchor", "middle")
          .text(t.getArcTitle());
    }),
    (T.redrawArc = function (t, e, n) {
      ...
      if (
        ((r = (a = h
          .selectAll("." + i.arcs)
          .selectAll("." + i.arc)
          .data(d.arcData.bind(d)))
          .enter()
          .append("path")
          .attr("class", d.classArc.bind(d))
          .style("fill", function (t) {
            return d.color(t.data);
          })
          .style("cursor", function (t) {
            return l.interaction_enabled && l.data_selection_isselectable(t)
              ? "pointer"
              : null;
          })
          .each(function (t) {
            d.isGaugeType(t.data) &&
              (t.startAngle = t.endAngle = l.gauge_startingAngle),
              (this._current = t);
          })
          .merge(a)),
        g &&
          ((c = (o = h
            ...
            .merge(o)),
          1 === d.filterTargetsToShow(d.data.targets).length
            ? c.style("display", "none")
            : c
                .style("fill", function (t) {
                  return l.color_pattern.length > 0
                    ? d.levelColor(t.data.values[0].value)
                    : d.color(t.data);
                })
                .style("display", l.gauge_labelLine_show ? "" : "none")
                .each(function (t) {
                  var e = 0,
                    i = 0,
                    n = 0,
                    a = "";
                  if (d.hiddenTargetIds.indexOf(t.data.id) < 0) {
                    var r = d.updateAngle(t),
                      s =
                        (d.gaugeArcWidth /
                          d.filterTargetsToShow(d.data.targets).length) *
                        (r.index + 1),
                      o = r.endAngle - Math.PI / 2,
                      c = d.radius - s,
                      l = o - (0 === c ? 0 : 1 / c);
                    (e = d.radiusExpanded - d.radius + s),
                      (i = Math.cos(l) * c),
                      (n = Math.sin(l) * c),
                      (a =
                        "rotate(" +
        ...
        r
          .attr("transform", function (t) {
            return !d.isGaugeType(t.data) && n ? "scale(0)" : "";
          })
          .on(
            "mouseover",
            l.interaction_enabled
              ? function (t) {
                  var e, i;
                  d.transiting ||
                    ((e = d.updateAngle(t)) &&
                      ((i = d.convertToArcData(e)),
                      d.expandArc(e.data.id),
                      d.api.focus(e.data.id),
                      d.toggleFocusLegend(e.data.id, !0),
                      d.config.data_onmouseover(i, this)));
                }
              : null
          )
          .on(
            ...
            l.interaction_enabled
              ? function (t) {
                  var e,
                    i = d.updateAngle(t);
                  i && ((e = [d.convertToArcData(i)]), d.showTooltip(e, this));
                }
              : null
          )
          .on(
            ...
            l.interaction_enabled
              ? function (t) {
                  ...
                  d.transiting ||
                    ((e = d.updateAngle(t)) &&
                      ((i = d.convertToArcData(e)),
                      d.unexpandArc(e.data.id),
                      d.api.revert(),
                      d.revertLegend(),
                      d.hideTooltip(),
                      d.config.data_onmouseout(i, this)));
                }
              : null
          )
          .on(
            ...
            l.interaction_enabled
              ? function (t, e) {
                  var i,
                    n = d.updateAngle(t);
                  n &&
                    ((i = d.convertToArcData(n)),
                    d.toggleShape && d.toggleShape(this, i, e),
                    d.config.data_onclick.call(d.api, i, this));
                }
              : null
          )
          .each(function () {
          ...
          .attrTween("d", function (t) {
            ...
            return i
              ? (isNaN(this._current.startAngle) &&
                ...
                (e = u.interpolate(this._current, i)),
                (this._current = e(0)),
                function (i) {
                  var n = e(i);
                  return (n.data = t.data), d.getArc(n, !0);
                })
              : function () {
                  return "M 0 0";
                };
        ...
        a.exit().transition().duration(e).style("opacity", 0).remove(),
        h
          .selectAll("." + i.chartArc)
          .select("text")
          .style("opacity", 0)
          .attr("class", function (t) {
            return d.isGaugeType(t.data) ? i.gaugeValue : "";
          })
          .text(d.textForArcLabel.bind(d))
          .attr("transform", d.transformForArcLabel.bind(d))
          .style("font-size", function (t) {
            return d.isGaugeType(t.data) &&
              1 === d.filterTargetsToShow(d.data.targets).length
              ? Math.round(d.radius / 5) + "px"
              : "";
          })
          .transition()
          .duration(t)
          .style("opacity", function (t) {
            return d.isTargetToShow(t.data.id) && d.isArcType(t.data) ? 1 : 0;
          }),
        h
          .select("." + i.chartArcsTitle)
          .style("opacity", d.hasType("donut") || g ? 1 : 0),
        g)
      ) {
        var f = 0;
        (s = d.arcs
          .select("g." + i.chartArcsBackground)
          .selectAll("path." + i.chartArcsBackground)
          .data(d.data.targets))
          .enter()
          .append("path"),
          s
            .attr("class", function (t, e) {
              return (
                i.chartArcsBackground + " " + i.chartArcsBackground + "-" + e
              );
            })
            .attr("d", function (t) {
              if (d.hiddenTargetIds.indexOf(t.id) >= 0) return "M 0 0";
              var e = {
                data: [{ value: l.gauge_max }],
                startAngle: l.gauge_startingAngle,
                endAngle:
                  -1 *
                  l.gauge_startingAngle *
                  (l.gauge_fullCircle ? Math.PI : 1),
                index: f++,
              };
              return d.getArc(e, !0, !0);
            }),
          s.exit().remove(),
          d.arcs
            .select("." + i.chartArcsGaugeUnit)
            .attr("dy", ".75em")
            .text(l.gauge_label_show ? l.gauge_units : ""),
          d.arcs
            .select("." + i.chartArcsGaugeMin)
            .attr(
              "dx",
              -1 *
                (d.innerRadius +
                  (d.radius - d.innerRadius) / (l.gauge_fullCircle ? 1 : 2)) +
                "px"
            )
            .attr("dy", "1.2em")
            .text(
              l.gauge_label_show ? d.textForGaugeMinMax(l.gauge_min, !1) : ""
            ),
          d.arcs
            .select("." + i.chartArcsGaugeMax)
            .attr(
              "dx",
              d.innerRadius +
                (d.radius - d.innerRadius) / (l.gauge_fullCircle ? 1 : 2) +
            ...
            .attr("dy", "1.2em")
            .text(
              l.gauge_label_show ? d.textForGaugeMinMax(l.gauge_max, !0) : ""
            );
      }
    }),
    (T.initGauge = function () {
      var t = this.arcs;
      this.hasType("gauge") &&
        (t.append("g").attr("class", i.chartArcsBackground),
        t
          .append("text")
          .attr("class", i.chartArcsGaugeUnit)
          .style("text-anchor", "middle")
          .style("pointer-events", "none"),
        t
          .append("text")
          .attr("class", i.chartArcsGaugeMin)
          .style("text-anchor", "middle")
          .style("pointer-events", "none"),
        t
          .append("text")
          .attr("class", i.chartArcsGaugeMax)
          .style("text-anchor", "middle")
          .style("pointer-events", "none"));
    }),
    ...
    (T.classRegion = function (t, e) {
      return (
        this.generateClass(i.region, e) + " " + ("class" in t ? t.class : "")
      );
    }),
    ...
    (T.classTarget = function (t) {
      var e = this.config.data_classes[t],
        n = "";
      return (
        e && (n = " " + i.target + "-" + e), this.generateClass(i.target, t) + n
      );
    }),
    ...
    (T.classDefocused = function (t) {
      return (
        " " + (this.defocusedTargetIds.indexOf(t.id) >= 0 ? i.defocused : "")
      );
    }),
    ...
    (T.generateColor = function () {
      var t = this.config,
        e = this.d3,
        i = t.data_colors,
        n = _(t.color_pattern) ? t.color_pattern : e.schemeCategory10,
        a = t.data_color,
        r = [];
      return function (t) {
        var e,
          s = t.id || (t.data && t.data.id) || t;
        return (
    ...
    (T.convertUrlToData = function (t, e, i, n, a) {
      var r,
        s,
        o = this,
        c = e || "csv";
      "json" === c
        ? ((r = o.d3.json), (s = o.convertJsonToData))
        : "tsv" === c
        ? ((r = o.d3.tsv), (s = o.convertXsvToData))
        : ((r = o.d3.csv), (s = o.convertXsvToData)),
        r(t, i)
          .then(function (t) {
            a.call(o, s.call(o, t, n));
          })
          .catch(function (t) {
            throw t;
          });
    ...
    (T.convertColumnsToData = function (t) {
      for (var e = [], i = [], n = 0; n < t.length; n++) {
        for (var a = t[n][0], r = 1; r < t[n].length; r++) {
          if ((u(e[r - 1]) && (e[r - 1] = {}), u(t[n][r])))
            throw new Error(
              "Source data is missing a component at (" + n + "," + r + ")!"
            );
          e[r - 1][a] = t[n][r];
    ...
    (T.convertDataToTargets = function (t, e) {
      var i,
        ...
        d = o.config;
      return (
        c(t) ? (r = Object.keys(t[0])) : ((r = t.keys), (t = t.rows)),
        (n = r.filter(o.isNotX, o)),
        (a = r.filter(o.isX, o)),
        n.forEach(function (i) {
          var n = o.getXKey(i);
          o.isCustomX() || o.isTimeSeries()
            ? a.indexOf(n) >= 0
              ? (o.data.xs[i] = (e && o.data.xs[i] ? o.data.xs[i] : []).concat(
                  t
                    .map(function (t) {
                      return t[n];
                    })
                    .filter(s)
                    .map(function (t, e) {
                      return o.generateTargetX(t, i, e);
                    })
                ))
              : d.data_x
              ? (o.data.xs[i] = o.getOtherTargetXs())
              : _(d.data_xs) &&
                (o.data.xs[i] = o.getXValuesOfXKey(n, o.data.targets))
            : (o.data.xs[i] = t.map(function (t, e) {
                return e;
              }));
        }),
          ...
          return {
            ...
            values: t
              .map(function (t, a) {
                var r,
                  s = t[o.getXKey(e)],
                  c = null === t[e] || isNaN(t[e]) ? null : +t[e];
                return (
                  o.isCustomX() && o.isCategorized() && !u(s)
                    ? (0 === i && 0 === a && (d.axis_x_categories = []),
                      -1 === (r = d.axis_x_categories.indexOf(s)) &&
                        ((r = d.axis_x_categories.length),
                        d.axis_x_categories.push(s)))
                    : (r = o.generateTargetX(s, e, a)),
                  (u(t[e]) || o.data.xs[e].length <= a) && (r = void 0),
                  { x: r, value: c, id: n }
                );
              })
              .filter(function (t) {
        ...
        (o.hasNegativeValue = o.hasNegativeValueInTargets(i)),
        (o.hasPositiveValue = o.hasPositiveValueInTargets(i)),
        d.data_type &&
          o.setTargetType(
            o.mapToIds(i).filter(function (t) {
    ...
    (T.isX = function (t) {
      var e = this.config;
      return (e.data_x && t === e.data_x) || (_(e.data_xs) && y(e.data_xs, t));
    }),
    (T.isNotX = function (t) {
      return !this.isX(t);
    }),
    (T.getXKey = function (t) {
      var e = this.config;
      return e.data_x ? e.data_x : _(e.data_xs) ? e.data_xs[t] : null;
    }),
    (T.getXValuesOfXKey = function (t, e) {
      var i,
        n = this;
      return (
        (e && _(e) ? n.mapToIds(e) : []).forEach(function (e) {
    ...
    (T.getXValue = function (t, e) {
      return t in this.data.xs && this.data.xs[t] && s(this.data.xs[t][e])
        ? this.data.xs[t][e]
        : e;
    }),
    ...
    (T.generateTargetX = function (t, e, i) {
      var n = this;
    ...
    (T.getOrderFunction = function () {
      ...
      if (e || i) {
        ...
        return function (t, i) {
          var a = t.values.reduce(n, 0),
            r = i.values.reduce(n, 0);
          return e ? r - a : a - r;
        };
      }
      if (o(t.data_order)) return t.data_order;
      if (c(t.data_order)) {
        var a = t.data_order;
        return function (t, e) {
    ...
    (T.hasDataLabel = function () {
      ...
      return (
        ...
        !("object" !== n(t.data_labels) || !_(t.data_labels))
      );
    }),
    (T.getDataLabelLength = function (t, e, i) {
      var n = this,
        a = [0, 0];
      return (
        n.selectChart
        ...
        t
          ...
          .forEach(function (t) {
            var e = a.main
              ...
              .node();
            !n && a.isWithinBar(a.d3.mouse(e), e) && (n = t);
          }),
        t
          .filter(function (t) {
            return t && !a.isBarType(t.id);
    ...
    (T.dist = function (t, e) {
      var i = this.config,
        ...
        r = this.circleY(t, t.index),
        s = this.x(t.x);
      return Math.sqrt(Math.pow(s - e[n], 2) + Math.pow(r - e[a], 2));
    }),
            ...
            t.forEach(function (t) {
              (n.withoutFadeIn[t] = !1),
                n.legend &&
                  n.legend
                    .selectAll(
                      "." + i.legendItem + n.getTargetSelectorSuffix(t)
                    )
                    .remove(),
    ...
    (T.getYDomainMin = function (t) {
      var e,
        ...
        c = o.config,
        d = o.mapToIds(t),
        u = o.getValuesAsIdKeyed(t);
      if (c.data_groups.length > 0)
        for (
          s = o.hasNegativeValueInTargets(t), e = 0;
    ...
    (T.getYDomainMax = function (t) {
      ...
      if (c.data_groups.length > 0)
        for (
          s = o.hasPositiveValueInTargets(t), e = 0;
          e < c.data_groups.length;
          e++
        )
          if (
    ...
    (T.getYDomain = function (t, e, i) {
      var n,
        ...
        y = t.filter(function (t) {
          return p.axis.getId(t.id) === e;
        }),
        m = i ? p.filterByXDomain(y, i) : y,
        S = "y2" === e ? x.axis_y2_min : x.axis_y_min,
        w = "y2" === e ? x.axis_y2_max : x.axis_y_max,
        v = p.getYDomainMin(m),
        b = p.getYDomainMax(m),
        T = "y2" === e ? x.axis_y2_center : x.axis_y_center,
        A =
          (p.hasType("bar", m) && x.bar_zerobased) ||
          (p.hasType("area", m) && x.area_zerobased),
        P = "y2" === e ? x.axis_y2_inverted : x.axis_y_inverted,
        C = p.hasDataLabel() && x.axis_rotated,
        L = p.hasDataLabel() && !x.axis_rotated;
      return (
        (v = s(S) ? S : s(w) ? (v < w ? v : w - 10) : v),
        (b = s(w) ? w : s(S) ? (S < b ? b : S + 10) : b),
        0 === m.length
          ? "y2" === e
            ? p.y2.domain()
            : p.y.domain()
          : (isNaN(v) && (v = 0),
            ...
            ((s(S) && h) || (s(w) && g)) && (A = !1),
            A && (h && (v = 0), g && (b = 0)),
            (r = o = 0.1 * (a = Math.abs(b - v))),
            void 0 !== T &&
              ((b = T + (c = Math.max(Math.abs(v), Math.abs(b)))), (v = T - c)),
            C
              ? ((d = p.getDataLabelLength(v, b, "width")),
                (u = f(p.y.range())),
                (r += a * ((l = [d[0] / u, d[1] / u])[1] / (1 - l[0] - l[1]))),
                (o += a * (l[0] / (1 - l[0] - l[1]))))
              : L &&
                ((d = p.getDataLabelLength(v, b, "height")),
                (r += p.axis.convertPixelsToAxisPadding(d[1], a)),
                (o += p.axis.convertPixelsToAxisPadding(d[0], a))),
            "y" === e &&
              _(x.axis_y_padding) &&
              ((r = p.axis.getPadding(x.axis_y_padding, "top", r, a)),
              (o = p.axis.getPadding(x.axis_y_padding, "bottom", o, a))),
            "y2" === e &&
              _(x.axis_y2_padding) &&
              ((r = p.axis.getPadding(x.axis_y2_padding, "top", r, a)),
              (o = p.axis.getPadding(x.axis_y2_padding, "bottom", o, a))),
            A && (h && (o = v), g && (r = -b)),
            (n = [v - o, b + r]),
            P ? n.reverse() : n)
      );
    ...
    (T.getXDomainPadding = function (t) {
      ...
      return (
        (i = this.isCategorized()
          ? 0
          : this.hasType("bar")
          ? (e = this.getMaxDataCount()) > 1
            ? c / (e - 1) / 2
            : 0.5
          : 0.01 * c),
        "object" === n(o.axis_x_padding) && _(o.axis_x_padding)
          ? ((a = s(o.axis_x_padding.left) ? o.axis_x_padding.left : i),
            (r = s(o.axis_x_padding.right) ? o.axis_x_padding.right : i))
          : (a = r =
              "number" == typeof o.axis_x_padding ? o.axis_x_padding : i),
        { left: a, right: r }
      );
    }),
    (T.getXDomain = function (t) {
      ...
      return (
        ...
        (n || 0 === n) &&
          (s = e.isTimeSeries() ? new Date(n.getTime() - r.left) : n - r.left),
        (a || 0 === a) &&
          (o = e.isTimeSeries()
    ...
    (T.updateXDomain = function (t, e, i, n, a) {
      var r = this,
        s = r.config;
      return (
        i &&
          ...
          s.zoom_enabled && r.zoom.update(),
          r.subX.domain(r.x.domain()),
          r.brush && r.brush.updateScale(r.subX)),
        e &&
          r.x.domain(
            a ||
              (!r.brush || r.brush.empty()
                ? r.orgXDomain
                : r.brush.selectionAsValue())
          ),
    ...
    (T.drag = function (t) {
      var e,
        ...
        g = u.d3;
      u.hasArcType() ||
        (l.data_selection_enabled &&
          l.data_selection_multiple &&
          ((e = u.dragStart[0]),
          (n = u.dragStart[1]),
          (a = t[0]),
          (r = t[1]),
          (s = Math.min(e, a)),
          (o = Math.max(e, a)),
          (c = l.data_selection_grouped ? u.margin.top : Math.min(n, r)),
          (d = l.data_selection_grouped ? u.height : Math.max(n, r)),
          h
            .select("." + i.dragarea)
            .attr("x", s)
            .attr("y", c)
          ...
          h
            ...
            .each(function (t, e) {
              var n,
                ...
                f,
                p = g.select(this),
                _ = p.classed(i.SELECTED),
                x = p.classed(i.INCLUDED),
                y = !1;
              if (p.classed(i.circle))
                (n = 1 * p.attr("cx")),
                  (a = 1 * p.attr("cy")),
                  (h = u.togglePoint),
                  (y = s < n && n < o && c < a && a < d);
                ...
                (n = (f = S(this)).x),
                  ...
                  (l = f.height),
                  (h = u.togglePath),
                  (y = !(o < n || n + r < s || d < a || a + l < c));
              }
              y ^ x &&
                (p.classed(i.INCLUDED, !x),
                p.classed(i.SELECTED, !_),
                h.call(u, !_, p, t, e));
            })));
    }),
    ...
    (T.initGrid = function () {
      ...
      (t.grid = t.main
        ...
        .attr("class", i.grid)),
        e.grid_x_show && t.grid.append("g").attr("class", i.xgrids),
        e.grid_y_show && t.grid.append("g").attr("class", i.ygrids),
        e.grid_focus_show &&
          t.grid
            .append("g")
            .attr("class", i.xgridFocus)
            .append("line")
            .attr("class", i.xgridFocus),
        (t.xgrid = n.selectAll([])),
    ...
    (T.updateXGrid = function (t) {
      var e = this,
        ...
        s = e.isCategorized() ? e.xAxis.tickOffset() : 0;
      (e.xgridAttr = n.axis_rotated
        ...
        (e.xgridAttr.opacity = function () {
          return +a.select(this).attr(n.axis_rotated ? "y1" : "x1") ===
    ...
    (T.updateYGrid = function () {
      var t = this,
        ...
        a = t.main
          ...
          .selectAll("." + i.ygrid)
          .data(n),
        r = a.enter().append("line").attr("class", i.ygrid);
      (t.ygrid = r.merge(a)),
        t.ygrid
    ...
    (T.updateGrid = function (t) {
      var e,
        ...
        d = s.xv.bind(s),
        u = s.yv.bind(s),
        l = s.xGridTextX.bind(s),
        h = s.yGridTextX.bind(s);
      s.grid.style("visibility", s.hasArcType() ? "hidden" : "visible"),
        o.select("line." + i.xgridFocus).style("visibility", "hidden"),
        c.grid_x_show && s.updateXGrid(),
        (n = (e = o
          .select("." + i.xgridLines)
          ...
          .attr("x2", c.axis_rotated ? s.width : d)
          .attr("y1", c.axis_rotated ? d : 0)
          .attr("y2", c.axis_rotated ? d : s.height)
          .style("opacity", 0),
        n
          .append("text")
          .attr("text-anchor", s.gridTextAnchor)
          .attr("transform", c.axis_rotated ? "" : "rotate(-90)")
          .attr("x", c.axis_rotated ? h : l)
          .attr("y", d)
          .attr("dx", s.gridTextDx)
          .attr("dy", -5)
          .style("opacity", 0),
        (s.xgridLines = n.merge(e)),
        e.exit().transition().duration(t).style("opacity", 0).remove(),
        c.grid_y_show && s.updateYGrid(),
        (r = (a = o
          .select("." + i.ygridLines)
          .selectAll("." + i.ygridLine)
          .data(c.grid_y_lines))
          .enter()
          .append("g")
          .attr("class", function (t) {
          ...
          .append("line")
          .attr("x1", c.axis_rotated ? u : 0)
          .attr("x2", c.axis_rotated ? u : s.width)
          .attr("y1", c.axis_rotated ? 0 : u)
          .attr("y2", c.axis_rotated ? s.height : u)
          .style("opacity", 0),
        r
          .append("text")
          .attr("text-anchor", s.gridTextAnchor)
          .attr("transform", c.axis_rotated ? "rotate(-90)" : "")
          .attr("x", c.axis_rotated ? l : h)
          .attr("y", u)
          .attr("dx", s.gridTextDx)
          .attr("dy", -5)
          .style("opacity", 0),
        (s.ygridLines = r.merge(a)),
        s.ygridLines
          .select("line")
          .transition()
          .duration(t)
        ...
        s.ygridLines
          ...
          .attr(
            "x",
            c.axis_rotated ? s.xGridTextX.bind(s) : s.yGridTextX.bind(s)
          )
          .attr("y", u)
          .text(function (t) {
            return t.text;
          ...
          .style("opacity", 1),
        a.exit().transition().duration(t).style("opacity", 0).remove();
    }),
    (T.redrawGrid = function (t, e) {
      var i = this,
        n = i.config,
        a = i.xv.bind(i),
        r = i.xgridLines.select("line"),
        s = i.xgridLines.select("text");
      return [
        (t ? r.transition(e) : r)
          .attr("x1", n.axis_rotated ? 0 : a)
          .attr("x2", n.axis_rotated ? i.width : a)
          .attr("y1", n.axis_rotated ? a : 0)
          .attr("y2", n.axis_rotated ? a : i.height)
          .style("opacity", 1),
        (t ? s.transition(e) : s)
          .attr(
            "x",
    ...
    (T.showXGridFocus = function (t) {
      var e = this,
        ...
        r = e.main.selectAll("line." + i.xgridFocus),
        o = e.xx.bind(e);
      n.tooltip_show &&
        (e.hasType("scatter") ||
          e.hasArcType() ||
          (r
            ...
            .data([a[0]])
            .attr(n.axis_rotated ? "y1" : "x1", o)
            .attr(n.axis_rotated ? "y2" : "x2", o),
    ...
    (T.generateGridData = function (t, e) {
      ...
      if ("year" === t)
        for (
          a = (n = this.getXDomain())[0].getFullYear(),
            r = n[1].getFullYear(),
            s = a;
          s <= r;
          s++
        )
          o.push(new Date(s + "-01-01 00:00:00"));
      else
        (o = e.ticks(10)).length > c &&
    ...
    (T.removeGridLines = function (t, e) {
      var n = this.config,
        a = this.getGridFilterToRemove(t),
        r = function (t) {
          return !a(t);
        },
        s = e ? i.xgridLines : i.ygridLines,
        o = e ? i.xgridLine : i.ygridLine;
      this.main
        .select("." + s)
        .selectAll("." + o)
        .filter(a)
    ...
    (T.initEventRect = function () {
      ...
      t.main
        .select("." + i.chart)
        .append("g")
        .attr("class", i.eventRects)
        .style("fill-opacity", 0),
        (t.eventRect = t.main
          .select("." + i.eventRects)
          .append("rect")
          .attr("class", i.eventRect)),
        e.zoom_enabled &&
          t.zoom &&
    ...
    (T.redrawEventRect = function () {
      var t,
        ...
        r = n.config;
      function s() {
        n.svg.select("." + i.eventRect).style("cursor", null),
          n.hideXGridFocus(),
          n.hideTooltip(),
          n.unexpandCircles(),
          n.unexpandBars();
      ...
      (t = n.width),
        ...
        n.main
          ...
          .style(
            "cursor",
            r.zoom_enabled ? (r.axis_rotated ? "ns-resize" : "ew-resize") : null
          ),
        n.eventRect
          .attr("x", 0)
          .attr("y", 0)
          ...
          .on(
            ...
            r.interaction_enabled
              ? function () {
                  ...
                  n.dragging ||
                    n.hasArcType(t) ||
                    ((t = n.filterTargetsToShow(n.data.targets)),
                    (e = a.mouse(this)),
                    (o = n.findClosestFromTargets(t, e)),
                    !n.mouseover ||
                      (o && o.id === n.mouseover.id) ||
                      (r.data_onmouseout.call(n.api, n.mouseover),
                      (n.mouseover = void 0)),
                    o
                      ? ((c = (
                          n.isScatterType(o) || !r.tooltip_grouped
                            ? [o]
                            : n.filterByX(t, o.x)
                        ).map(function (t) {
                          return n.addName(t);
                        })),
                        n.showTooltip(c, this),
                        r.point_focus_expand_enabled &&
                          (n.unexpandCircles(),
                          c.forEach(function (t) {
                            n.expandCircles(t.index, t.id, !1);
                          })),
                        n.expandBars(o.index, o.id, !0),
                        n.showXGridFocus(c),
                        (n.isBarType(o.id) ||
                          n.dist(o, e) < r.point_sensitivity) &&
                          (n.svg
                            .select("." + i.eventRect)
                            .style("cursor", "pointer"),
                          n.mouseover ||
                            (r.data_onmouseover.call(n.api, o),
                            (n.mouseover = o))))
                      : s());
                }
              : null
            ...
            r.interaction_enabled
              ? function () {
                  ...
                  n.hasArcType(t) ||
                    ((t = n.filterTargetsToShow(n.data.targets)),
                    (e = a.mouse(this)),
                    (s = n.findClosestFromTargets(t, e)) &&
                      (n.isBarType(s.id) ||
                        n.dist(s, e) < r.point_sensitivity) &&
                      (n.isScatterType(s) || !r.data_selection_grouped
                        ? [s]
                        : n.filterByX(t, s.x)
                      ).forEach(function (t) {
                        n.main
                          .selectAll(
                            "." + i.shapes + n.getTargetSelectorSuffix(t.id)
                          )
                          .selectAll("." + i.shape + "-" + t.index)
                          .each(function () {
                            (r.data_selection_grouped ||
                              n.isWithinShape(this, t)) &&
                              (n.toggleShape(this, t, t.index),
                              r.data_onclick.call(n.api, t, this));
                          });
                      }));
                }
              : null
          ...
          .call(
            r.interaction_enabled && r.data_selection_draggable && n.drag
              ? a
                  .drag()
                  .on("drag", function () {
                    n.drag(a.mouse(this));
    ...
    (T.toggleFocusLegend = function (t, e) {
      ...
      (t = n.mapToTargetIds(t)),
        n.legend
          .selectAll("." + i.legendItem)
          .filter(function (e) {
            return t.indexOf(e) >= 0;
          })
          .classed(i.legendItemFocused, e)
          .transition()
          .duration(100)
          .style("opacity", function () {
            return (e ? n.opacityForLegend : n.opacityForUnfocusedLegend).call(
              n,
              n.d3.select(this)
            );
          });
    ...
    (T.updateLegend = function (t, e, n) {
      ...
      function F(e, n, a) {
        var r,
          ...
          l =
            ((o = e),
            (c = n),
            v.legendItemTextBox[c] ||
              (v.legendItemTextBox[c] = v.getTextRect(
                o.textContent,
                i.legendItem,
                o
              )),
          ...
          h =
            l.width +
            V +
            (!u || v.isLegendRight || v.isLegendInset ? A : 0) +
            b.legend_padding,
          g = l.height + T,
          f = v.isLegendRight || v.isLegendInset ? g : h,
          p =
            v.isLegendRight || v.isLegendInset
              ? v.getLegendHeight()
              : v.getLegendWidth();
        function _(t, e) {
          e || ((r = (p - G - f) / 2) < L && ((r = (p - f) / 2), (G = 0), D++)),
            (k[t] = D),
            (R[D] = v.isLegendInset ? 10 : r),
            (E[t] = G),
            (G += f);
        }
        d && ((G = 0), (D = 0), (P = 0), (C = 0)),
          !b.legend_show || v.isLegendToShow(n)
            ? ((O[n] = h),
              (I[n] = g),
              (!P || h >= P) && (P = h),
              (!C || g >= C) && (C = g),
              (s = v.isLegendRight || v.isLegendInset ? C : P),
              b.legend_equally
      ...
      (t = t.filter(function (t) {
        return !l(b.data_names[t]) || null !== b.data_names[t];
      })),
        (p = x((e = e || {}), "withTransition", !0)),
        (_ = x(e, "withTransitionForTransform", !0)),
        v.isLegendInset &&
          ((D = b.legend_inset_step ? b.legend_inset_step : t.length),
          v.updateLegendStep(D)),
        v.isLegendRight
          ? ((a = function (t) {
              return P * k[t];
            }),
        ...
        (r = function (t, e) {
          return a(t, e) + 4 + b.legend_item_tile_width;
        }),
        (c = function (t, e) {
          return o(t, e) + 9;
        }),
        ...
        (h = function (t, e) {
          return a(t, e) - 2 + b.legend_item_tile_width;
        }),
        (g = function (t, e) {
          return o(t, e) + 4;
        }),
        (f = v.legend
          ...
          .append("g")
          .attr("class", function (t) {
            return v.generateClass(i.legendItem, t);
          })
          ...
          .style("cursor", "pointer")
          .on("click", function (t) {
            b.legend_item_onclick
              ? b.legend_item_onclick.call(v, t)
              : v.d3.event.altKey
              ? (v.api.hide(), v.api.show(t))
              : (v.api.toggle(t),
                v.isTargetToShow(t) ? v.api.focus(t) : v.api.revert());
          })
          .on("mouseover", function (t) {
            b.legend_item_onmouseover
              ? b.legend_item_onmouseover.call(v, t)
              : (v.d3.select(this).classed(i.legendItemFocused, !0),
                !v.transiting && v.isTargetToShow(t) && v.api.focus(t));
          })
          .on("mouseout", function (t) {
            b.legend_item_onmouseout
              ? b.legend_item_onmouseout.call(v, t)
              : (v.d3.select(this).classed(i.legendItemFocused, !1),
                v.api.revert());
          }))
          .append("text")
          .text(function (t) {
            return l(b.data_names[t]) ? b.data_names[t] : t;
          })
          .each(function (t, e) {
            F(this, t, e);
          })
          .style("pointer-events", "none")
          .attr("x", v.isLegendRight || v.isLegendInset ? r : -200)
          .attr("y", v.isLegendRight || v.isLegendInset ? -200 : c),
        f
          .append("rect")
          .attr("class", i.legendItemEvent)
          .style("fill-opacity", 0)
          .attr("x", v.isLegendRight || v.isLegendInset ? s : -200)
          .attr("y", v.isLegendRight || v.isLegendInset ? -200 : d),
        f
          .append("line")
          .attr("class", i.legendItemTile)
          .style("stroke", v.color)
          .style("pointer-events", "none")
          .attr("x1", v.isLegendRight || v.isLegendInset ? u : -200)
          .attr("y1", v.isLegendRight || v.isLegendInset ? -200 : g)
          .attr("x2", v.isLegendRight || v.isLegendInset ? h : -200)
          .attr("y2", v.isLegendRight || v.isLegendInset ? -200 : g)
          .attr("stroke-width", b.legend_item_tile_height),
        (w = v.legend.select("." + i.legendBackground + " rect")),
        v.isLegendInset &&
          P > 0 &&
          0 === w.size() &&
          (w = v.legend
            .insert("g", "." + i.legendItem)
            .attr("class", i.legendBackground)
            .append("rect")),
        (y = v.legend
          .selectAll("text")
          .data(t)
        ...
        (p ? y.transition() : y).attr("x", r).attr("y", c),
        (m = v.legend.selectAll("rect." + i.legendItemEvent).data(t)),
        (p ? m.transition() : m)
          ...
          .attr("x", s)
          .attr("y", d),
        (S = v.legend.selectAll("line." + i.legendItemTile).data(t)),
        (p ? S.transition() : S)
          .style(
            "stroke",
            v.levelColor
              ? function (t) {
                  return v.levelColor(v.cache[t].values[0].value);
                }
              : v.color
          )
          .attr("x1", u)
        ...
        w &&
          (p ? w.transition() : w)
            .attr("height", v.getLegendHeight() - 12)
            .attr("width", P * (D + 1) + 10),
        v.legend
          .selectAll("." + i.legendItem)
          .classed(i.legendItemHidden, function (t) {
            return !v.isTargetToShow(t);
          }),
        v.updateLegendItemWidth(P),
        v.updateLegendItemHeight(C),
        v.updateLegendStep(D),
        v.updateSizes(),
        v.updateScales(),
        v.updateSvgSize(),
        v.transformAll(_, n),
        (v.legendHasRendered = !0);
    }),
    (T.initRegion = function () {
      this.region = this.main
        .append("g")
        .attr("clip-path", this.clipPath)
        .attr("class", i.regions);
    }),
    (T.updateRegion = function (t) {
      ...
      var a = e.main
        ...
        r = a
          ...
          .style("fill-opacity", 0);
      (e.mainRegion = r.merge(a).attr("class", e.classRegion.bind(e))),
        a.exit().transition().duration(t).style("opacity", 0).remove();
    }),
      ...
      return [
        (t ? n.transition(e) : n)
          ...
          .style("fill-opacity", function (t) {
            return s(t.opacity) ? t.opacity : 0.1;
          }),
      ];
    }),
    ...
    (T.getScale = function (t, e, i) {
      return (i ? this.d3.scaleTime() : this.d3.scaleLinear()).range([t, e]);
    }),
    (T.getX = function (t, e, i, n) {
      var a,
        r = this.getScale(t, e, this.isTimeSeries()),
        s = i ? r.domain(i) : r;
      for (a in (this.isCategorized()
        ? ((n =
            n ||
            function () {
              return 0;
    ...
    (T.updateScales = function () {
      ...
      (t.xMin = e.axis_rotated ? 1 : 0),
        ...
        i || (t.brush && t.brush.updateScale(t.subX)),
    ...
    (T.selectPoint = function (t, e, n) {
      ...
      r.data_onselected.call(a.api, e, t.node()),
        a.main
          .select("." + i.selectedCircles + a.getTargetSelectorSuffix(e.id))
          .selectAll("." + i.selectedCircle + "-" + n)
          .data([e])
          .enter()
          .append("circle")
          .attr("class", function () {
    ...
    (T.unselectPoint = function (t, e, n) {
      this.config.data_onunselected.call(this.api, e, t.node()),
        this.main
          .select("." + i.selectedCircles + this.getTargetSelectorSuffix(e.id))
          .selectAll("." + i.selectedCircle + "-" + n)
          .transition()
          .duration(100)
          .attr("r", 0)
    ...
    (T.togglePoint = function (t, e, i, n) {
    ...
    (T.toggleShape = function (t, e, n) {
      var a = this,
        ...
        s = a.config,
        o = r.select(t),
        c = o.classed(i.SELECTED),
        d = a.getToggle(t, e).bind(a);
      s.data_selection_enabled &&
        s.data_selection_isselectable(e) &&
        (s.data_selection_multiple ||
          a.main
            .selectAll(
              "." +
                i.shapes +
                (s.data_selection_grouped
                  ? a.getTargetSelectorSuffix(e.id)
                  : "")
            )
            .selectAll("." + i.shape)
            .each(function (t, e) {
              var n = r.select(this);
              n.classed(i.SELECTED) && d(!1, n.classed(i.SELECTED, !1), t, e);
            }),
        o.classed(i.SELECTED, !c),
        d(!c, o, e, n));
    }),
    (T.initBar = function () {
      this.main
        .select("." + i.chart)
        .append("g")
        .attr("class", i.chartBars);
    }),
    (T.updateTargetsForBar = function (t) {
      var e = this,
        n = e.config,
        a = e.classChartBar.bind(e),
        r = e.classBars.bind(e),
        s = e.classFocus.bind(e);
      e.main
        .select("." + i.chartBars)
        .selectAll("." + i.chartBar)
        .data(t)
        .attr("class", function (t) {
          return a(t) + s(t);
        })
    ...
    (T.updateBar = function (t) {
      var e = this,
        ...
        c = o
          ...
          .style("stroke", s)
          .style("fill", s);
      (e.mainBar = c.merge(o).style("opacity", r)),
        o.exit().transition().duration(t).style("opacity", 0);
    }),
    (T.redrawBar = function (t, e, i) {
      return [
    ...
    (T.getBars = function (t, e) {
      return (
        e
          ? this.main.selectAll("." + i.bars + this.getTargetSelectorSuffix(e))
          : this.main
      ).selectAll("." + i.bar + (s(t) ? "-" + t : ""));
    }),
    (T.expandBars = function (t, e, n) {
      n && this.unexpandBars(), this.getBars(t, e).classed(i.EXPANDED, !0);
    }),
    (T.unexpandBars = function (t) {
      this.getBars(t).classed(i.EXPANDED, !1);
    }),
    (T.generateDrawBar = function (t, e) {
      var i = this.config,
        n = this.generateGetBarPoints(t, e);
      return function (t, e) {
        var a = n(t, e),
          r = i.axis_rotated ? 1 : 0,
          s = i.axis_rotated ? 0 : 1;
        return (
          "M " +
          a[0][r] +
          "," +
    ...
    (T.isWithinBar = function (t, e) {
      var i = e.getBoundingClientRect(),
        ...
        a = e.pathSegList.getItem(1),
        r = Math.min(n.x, a.x),
        s = Math.min(n.y, a.y),
        o = r + i.width + 2,
        c = s + i.height + 2,
        d = s - 2;
      return r - 2 < t[0] && t[0] < o && d < t[1] && t[1] < c;
    }),
            ...
            for (e = 0; e < n.data_groups.length; e++)
              if (!(n.data_groups[e].indexOf(t.id) < 0))
                for (i = 0; i < n.data_groups[e].length; i++)
                  if (n.data_groups[e][i] in a) {
                    a[t.id] = a[n.data_groups[e][i]];
                    break;
                  }
            u(a[t.id]) && (a[t.id] = r++);
          }
    ...
    (T.getShapeX = function (t, e, i, n) {
      var a = n ? this.subX : this.x;
      return function (n) {
        var r = n.id in i ? i[n.id] : 0;
        return n.x || 0 === n.x ? a(n.x) - t * (e / 2 - r) : 0;
      };
    }),
    ...
    (T.getShapeOffset = function (t, e, i) {
      var n = this,
        ...
        return (
          a.forEach(function (i) {
            ...
            i.id !== t.id &&
              ...
              ((void 0 !== a[s] && +a[s].x == +t.x) ||
                ((s = -1),
                a.forEach(function (e, i) {
                  e.x === t.x && (s = i);
                })),
              s in a && a[s].value * t.value >= 0 && (d += o(a[s].value) - c));
          }),
          d
        );
      };
    ...
    (T.isWithinShape = function (t, e) {
      var n,
        ...
        r = a.d3.select(t);
      return (
        a.isTargetToShow(e.id)
          ? "circle" === t.nodeName
            ? (n = a.isStepType(e)
                ? a.isWithinStep(t, a.getYScale(e.id)(e.value))
                : a.isWithinCircle(t, 1.5 * a.pointSelectR(e)))
            : "path" === t.nodeName &&
              (n = !r.classed(i.bar) || a.isWithinBar(a.d3.mouse(t), t))
          : (n = !1),
        n
      );
    }),
    ...
    (T.updateTargetsForLine = function (t) {
      ...
      (e = n.main
        ...
        e.append("g").attr("class", function (t) {
          return n.generateClass(i.selectedCircles, t.id);
        }),
        e
          .append("g")
          .attr("class", c)
          .style("cursor", function (t) {
            return a.data_selection_isselectable(t) ? "pointer" : null;
          }),
        t.forEach(function (t) {
          n.main
            .selectAll(
              "." + i.selectedCircles + n.getTargetSelectorSuffix(t.id)
            )
            .selectAll("." + i.selectedCircle)
            .each(function (e) {
      ...
      var i = this,
        ...
        c = function (t, e) {
          return n.data_groups.length > 0
            ? r(t, e)[0][1]
            : s.call(i, t.id)(t.value);
        };
      return (
        (a = n.axis_rotated ? a.x(c).y(o) : a.x(o).y(c)),
        n.line_connectNull ||
        ...
        function (t) {
          var r,
            o = n.line_connectNull ? i.filterRemoveNull(t.values) : t.values,
            c = e ? i.subX : i.x,
            d = s.call(i, t.id),
            u = 0,
            l = 0;
          return (
            i.isLineType(t)
              ? n.data_regions[t.id]
                ? (r = i.lineWithRegions(o, c, d, n.data_regions[t.id]))
                : (i.isStepType(t) && (o = i.convertValuesToStep(o)),
                  (r = a.curve(i.getInterpolate(t))(o)))
              : (o[0] && ((u = c(o[0].x)), (l = d(o[0].value))),
                (r = n.axis_rotated ? "M " + l + " " + u : "M " + u + " " + l)),
            r || "M 0 0"
          );
        }
      );
    ...
    (T.lineWithRegions = function (t, e, i, n) {
      var a,
        r,
        s,
        o,
      ...
      if (l(n))
        for (a = 0; a < n.length; a++)
          (w[a] = {}),
            u(n[a].start)
              ? (w[a].start = t[0].x)
              : (w[a].start = x.isTimeSeries()
                  ? x.parseDate(n[a].start)
                  : n[a].start),
            u(n[a].end)
              ? (w[a].end = t[t.length - 1].x)
              : (w[a].end = x.isTimeSeries()
                  ? x.parseDate(n[a].end)
                  : n[a].end);
      function b(t) {
      ...
      for (
        ...
        if (u(w) || !v(t[a].x, w)) m += " " + p(t[a]) + " " + _(t[a]);
        else
          for (
            o = x.getScale(t[a - 1].x + S, t[a].x + S, x.isTimeSeries()),
              c = x.getScale(t[a - 1].value, t[a].value),
              d = e(t[a].x) - e(t[a - 1].x),
              h = i(t[a].value) - i(t[a - 1].value),
              f = 2 * (g = 2 / Math.sqrt(Math.pow(d, 2) + Math.pow(h, 2))),
              r = g;
            r <= 1;
            r += f
          )
    ...
    (T.updateArea = function (t) {
      ...
      (e.mainArea = r.merge(a).style("opacity", e.orgAreaOpacity)),
        a.exit().transition().duration(t).style("opacity", 0);
    }),
    (T.redrawArea = function (t, e, i) {
      return [
    ...
    (T.generateDrawArea = function (t, e) {
      var i = this,
        ...
        c = function (t, e) {
          return n.data_groups.length > 0
            ? r(t, e)[0][1]
            : s.call(i, t.id)(i.getAreaBaseValue(t.id));
        },
        d = function (t, e) {
          return n.data_groups.length > 0
            ? r(t, e)[1][1]
          ...
          return (
            i.isAreaType(t)
              ? (i.isStepType(t) && (r = i.convertValuesToStep(r)),
                (e = a.curve(i.getInterpolate(t))(r)))
              : (r[0] &&
                  ((s = i.x(r[0].x)), (o = i.getYScale(t.id)(r[0].value))),
                (e = n.axis_rotated ? "M " + o + " " + s : "M " + s + " " + o)),
            e || "M 0 0"
          );
        }
      );
    ...
    (T.updateCircle = function (t, e) {
      var n = this,
        a = n.main
          .selectAll("." + i.circles)
          .selectAll("." + i.circle)
          .data(n.lineOrScatterData.bind(n)),
        r = a
          .enter()
          .append("circle")
          .attr("class", n.classCircle.bind(n))
          .attr("cx", t)
          .attr("cy", e)
          .attr("r", n.pointR.bind(n))
          .style("fill", n.color);
      (n.mainCircle = r
        .merge(a)
        .style("opacity", n.initialOpacityForCircle.bind(n))),
        a.exit().style("opacity", 0);
    }),
    (T.redrawCircle = function (t, e, n, a) {
      var r = this,
        s = r.main.selectAll("." + i.selectedCircle);
      return [
        (n ? r.mainCircle.transition(a) : r.mainCircle)
          .style("opacity", this.opacityForCircle.bind(r))
          .style("fill", r.color)
          .attr("cx", t)
          .attr("cy", e),
        (n ? s.transition(a) : s).attr("cx", t).attr("cy", e),
      ];
    }),
    ...
    (T.getCircles = function (t, e) {
      return (
        e
          ? this.main.selectAll(
              "." + i.circles + this.getTargetSelectorSuffix(e)
            )
          : this.main
      ).selectAll("." + i.circle + (s(t) ? "-" + t : ""));
    }),
    (T.expandCircles = function (t, e, n) {
      var a = this.pointExpandedR.bind(this);
      n && this.unexpandCircles(),
        this.getCircles(t, e).classed(i.EXPANDED, !0).attr("r", a);
    }),
    (T.unexpandCircles = function (t) {
      ...
      e.getCircles(t)
        ...
        .classed(i.EXPANDED, !1)
        .attr("r", n);
    }),
    (T.pointR = function (t) {
      var e = this.config;
      return this.isStepType(t) ? 0 : o(e.point_r) ? e.point_r(t) : e.point_r;
    }),
    (T.pointExpandedR = function (t) {
      var e = this.config;
      return e.point_focus_expand_enabled
        ? o(e.point_focus_expand_r)
    ...
    (T.getCurrentPaddingTop = function () {
      var t = this.config,
        e = s(t.padding_top) ? t.padding_top : 0;
      return (
    ...
    (T.getSvgLeft = function (t) {
      var e = this,
        n = e.config,
        a = n.axis_rotated || (!n.axis_rotated && !n.axis_y_inner),
        r = n.axis_rotated ? i.axisX : i.axisY,
        s = e.main.select("." + r).node(),
        o = s && a ? s.getBoundingClientRect() : { right: 0 },
        c = e.selectChart.node().getBoundingClientRect(),
        d = e.hasArcType(),
        u = o.right - c.left - (d ? 0 : e.getCurrentPaddingLeft(t));
      return u > 0 ? u : 0;
    }),
    ...
    (T.initBrush = function (t) {
      var e = this,
        n = e.d3;
      return (
        (e.brush = (e.config.axis_rotated ? n.brushY() : n.brushX())
          .on("brush", function () {
          ...
          .on("end", function () {
            var t = n.event.sourceEvent;
            (t && "zoom" === t.type) ||
              (e.brush.empty() && t && "end" !== t.type && e.brush.clear());
          })),
        (e.brush.updateExtent = function () {
          var t,
            i = this.scale.range();
          return (
            (t = e.config.axis_rotated
              ? [
                  [0, i[0]],
                  [e.width2, i[1]],
                ]
        ...
        (e.brush.update = function (t) {
          this.updateScale(t || e.subX).updateExtent(),
            e.context.select("." + i.brush).call(this);
        }),
        (e.brush.clear = function () {
          e.context.select("." + i.brush).call(e.brush.move, null);
        }),
        (e.brush.selection = function () {
          return n.brushSelection(e.context.select("." + i.brush).node());
        }),
        (e.brush.selectionAsValue = function (t, n) {
          var a, r;
          return t
            ? (e.context &&
                ((a = [this.scale(t[0]), this.scale(t[1])]),
                (r = e.context.select("." + i.brush)),
                n && (r = r.transition()),
                e.brush.move(r, a)),
              [])
            : ((a = e.brush.selection() || [0, 0]),
              [this.scale.invert(a[0]), this.scale.invert(a[1])]);
        }),
    ...
    (T.initSubchart = function () {
      var t = this,
        ...
        a = e.subchart_show ? "visible" : "hidden";
      n.style("visibility", a),
        n
          .append("g")
        ...
        n
          ...
          .append("g")
          .attr("class", i.chartLines),
        n.append("g").attr("clip-path", t.clipPath).attr("class", i.brush),
        (t.axes.subx = n
          .append("g")
          .attr("class", i.axisX)
    ...
    (T.initSubchartBrush = function () {
      this.initBrush(this.subX).updateExtent(),
        this.context.select("." + i.brush).call(this.brush);
    }),
    (T.updateTargetsForSubchart = function (t) {
      var e,
        ...
        o = s.context,
        c = s.config,
        d = s.classChartBar.bind(s),
        u = s.classBars.bind(s),
        l = s.classChartLine.bind(s),
        h = s.classLines.bind(s),
        g = s.classAreas.bind(s);
      c.subchart_show &&
        ((a = (r = o
          .select("." + i.chartBars)
          .selectAll("." + i.chartBar)
        ...
        e.append("g").attr("class", g),
        o
          .selectAll("." + i.brush + " rect")
          .attr(
            c.axis_rotated ? "width" : "height",
            c.axis_rotated ? s.width2 : s.height2
          ));
    }),
    (T.updateBarForSubchart = function (t) {
      ...
      n.exit().transition().duration(t).style("opacity", 0).remove(),
        (e.contextBar = a.merge(n).style("opacity", e.initialOpacity.bind(e)));
    }),
    (T.redrawBarForSubchart = function (t, e, i) {
      (e
    ...
    (T.updateLineForSubchart = function (t) {
      var e = this,
        ...
        a = n
          ...
          .style("stroke", e.color);
      n.exit().transition().duration(t).style("opacity", 0).remove(),
        (e.contextLine = a.merge(n).style("opacity", e.initialOpacity.bind(e)));
    }),
    (T.redrawLineForSubchart = function (t, e, i) {
      (e
    ...
    (T.updateAreaForSubchart = function (t) {
      ...
      a.exit().transition().duration(t).style("opacity", 0).remove(),
        (e.contextArea = r.merge(a).style("opacity", 0));
    }),
    (T.redrawAreaForSubchart = function (t, e, i) {
      (e
    ...
    (T.redrawSubchart = function (t, e, i, n, a, r, s) {
      var o,
        c,
        d,
        u = this,
        l = u.d3,
        h = u.config;
      u.context.style("visibility", h.subchart_show ? "visible" : "hidden"),
        h.subchart_show &&
          (l.event &&
            "zoom" === l.event.type &&
            u.brush.selectionAsValue(u.x.orgDomain()),
          t &&
            (u.brush.empty() || u.brush.selectionAsValue(u.x.orgDomain()),
            (o = u.generateDrawArea(a, !0)),
            (c = u.generateDrawBar(r, !0)),
            (d = u.generateDrawLine(s, !0)),
            u.updateBarForSubchart(i),
            u.updateLineForSubchart(i),
            u.updateAreaForSubchart(i),
            u.redrawBarForSubchart(c, i, i),
            u.redrawLineForSubchart(d, i, i),
            u.redrawAreaForSubchart(o, i, i)));
    }),
    (T.redrawForBrush = function () {
      ...
      e.redraw({
        ...
        (t = a.event.selection || e.brush.scale.range()),
        e.main
          .select("." + i.eventRect)
          .call(
            e.zoom.transform,
            a.zoomIdentity.scale(e.width / (t[1] - t[0])).translate(-t[0], 0)
          ),
        e.config.subchart_onbrush.call(e.api, n.orgDomain());
    }),
    (T.transformContext = function (t, e) {
      var n;
      e && e.axisSubX
        ? (n = e.axisSubX)
        : ((n = this.context.select("." + i.axisX)), t && (n = n.transition())),
    ...
    (T.updateTargetsForText = function (t) {
      var e = this,
        ...
        o = s
          ...
          .style("opacity", 0)
          .style("pointer-events", "none");
      o.append("g").attr("class", a),
        o.merge(s).attr("class", function (t) {
          return n(t) + r(t);
        });
    }),
    (T.updateText = function (t, e, n) {
      var a = this,
        r = a.config,
        s = a.barOrLineData.bind(a),
        o = a.classText.bind(a),
        c = a.main
          .selectAll("." + i.texts)
          .selectAll("." + i.text)
          .data(s),
        d = c
          ...
          .style("fill-opacity", 0);
      (a.mainText = d.merge(c).text(function (t, e, i) {
        return a.dataLabelFormat(t.id)(t.value, t.id, e, i);
      })),
        c.exit().transition().duration(n).style("fill-opacity", 0).remove();
    }),
    (T.redrawText = function (t, e, i, n, a) {
      return [
        (n ? this.mainText.transition(a) : this.mainText)
          .attr("x", t)
          .attr("y", e)
          .style("fill", this.color)
    ...
    (T.generateXYForText = function (t, e, i, n) {
      var a = this,
    ...
    (T.getXForText = function (t, e, i) {
      ...
      return (
        ...
        null === e.value &&
          (n > r.width ? (n = r.width - s.width) : n < 0 && (n = 4)),
        n
      );
    }),
    (T.getYForText = function (t, e, i) {
      var n,
        a = this,
    ...
    (T.initTooltip = function () {
      ...
      if (
        ((e.tooltip = e.selectChart
          ...
          .append("div")
          .attr("class", i.tooltipContainer)
          .style("position", "absolute")
          .style("pointer-events", "none")
          .style("display", "none")),
        n.tooltip_init_show)
      ) {
        if (e.isTimeSeries() && d(n.tooltip_init_x)) {
          for (
    ...
    (T.getTooltipSortFunction = function () {
      ...
      if (d(n) && "asc" === n.toLowerCase())
        return function (t, e) {
          return a(t) - a(e);
        };
      if (d(n) && "desc" === n.toLowerCase())
        return function (t, e) {
          return a(e) - a(t);
        };
      if (o(n)) {
    ...
    (T.getTooltipContent = function (t, e, i, n) {
      var a,
        r,
        s,
        o,
        ...
        u = this,
        l = u.config,
        h = l.tooltip_format_title || e,
        g =
          l.tooltip_format_name ||
          function (t) {
            return t;
          },
        f = l.tooltip_format_value || i,
        ...
        if (
          ...
          (a ||
            ...
            (a =
              ...
              u.CLASS.tooltip +
              "'>" +
              (s || 0 === s ? "<tr><th colspan='2'>" + s + "</th></tr>" : ""))),
          void 0 !== (o = m(f(t[r].value, t[r].ratio, t[r].id, t[r].index, t))))
        ) {
          if (null === t[r].name) continue;
          (c = m(g(t[r].name, t[r].ratio, t[r].id, t[r].index))),
            (d = u.levelColor ? u.levelColor(t[r].value) : n(t[r].id)),
            (a +=
              "<tr class='" +
              u.CLASS.tooltipName +
              "-" +
              u.getTargetSelectorSuffix(t[r].id) +
              "'>"),
            (a +=
              ...
              c +
              "</td>"),
            (a += "<td class='value'>" + o + "</td>"),
            (a += "</tr>");
        }
      return a + "</table>";
    }),
    (T.tooltipPosition = function (t, e, i, n) {
      var a,
        r,
        s,
        o,
      ...
      return (
        h
          ? ((r =
              ...
              g[0]),
            (o = (d.hasType("gauge") ? d.height : d.height / 2) + g[1] + 20))
          : ((a = d.getSvgLeft(!0)),
            u.axis_rotated
              ? ((s = (r = a + g[0] + 100) + e),
    ...
    (T.showTooltip = function (t, e) {
      var i,
        ...
        u = o.tooltip_position || T.tooltipPosition;
      0 !== d.length &&
        o.tooltip_show &&
        (r.tooltip
          .html(
    ...
    (T.hasType = function (t, e) {
      var i = this.config.data_types,
        n = !1;
      return (
        (e = e || this.data.targets) && e.length
          ? e.forEach(function (e) {
              var a = i[e.id];
              ((a && a.indexOf(t) >= 0) || (!a && "line" === t)) && (n = !0);
            })
          : Object.keys(i).length
          ? Object.keys(i).forEach(function (e) {
              i[e] === t && (n = !0);
            })
          : (n = this.config.data_type === t),
        n
      );
    }),
      ...
      return (
        (e.zoom = i
          ...
          .on("start", function () {
            ...
            (a && "brush" === a.type) ||
              ((t = a), n.zoom_onzoomstart.call(e.api, a));
          })
          .on("zoom", function () {
        ...
        (e.zoom.updateDomain = function () {
          return (
            i.event &&
              i.event.transform &&
              e.x.domain(i.event.transform.rescaleX(e.subX).domain()),
            this
          );
        }),
