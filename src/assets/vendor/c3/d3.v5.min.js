...
(function (t, n) {
  ...
  function h(t, n, e) {
    var r = (n - t) / Math.max(0, e),
      ...
      o = r / Math.pow(10, i);
    return i >= 0
      ? (o >= is ? 10 : o >= os ? 5 : o >= as ? 2 : 1) * Math.pow(10, i)
      : -Math.pow(10, -i) / (o >= is ? 10 : o >= os ? 5 : o >= as ? 2 : 1);
  }
  function d(t, n, e) {
      ...
      (m = m.merge(
        ...
        (S = S.merge(
          T.append("text")
            .attr("fill", "#000")
            .attr(s, c * p)
            .attr("dy", t === fs ? "0em" : t === ss ? "0.71em" : "0.32em")
        )),
        e !== b &&
          ((m = m.transition(e)),
          (w = w.transition(e)),
        ...
        m.attr(
          "d",
          t === ls || t == cs
            ? "M" + c * u + "," + g + "H0.5V" + y + "H" + c * u
            : "M" + g + "," + c * u + "V0.5H" + y + "V" + c * u
        ),
    ...
    return (
      ...
      (e.tickArguments = function (t) {
        return arguments.length
          ? ((r = null == t ? [] : us.call(t)), e)
          : r.slice();
      }),
      (e.tickValues = function (t) {
        return arguments.length
          ? ((i = null == t ? null : us.call(t)), e)
          : i && i.slice();
      }),
  ...
  function k(t) {
    ...
    return (
      ...
      vs.hasOwnProperty(n) ? { space: vs[n], local: t } : t
    );
  }
  function C(t) {
    var n = k(t);
        ...
        : function (t) {
            return function () {
              var n = this.ownerDocument,
                e = this.namespaceURI;
              return e === ps && n.documentElement.namespaceURI === ps
                ? n.createElement(t)
  ...
  function O(t, n, e, r, i, o, a) {
    ...
    for (u = 0; u < l; ++u)
      (f = n[u]) &&
        ((d[u] = c = ms + a.call(f, f.__data__, u, n)),
        c in s ? (i[u] = f) : (s[c] = f));
    for (u = 0; u < h; ++u)
      (f = s[(c = ms + a.call(t, o[u], u, o))])
        ? ((r[u] = f), (f.__data__ = o[u]), (s[c] = null))
        : (e[u] = new U(t, o[u]));
    ...
    return function (i, o, a) {
      ...
      if (f)
        for (var s = 0, l = f.length; s < l; ++s)
          if ((u = f[s]).type === t.type && u.name === t.name)
            return (
  ...
  function _t(t) {
    var n = t.document.documentElement,
      e = ct(t).on("dragstart.drag", yt, !0);
    "onselectstart" in n
      ? e.on("selectstart.drag", yt, !0)
  ...
  function kt(t) {
    ...
    return (
      ...
      (n = Ss.exec(t))
        ...
        ? Ct(parseInt(n[1], 16))
        : (n = ks.exec(t))
        ? new Lt(n[1], n[2], n[3], 1)
        : (n = Cs.exec(t))
        ? new Lt((255 * n[1]) / 100, (255 * n[2]) / 100, (255 * n[3]) / 100, 1)
        : (n = Ps.exec(t))
        ? Pt(n[1], n[2], n[3], n[4])
        : (n = zs.exec(t))
        ? Pt((255 * n[1]) / 100, (255 * n[2]) / 100, (255 * n[3]) / 100, n[4])
        : (n = Rs.exec(t))
          ...
          return (
            u
              ? ((a =
                ...
                (a *= 60))
              : (u = f > 0 && f < 1 ? 0 : a),
            new Ot(a, u, f, t.opacity)
          );
        })(t)
      : new Ot(t, n, e, null == r ? 1 : r);
  }
  function Ot(t, n, e, r) {
  ...
  function Bt(t) {
    ...
    var e,
      ...
      o = Gt(t.g),
      a = Gt(t.b),
      u = jt((0.2225045 * i + 0.7168786 * o + 0.0606169 * a) / Ys);
    return (
      i === o && o === a
        ? (e = r = u)
        : ((e = jt((0.4360747 * i + 0.3850649 * o + 0.1430804 * a) / Os)),
          (r = jt((0.0139322 * i + 0.0971045 * o + 0.7141733 * a) / Bs))),
      new It(116 * u - 16, 500 * (e - u), 200 * (u - r), t.opacity)
    );
  }
  function Ft(t, n, e, r) {
  ...
  function Vt(t) {
    ...
    if ((t instanceof It || (t = Bt(t)), 0 === t.a && 0 === t.b))
      return new Wt(NaN, 0, t.l, t.opacity);
    ...
    return 1 === arguments.length
      ? (function (t) {
          ...
          var n = t.r / 255,
            e = t.g / 255,
            r = t.b / 255,
            i = (Zs * r + $s * n - Ws * e) / (Zs + $s - Ws),
            o = r - i,
            a = (Vs * (e - i) - Xs * o) / Gs,
            u = Math.sqrt(a * a + o * o) / (Vs * i * (1 - i)),
  ...
  function rn(t, n) {
    var e = n - t;
    return e
      ? en(t, e > 180 || e < -180 ? e - 360 * Math.round(e / 360) : e)
      : nn(isNaN(t) ? n : t);
  }
  function on(t) {
    return 1 == (t = +t)
  ...
  function hn(t, n) {
    var e,
      r,
      i,
      o = (al.lastIndex = ul.lastIndex = 0),
      a = -1,
      u = [],
      f = [];
    for (t += "", n += ""; (e = al.exec(t)) && (r = ul.exec(n)); )
      (i = r.index) > o &&
  ...
  function vn(t, n, e, r, i, o) {
    ...
    return (
      ...
      (u = Math.sqrt(e * e + r * r)) && ((e /= u), (r /= u), (f /= u)),
      t * r < n * e && ((t = -t), (n = -n), (f = -f), (a = -a)),
      {
        translateX: i,
        translateY: o,
  ...
  function gn(t, n, e, r) {
    ...
    return function (o, a) {
      ...
      return (
        ...
        (function (t, n, e, o) {
          t !== n
            ? (t - n > 180 ? (n += 360) : n - t > 180 && (t += 360),
              o.push({ i: e.push(i(e) + "rotate(", null, r) - 2, x: sn(t, n) }))
            : n && e.push(i(e) + "rotate(" + n + r);
        })(o.rotate, a.rotate, u, f),
        (function (t, n, e, o) {
          t !== n
            ? o.push({ i: e.push(i(e) + "skewX(", null, r) - 2, x: sn(t, n) })
        ...
        })(o.scaleX, o.scaleY, a.scaleX, a.scaleY, u, f),
        (o = a = null),
        function (t) {
  ...
  function _n(t, n) {
    ...
    if (h < vl)
      ...
      var d = Math.sqrt(h),
        p = (c * c - a * a + pl * h) / (2 * a * dl * d),
        v = (c * c - a * a - pl * h) / (2 * c * dl * d),
  ...
  function Nn() {
    wn(), ++wl;
    for (var t, n = nl; n; )
      (t = Sl - n._time) >= 0 && n._call.call(null, t), (n = n._next);
    --wl;
  }
  function Sn() {
  ...
  function kn(t) {
    if (!wl) {
      ...
      t - Sl > 24
        ? (t < 1 / 0 && (Ml = setTimeout(Sn, t - kl.now() - El)),
          Al && (Al = clearInterval(Al)))
        : (Al || ((Nl = kl.now()), (Al = setInterval(En, Tl))),
          (wl = 1),
          Cl(Sn));
    }
  }
          ...
          if ((h = u[c]).name === e.name) {
            ...
            h.state === ql
              ? ((h.state = Yl),
                ...
                delete u[c])
              : +c < n && ((h.state = Yl), h.timer.stop(), delete u[c]);
          }
        if (
          (Cn(function () {
            e.state === Ul &&
              ((e.state = ql), e.timer.restart(i, e.delay, e.time), i(f));
          }),
          (e.state = Dl),
          ...
          for (
            e.state = Ul, a = new Array((l = e.tween.length)), c = 0, s = -1;
            c < l;
            ++c
          )
        ...
        for (
          var r =
              n < e.duration
                ...
                : (e.timer.restart(o), (e.state = Ol), 1),
            i = -1,
            u = a.length;
          ++i < u;
  ...
  function Vn(t, n) {
    for (var e; !(e = t.__transition) || !(e = e[n]); )
      if (!(t = t.parentNode)) return (lh.time = wn()), lh;
    return e;
  }
  function $n(t) {
    return function () {
    ...
    function e(t) {
      ...
      i.exit().remove(),
        ...
        t
          ...
          .on("mousedown.brush touchstart.brush", a);
    }
    function r() {
      var t = ct(this),
        n = te(this).selection;
    ...
    function a() {
      function e() {
        ...
        !L ||
          m ||
          x ||
          (Math.abs(t[0] - U[0]) > Math.abs(t[1] - U[1]) ? (x = !0) : (m = !0)),
          (U = t),
          (b = !0),
          Zn(),
          o();
      ...
      function o() {
        ...
        switch (((y = U[0] - D[0]), (_ = U[1] - D[1]), A)) {
          ...
          case dh:
            T &&
              ((y = Math.max(C - u, Math.min(z - d, y))),
              (c = u + y),
              (p = d + y)),
              N &&
                ((_ = Math.max(P - l, Math.min(R - v, _))),
                (h = l + _),
                (g = v + _));
            break;
          case vh:
            T < 0
              ? ((y = Math.max(C - u, Math.min(z - u, y))),
                (c = u + y),
                (p = d))
              : T > 0 &&
                ((y = Math.max(C - d, Math.min(z - d, y))),
                (c = u),
                (p = d + y)),
              N < 0
                ? ((_ = Math.max(P - l, Math.min(R - l, _))),
                  (h = l + _),
                  (g = v))
                : N > 0 &&
                  ((_ = Math.max(P - v, Math.min(R - v, _))),
                  (h = l),
                  (g = v + _));
            break;
          case gh:
            T &&
              ((c = Math.max(C, Math.min(z, u - y * T))),
              (p = Math.max(C, Math.min(z, d + y * T)))),
              N &&
                ((h = Math.max(P, Math.min(R, l - _ * N))),
                (g = Math.max(P, Math.min(R, v + _ * N))));
        }
        p < c &&
          ((T *= -1),
          (t = u),
          ...
          (c = p),
          (p = t),
          M in xh && Y.attr("cursor", mh[(M = xh[M])])),
          g < h &&
            ((N *= -1),
            (t = l),
            (l = v),
            ...
            (h = g),
            (g = t),
            M in wh && Y.attr("cursor", mh[(M = wh[M])])),
          S.selection && (k = S.selection),
          m && ((c = k[0][0]), (p = k[1][0])),
          x && ((h = k[0][1]), (g = k[1][1])),
          (k[0][0] === c && k[0][1] === h && k[1][0] === p && k[1][1] === g) ||
            ((S.selection = [
              [c, h],
              [p, g],
            ]),
      ...
      function a() {
        ...
        O.attr("pointer-events", "all"),
          Y.attr("cursor", mh.overlay),
          S.selection && (k = S.selection),
          ne(k) && ((S.selection = null), r.call(w)),
          q.end();
      }
      if (t.event.touches) {
      ...
      if (s.apply(this, arguments)) {
        var u,
          ...
          A =
            "selection" === (t.event.metaKey ? (M = "overlay") : M)
              ? dh
              : t.event.altKey
              ? gh
              : vh,
          ...
          D = pt(w),
          U = D,
          q = i(w, arguments).beforestart();
        "overlay" === M
          ? (S.selection = k =
              [
                [(u = n === _h ? C : D[0]), (l = n === yh ? P : D[1])],
                [(d = n === _h ? z : u), (v = n === yh ? R : l)],
              ])
          : ((u = k[0][0]), (l = k[0][1]), (d = k[1][0]), (v = k[1][1])),
          (c = u),
          (h = l),
          (p = d),
          (g = v);
        var O = ct(w).attr("pointer-events", "none"),
          Y = O.selectAll(".overlay").attr("cursor", mh[M]);
        if (t.event.touches)
          O.on("touchmove.brush", e, !0).on(
            "touchend.brush touchcancel.brush",
            a,
            !0
          );
        else {
          var B = ct(t.event.view)
            .on(
              "keydown.brush",
              function () {
        ...
        t.selection
          ...
          : t.each(function () {
              var t = arguments,
                ...
                u = i(this, t).beforestart();
              Dn(this),
                (o.selection = null == a || ne(a) ? null : a),
                r.call(this),
                u.start().brush().end();
            });
      }),
      (o.prototype = {
        ...
        emit: function (t) {
          ot(
            ...
            })(e, t, n.output(this.state.selection)),
            l.apply,
            l,
  ...
  function Me() {
    function t(t) {
      var e = a(t);
      if (Array.isArray(e)) e = e.slice().sort(be);
      else {
        var r = u(t),
          i = r[0],
          o = r[1];
        (e = d(i, o, e)),
          (e = s(Math.floor(i / e) * e, Math.floor(o / e) * e, e));
      }
    ...
    function n(t, n) {
      ...
      return (
        (function (t, n, r) {
          function a(t) {
            ...
            (n = p[c])
              ? (i = d[s])
                ...
                : (delete p[n.end], n.ring.push(a), (p[(n.end = s)] = n))
              : (n = d[s])
              ? (i = p[c])
                ? (delete d[n.start],
                  delete p[i.end],
                ...
                : (delete d[n.start], n.ring.unshift(o), (d[(n.start = c)] = n))
              : (d[c] = p[s] = { start: c, end: s, ring: [o, a] });
          }
          var u,
            f,
            c,
          ...
          for (; ++u < i - 1; )
            (c = s), (s = t[u + 1] >= n), qh[c | (s << 1)].forEach(a);
          qh[s << 0].forEach(a);
          for (; ++f < o - 1; ) {
            for (
              u = -1,
    ...
    function r(t, n, e) {
      t.forEach(function (t) {
        ...
        a > 0 &&
          a < i &&
          f === a &&
          ((r = n[c * i + f - 1]), (t[0] = a + (e - r) / (s - r) - 0.5)),
          u > 0 &&
            u < o &&
            c === u &&
            ((r = n[(c - 1) * i + f]), (t[1] = u + (e - r) / (s - r) - 0.5));
      });
    }
    var i = 1,
      o = 1,
  ...
  function Ae(t, n, e) {
    for (var r = t.width, i = t.height, o = 1 + (e << 1), a = 0; a < i; ++a)
      for (var u = 0, f = 0; u < r + e; ++u)
        u < r && (f += t.data[u + a * r]),
          u >= e &&
            (u >= o && (f -= t.data[u - o + a * r]),
            (n.data[u - e + a * r] = f / Math.min(u + 1, r - 1 + o - u, o)));
  }
  function Te(t, n, e) {
    for (var r = t.width, i = t.height, o = 1 + (e << 1), a = 0; a < r; ++a)
      for (var u = 0, f = 0; u < i + e; ++u)
        u < i && (f += t.data[a + u * r]),
          u >= e &&
            (u >= o && (f -= t.data[a + (u - o) * r]),
            (n.data[a + (u - e) * r] = f / Math.min(u + 1, i - 1 + o - u, o)));
  }
  function Ne(t) {
    return t[0];
  }
    ...
    function n(t, n) {
      function e() {
        ...
        if (t.charCodeAt(r) === Bh) {
          for (
            ;
            (u++ < a && t.charCodeAt(u) !== Bh) || t.charCodeAt(++u) === Bh;
          ...
          return (
            (n = u) >= a
              ...
              : (e = t.charCodeAt(u++)) === Fh
              ? (s = !0)
              : e === Ih && ((s = !0), t.charCodeAt(u) === Fh && ++u),
            t.slice(r + 1, n - 1).replace(/""/g, '"')
          );
        }
        for (; u < a; ) {
          if ((e = t.charCodeAt((n = u++))) === Fh) s = !0;
          else if (e === Ih) (s = !0), t.charCodeAt(u) === Fh && ++u;
      ...
      var r,
        ...
        s = !1;
      for (
        t.charCodeAt(a - 1) === Fh && --a, t.charCodeAt(a - 1) === Ih && --a;
        (r = e()) !== Yh;
          ...
          if (
            ...
            for (n = -1, r = t.length; ++n < r; )
              if (48 > (a = t.charCodeAt(n)) || a > 57) {
                (x = (46 === a ? i + t.slice(n + 1) : t.slice(n)) + x),
                  (t = t.slice(0, n));
                break;
              }
        }
        d && !l && (t = e(t, 1 / 0));
        var M = s.length + t.length + x.length,
          A = M < h ? new Array(h - M + 1).join(u) : "";
        switch (
          (d &&
            l &&
            ((t = e(A + t, A.length ? h - x.length : 1 / 0)), (A = "")),
          f)
        ) {
          case "<":
            t = s + t + x + A;
    ...
    var e =
        t.grouping && t.thousands
          ? (function (t, n) {
              return function (e, r) {
                for (
                  var i = e.length, o = [], a = 0, u = t[0], f = 0;
                  i > 0 &&
                  u > 0 &&
  ...
  function or(n) {
    return (
      (cd = ir(n)),
      (t.format = cd.format),
      (t.formatPrefix = cd.formatPrefix),
      cd
    );
  }
  function ar(t) {
  ...
  function ur(t, n) {
    return Math.max(
      0,
      3 * Math.max(-8, Math.min(8, Math.floor(Ke(n) / 3))) - Ke(Math.abs(t))
    );
  }
  function fr(t, n) {
    return (
      (t = Math.abs(t)), (n = Math.abs(n) - t), Math.max(0, Ke(n) - Ke(t)) + 1
    );
  }
  function cr() {
    return new sr();
  ...
  function zr(t, n) {
    ...
    if (Ad) {
      ...
      c ^ (u * xd < f && f < u * t)
        ...
        c
          ? t < xd
            ? Or(yd, t) > Or(yd, bd) && (bd = t)
            : Or(t, bd) > Or(yd, bd) && (yd = t)
          : bd >= yd
          ? (t < yd && (yd = t), t > bd && (bd = t))
          : t > xd
          ? Or(yd, t) > Or(yd, bd) && (bd = t)
  ...
  function ii(t) {
    ...
    return (
      (t = ti(t[0] * Qd, t[1] * Qd, t.length > 2 ? t[2] * Qd : 0)),
      (n.invert = function (n) {
        return (
          (n = t.invert(n[0] * Qd, n[1] * Qd)), (n[0] *= Zd), (n[1] *= Zd), n
        );
      }),
      n
    );
  ...
  function oi(t, n, e, r, i, o) {
    if (e) {
      ...
      for (var c, s = i; r > 0 ? s > o : s < o; s -= f)
        (c = Ar([a, -u * np(s), -u * ap(s)])), t.point(c[0], c[1]);
    }
  }
  function ai(t, n) {
    ((n = Tr(n))[0] -= t), Cr(n);
      ...
      (t.forEach(function (t) {
        if (!((n = t.length - 1) <= 0)) {
          ...
          if (fi(r, a)) {
            ...
            u.push((e = new ci(r, t, null, !0))),
              f.push((e.o = new ci(r, null, e, !1))),
              u.push((e = new ci(a, t, null, !1))),
              f.push((e.o = new ci(a, null, e, !0)));
        }
      }),
      u.length)
    ) {
    ...
    return function (i) {
      ...
      function l() {
        ...
        var t,
          ...
          a = g.result(),
          u = a.length;
        if ((p.pop(), h.push(p), (p = null), u))
          if (1 & o) {
            if (((e = a[0]), (n = e.length - 1) > 0)) {
              for (
                b || (i.polygonStart(), (b = !0)), i.lineStart(), t = 0;
                t < n;
                ++t
              )
                i.point((r = e[t])[0], r[1]);
            ...
            u > 1 && 2 & o && a.push(a.pop().concat(a.shift())),
              d.push(a.filter(pi));
      }
      var h,
        d,
        ...
        m = {
          ...
          polygonEnd: function () {
            ...
            var t = hi(h, r);
            d.length
              ? (b || (i.polygonStart(), (b = !0)), si(d, vi, t, e, i))
              : t &&
  ...
  function vi(t, n) {
    return (
      ((t = t.x)[0] < 0 ? t[1] - Vd - Hd : Vd - t[1]) -
      ((n = n.x)[0] < 0 ? n[1] - Vd - Hd : Vd - n[1])
    );
  }
  function gi(t) {
    function n(t, n) {
        ...
        return {
          ...
          point: function (l, h) {
            var d,
              p = [l, h],
              v = n(l, h),
              g = a ? (v ? 0 : r(l, h)) : v ? r(l + (l < 0 ? Gd : -Gd), h) : 0;
            if (
              (!i && (c = f = v) && t.lineStart(),
              v !== f &&
                (!(d = e(i, p)) || fi(i, d) || fi(p, d)) &&
                ((p[0] += Hd), (p[1] += Hd), (v = n(p[0], p[1]))),
              v !== f)
            )
              (s = 0),
                v
                  ? (t.lineStart(), (d = e(p, i)), t.point(d[0], d[1]))
                  : ((d = e(i, p)), t.point(d[0], d[1]), t.lineEnd()),
                (i = d);
            else if (u && i && a ^ v) {
              var y;
              g & o ||
    ...
    return function (a) {
      ...
      function c(o, a) {
        ...
        if ((l && h.push([o, a]), m))
          (d = o),
            ...
            (v = u),
            (m = !1),
            u && (w.lineStart(), w.point(o, a));
        else if (u && b) w.point(o, a);
        else {
          var f = [
              (g = Math.max(zp, Math.min(Pp, g))),
              (_ = Math.max(zp, Math.min(Pp, _))),
            ],
            c = [
              (o = Math.max(zp, Math.min(Pp, o))),
              (a = Math.max(zp, Math.min(Pp, a))),
            ];
          !(function (t, n, e, r, i, o) {
              ...
              if (((a = i - u), l || !(a < 0))) {
                ...
                if (((a = r - f), h || !(a > 0))) {
                  ...
                  if (((a = o - f), h || !(a < 0))) {
                    ...
                    return (
                      c > 0 && ((t[0] = u + c * l), (t[1] = f + c * h)),
                      s < 1 && ((n[0] = u + s * l), (n[1] = f + s * h)),
                      !0
                    );
                  }
                }
            ...
            ? u && (w.lineStart(), w.point(o, a), (x = !1))
            : (b || (w.lineStart(), w.point(f[0], f[1])),
              w.point(c[0], c[1]),
              u || w.lineEnd(),
              (x = !1));
        }
      ...
      var s,
        ...
        A = {
          ...
          lineEnd: function () {
            s && (c(d, p), v && b && M.rejoin(), s.push(M.result())),
              (A.point = f),
              b && w.lineEnd();
          },
          polygonStart: function () {
  ...
  function Pi() {
    ...
    function n() {
      return s(ep(o / y) * y, i, y)
        .map(d)
        .concat(s(ep(c / _) * _, f, _).map(p))
        .concat(
          s(ep(r / v) * v, e, v)
            .filter(function (t) {
              return Jd(t % y) > Hd;
          ...
          function e(r, i, o, a, u, f, c, s, l, h, d, p, v, g) {
            ...
            if (b > 4 * n && v--) {
              var m = a + h,
                ...
                A = dr((w /= M)),
                T =
                  Jd(Jd(w) - 1) < Hd || Jd(o - l) < Hd ? (o + l) / 2 : tp(x, m),
                N = t(T, A),
                S = N[0],
                E = N[1],
                k = S - r,
                ...
                P = _ * k - y * C;
              ((P * P) / b > n ||
                Jd((y * k + _ * C) / b - 0.5) > 0.3 ||
                a * h + u * d + f * p < lv) &&
                (e(r, i, o, a, u, f, S, E, T, (m /= M), (x /= M), w, v, g),
                g.point(S, E),
                e(S, E, T, m, x, w, c, s, l, h, d, p, v, g));
            }
          }
          return function (n) {
            function r(e, r) {
            ...
            function c() {
              e(y, _, g, b, m, x, l, h, s, d, p, v, sv, n),
                (w.lineEnd = a),
                a();
            }
            var s,
  ...
  function uo(t) {
    ...
    function e() {
      ...
      return (
        (o = ti(b, m, x)), (s = Jr(i, n)), (l = Jr(o, s)), (c = io(s, S)), r()
      );
    }
    function r() {
      return (h = d = null), n;
  ...
  function _o(t, n) {
    ...
    var r = np(t),
      i = t === n ? ap(t) : ip(r / np(n)) / ip(yo(n) / yo(t)),
      o = (r * op(yo(t), i)) / i;
    return i
      ? ((e.invert = function (t, n) {
          var e = o - n,
  ...
  function Go(t) {
    ...
    t: for (u = 3; u < i; ++u) {
      ...
      for (
        r.previous = n, r.next = e, n.next = e.previous = e = r, o = Ho(n);
        (r = r.next) !== e;
  ...
  function la(t, n, e, r, i, o) {
    for (
      ...
      y.push((a = { value: s, dice: f < c, children: _.slice(b, m) })),
        a.dice
          ? na(a, e, r, i, w ? (r += (c * s) / w) : o)
          : sa(a, e, r, w ? (e += (f * s) / w) : i, o),
        (w -= s),
        (b = m);
    }
    return y;
  ...
  function Ta(t, n) {
    function e() {
      return (
        (i = Math.min(u.length, f.length) > 2 ? Ma : wa), (o = a = null), r
      );
    }
    function r(n) {
      return (
      ...
      (n.tickFormat = function (n, r) {
        return (function (n, e, r) {
          ...
          switch ((r = tr(null == r ? ",f" : r)).type) {
            ...
            case "r":
              null != r.precision ||
                isNaN((i = fr(u, Math.max(Math.abs(o), Math.abs(a))))) ||
  ...
  function Ua() {
    function n() {
      return (
        (o = La(i)), (a = Ra(i)), r()[0] < 0 && ((o = Da(o)), (a = Da(a))), e
      );
    }
  ...
  function Fa() {
    ...
    return (
      (t.domain = function (i) {
        return arguments.length
          ? ((n = Cv.call(i)), (r = Math.min(n.length, e.length - 1)), t)
          : n.slice();
      }),
      (t.range = function (i) {
        return arguments.length
          ? ((e = Cv.call(i)), (r = Math.min(n.length, e.length - 1)), t)
          : e.slice();
      }),
      (t.invertExtent = function (t) {
        var r = e.indexOf(t);
    ...
    return (
      ...
      e &&
        ((i.count = function (n, r) {
          return (
            Rv.setTime(+n), Lv.setTime(+r), t(Rv), t(Lv), Math.floor(e(Rv, Lv))
          );
        }),
        (i.every = function (t) {
          return (
  ...
  function ja(t) {
    return Ia(
      ...
      function (t, n) {
        return (
          (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * qv) / Ov
        );
      }
    );
  }
      ...
      return function (e) {
        ...
        if (("p" in a && (a.H = (a.H % 12) + 12 * a.p), "V" in a)) {
          ...
          "w" in a || (a.w = 1),
            "Z" in a
              ? ((i =
                  (o = (i = Ga(Va(a.y))).getUTCDay()) > 4 || 0 === o
                    ? _g.ceil(i)
                    : _g(i)),
                (i = vg.offset(i, 7 * (a.V - 1))),
                (a.y = i.getUTCFullYear()),
                (a.m = i.getUTCMonth()),
                (a.d = i.getUTCDate() + ((a.w + 6) % 7)))
              : ((i =
                  (o = (i = n(Va(a.y))).getDay()) > 4 || 0 === o
                    ? $v.ceil(i)
                    : $v(i)),
                (i = Xv.offset(i, 7 * (a.V - 1))),
                (a.y = i.getFullYear()),
                (a.m = i.getMonth()),
        ...
        return "Z" in a
          ? ((a.H += (a.Z / 100) | 0), (a.M += a.Z % 100), Ga(a))
          : n(a);
      };
    }
    function r(t, n, e, r) {
      for (var i, o, a = 0, u = n.length, f = e.length; a < u; ) {
        ...
        if (37 === (i = n.charCodeAt(a++))) {
          if (
            ((i = n.charAt(a++)),
            !(o = A[i in Ug ? n.charAt(a++) : i]) || (r = o(t, e, r)) < 0)
          )
            return -1;
  ...
  function ku(t, n) {
    var e = t.getDay();
    return (
      (t = e >= 4 || 0 === e ? Qv(t) : Qv.ceil(t)),
      Wa(Qv.count(cg(t), t) + (4 === cg(t).getDay()), n, 2)
    );
  }
  function Cu(t) {
    return t.getDay();
  ...
  function Gu(t, n) {
    var e = t.getUTCDay();
    return (
      (t = e >= 4 || 0 === e ? xg(t) : xg.ceil(t)),
      Wa(xg.count(Rg(t), t) + (4 === Rg(t).getUTCDay()), n, 2)
    );
  }
  function Vu(t) {
    return t.getUTCDay();
  ...
  function nf(n) {
    return (
      (Lg = $a(n)),
      (t.timeFormat = Lg.format),
      (t.timeParse = Lg.parse),
      (t.utcFormat = Lg.utcFormat),
      (t.utcParse = Lg.utcParse),
      Lg
    );
  }
  function ef(t) {
    ...
    function l(n, r, i, o) {
      if ((null == n && (n = 10), "number" == typeof n)) {
        ...
        u === A.length
          ? ((o = d(r / Wg, i / Wg, n)), (n = t))
          : u
          ? ((o = (u = A[a / A[u - 1][2] < A[u][2] / a ? u - 1 : u])[1]),
            (n = u[0]))
          : ((o = Math.max(d(r, i, n), 1)), (n = f));
      }
  ...
  function Mf() {
    function t(t) {
      var u,
        ...
        s = t.length,
        l = !1;
      for (null == i && (a = o((c = oe()))), u = 0; u <= s; ++u)
        !(u < s && r((f = t[u]), u, t)) === l &&
          ((l = !l) ? a.lineStart() : a.lineEnd()),
          l && a.point(+n(f, u, t), +e(f, u, t));
    ...
    return (
      (t.x = function (e) {
        return arguments.length
          ? ((n = "function" == typeof e ? e : lf(+e)), t)
          : n;
      }),
      (t.y = function (n) {
        return arguments.length
          ? ((e = "function" == typeof n ? n : lf(+n)), t)
          : e;
      }),
      (t.defined = function (n) {
        return arguments.length
          ? ((r = "function" == typeof n ? n : lf(!!n)), t)
          : r;
      }),
      (t.curve = function (n) {
  ...
  function Af() {
    function t(t) {
      ...
      for (null == u && (c = f((d = oe()))), n = 0; n <= p; ++n) {
        if (!(n < p && a((h = t[n]), n, t)) === v)
          if ((v = !v)) (s = n), c.areaStart(), c.lineStart();
          else {
    ...
    return (
      (t.x = function (n) {
        return arguments.length
          ? ((e = "function" == typeof n ? n : lf(+n)), (r = null), t)
          : e;
      }),
      (t.x0 = function (n) {
        return arguments.length
      ...
      (t.x1 = function (n) {
        return arguments.length
          ? ((r = null == n ? null : "function" == typeof n ? n : lf(+n)), t)
          : r;
      }),
      (t.y = function (n) {
        return arguments.length
          ? ((i = "function" == typeof n ? n : lf(+n)), (o = null), t)
          : i;
      }),
      (t.y0 = function (n) {
        return arguments.length
          ? ((i = "function" == typeof n ? n : lf(+n)), t)
          : i;
      }),
      (t.y1 = function (n) {
        return arguments.length
          ? ((o = null == n ? null : "function" == typeof n ? n : lf(+n)), t)
          : o;
      }),
      (t.lineX0 = t.lineY0 =
        function () {
  ...
  function Df(t) {
    ...
    return (
      ...
      (n.x = function (t) {
        return arguments.length
          ? ((i = "function" == typeof t ? t : lf(+t)), n)
          : i;
      }),
      (n.y = function (t) {
        return arguments.length
          ? ((o = "function" == typeof t ? t : lf(+t)), n)
          : o;
      }),
  ...
  function Wf(t, n, e) {
    ...
    if (t._l01_a > M_) {
      ...
      (r = (r * u - t._x0 * t._l12_2a + t._x2 * t._l01_2a) / f),
        (i = (i * u - t._y0 * t._l12_2a + t._y2 * t._l01_2a) / f);
    }
    if (t._l23_a > M_) {
      var c = 2 * t._l23_2a + 3 * t._l23_a * t._l12_a + t._l12_2a,
        s = 3 * t._l23_a * (t._l23_a + t._l12_a);
      (o = (o * c + t._x1 * t._l23_2a - n * t._l12_2a) / s),
        (a = (a * c + t._y1 * t._l23_2a - e * t._l12_2a) / s);
    }
  ...
  function nc(t, n, e) {
    var r = t._x1 - t._x0,
      ...
      u = (o * i + a * r) / (r + i);
    return (
      (tc(o) + tc(a)) * Math.min(Math.abs(o), Math.abs(a), 0.5 * Math.abs(u)) ||
      0
    );
  }
  function ec(t, n) {
  ...
  function Mc(t, n, e, r) {
    ...
    return (
      ...
      e && Tc(i, t, n, e),
      r && Tc(i, n, t, r),
      nb[t.index].halfedges.push(o),
      nb[n.index].halfedges.push(o),
      i
    );
  }
  function Ac(t, n, e) {
  ...
  function zc(t) {
    var n = t.circle;
    n &&
      (n.P || (K_ = n.N), eb.remove(n), ib.push(n), bc(n), (t.circle = null));
  }
  function Rc(t) {
    var n =
      ob.pop() ||
  ...
  function Dc(t) {
    ...
    for (
      var f = o;
      f.circle &&
      Math.abs(e - f.circle.x) < ab &&
      Math.abs(r - f.circle.cy) < ab;

    )
      (o = f.P), u.unshift(f), Lc(f), (f = o);
    u.unshift(f), zc(f);
    for (
      var c = a;
      c.circle &&
      Math.abs(e - c.circle.x) < ab &&
      Math.abs(r - c.circle.cy) < ab;

    )
      (a = c.N), u.push(c), Lc(c), (c = a);
    u.push(c), zc(c);
    var s,
      l = u.length;
    for (s = 1; s < l; ++s)
      (c = u[s]), (f = u[s - 1]), Tc(c.edge, f.site, c.site, i);
    (f = u[0]),
      ((c = u[l - 1]).edge = Mc(f.site, c.site, null, i)),
      Pc(f),
      Pc(c);
  }
  function Uc(t) {
    for (var n, e, r, i, o = t[0], a = t[1], u = tb._; u; )
      if ((r = qc(u, a) - o) > ab) u = u.L;
      else {
        if (
          !(
            (i =
    ...
    if ((tb.insert(n, f), n || e)) {
      if (n === e)
        return (
          ...
          (e = Rc(n.site)),
          tb.insert(f, e),
          (f.edge = e.edge = Mc(n.site, f.site)),
          Pc(n),
          void Pc(e)
        );
      if (e) {
        ...
        Tc(e.edge, c, p, m),
          (f.edge = Mc(c, t, null, m)),
          (e.edge = Mc(t, p, null, m)),
          Pc(n),
          Pc(e);
  ...
  function Bc(t, n) {
    var e,
      ...
      i,
      o = t.sort(Yc).pop();
    for (rb = [], nb = new Array(t.length), tb = new _c(), eb = new _c(); ; )
      if (((i = K_), o && (!i || o[1] < i.y || (o[1] === i.y && o[0] < i.x))))
        (o[0] === e && o[1] === r) || (Uc(o), (e = o[0]), (r = o[1])),
          (o = t.pop());
      else {
        if (!i) break;
        Dc(i.arc);
    ...
    if (
      ((function () {
        for (var t, n, e, r, i = 0, o = nb.length; i < o; ++i)
          if ((t = nb[i]) && (r = (n = t.halfedges).length)) {
            var a = new Array(r),
              u = new Array(r);
      ...
      var a = +n[0][0],
        ...
        c = +n[1][1];
      (function (t, n, e, r) {
        for (var i, o = rb.length; o--; )
          (Sc((i = rb[o]), t, n, e, r) &&
            Nc(i, t, n, e, r) &&
            (Math.abs(i[0][0] - i[1][0]) > ab ||
              Math.abs(i[0][1] - i[1][1]) > ab)) ||
            delete rb[o];
      })(a, u, f, c),
        (function (t, n, e, r) {
          var i,
            ...
            if ((o = nb[i])) {
              ...
              for (u = 0, c = f.length; u < c; )
                (p = (d = Cc(o, rb[f[u]]))[0]),
                  ...
                  (l = (s = kc(o, rb[f[++u % c]]))[0]),
                  (h = s[1]),
                  (Math.abs(p - l) > ab || Math.abs(v - h) > ab) &&
                    (f.splice(
                      u,
                      0,
                      rb.push(
                        Ac(
                          a,
                          d,
                          Math.abs(p - t) < ab && r - v > ab
                            ? [t, Math.abs(l - t) < ab ? h : r]
                            : Math.abs(v - r) < ab && e - p > ab
                            ? [Math.abs(h - r) < ab ? l : e, r]
                            : Math.abs(p - e) < ab && v - n > ab
                            ? [e, Math.abs(l - e) < ab ? h : n]
                            : Math.abs(v - n) < ab && p - t > ab
                            ? [Math.abs(h - n) < ab ? l : t, n]
                            : null
                        )
                      ) - 1
                    ),
          ...
          for (i = 0; i < g; ++i)
            (o = nb[i]) && (o.halfedges.length || delete nb[i]);
        })(a, u, f, c);
    }
    ...
    on: function (t, n) {
        ...
        a = i.length;
      {
        if (!(arguments.length < 2)) {
          ...
          for (; ++o < a; )
            if ((e = (t = i[o]).type)) r[e] = E(r[e], t.name, n);
            else if (null == n) for (e in r) r[e] = E(r[e], t.name, null);
          return this;
        }
        for (; ++o < a; )
          if (
  ...
  if ("undefined" != typeof document) {
    ...
    if (!ys.matches) {
      var _s =
        ys.webkitMatchesSelector ||
        ys.msMatchesSelector ||
        ys.mozMatchesSelector ||
        ys.oMatchesSelector;
      gs = function (t) {
        return function () {
  ...
  if (((t.event = null), "undefined" != typeof document)) {
    "onmouseenter" in document.documentElement ||
      (xs = { mouseenter: "mouseover", mouseleave: "mouseout" });
  }
  var ws = [null];
  ut.prototype = ft.prototype = {
    ...
    select: function (t) {
      ...
      for (
        ...
        for (
          var o, a, u = n[i], f = u.length, c = (r[i] = new Array(f)), s = 0;
          s < f;
          ++s
        )
          (o = u[s]) &&
            (a = t.call(o, o.__data__, s, u)) &&
            ("__data__" in o && (a.__data__ = o.__data__), (c[s] = a));
    ...
    order: function () {
      for (var t = this._groups, n = -1, e = t.length; ++n < e; )
        for (var r, i = t[n], o = i.length - 1, a = i[o]; --o >= 0; )
          (r = i[o]) &&
            (a && a !== r.nextSibling && a.parentNode.insertBefore(r, a),
            (a = r));
      return this;
    },
    sort: function (t) {
      ...
      for (
        ...
        for (
          var a, u = e[o], f = u.length, c = (i[o] = new Array(f)), s = 0;
          s < f;
          ++s
        )
          (a = u[s]) && (c[s] = a);
    ...
    insert: function (t, n) {
      var e = "function" == typeof t ? t : C(t),
        r = null == n ? Q : "function" == typeof n ? n : z(n);
      return this.select(function () {
  ...
  var As = "\\s*([+-]?\\d+)\\s*",
    ...
    Ss = /^#([0-9a-f]{3})$/,
    Es = /^#([0-9a-f]{6})$/,
    ks = new RegExp("^rgb\\(" + [As, As, As] + "\\)$"),
    Cs = new RegExp("^rgb\\(" + [Ns, Ns, Ns] + "\\)$"),
    Ps = new RegExp("^rgba\\(" + [As, As, As, Ts] + "\\)$"),
    zs = new RegExp("^rgba\\(" + [Ns, Ns, Ns, Ts] + "\\)$"),
    Rs = new RegExp("^hsl\\(" + [Ts, Ns, Ns] + "\\)$"),
    Ls = new RegExp("^hsla\\(" + [Ts, Ns, Ns, Ts] + "\\)$"),
    Ds = {
      aliceblue: 15792383,
    ...
    St(Et, {
      ...
      rgb: function () {
        ...
        return (
          ...
          (e = Bs * Ht(e)),
          new Lt(
            Xt(3.1338561 * n - 1.6168667 * t - 0.4906146 * e),
            Xt(-0.9787684 * n + 1.9161415 * t + 0.033454 * e),
            Xt(0.0719453 * n - 0.2289914 * t + 1.4052427 * e),
            this.opacity
          )
        );
      },
  ...
  Nt(
    ...
    St(Et, {
      ...
      rgb: function () {
        var t = isNaN(this.h) ? 0 : (this.h + 120) * Us,
          n = +this.l,
    ...
    rl = (function t(n) {
      function e(t, n) {
        var e = r((t = Rt(t)).r, (n = Rt(n)).r),
          i = r(t.g, n.g),
          o = r(t.b, n.b),
          a = an(t.opacity, n.opacity);
        return function (n) {
          return (
            (t.r = e(n)), (t.g = i(n)), (t.b = o(n)), (t.opacity = a(n)), t + ""
          );
        };
      }
      var r = on(n);
      ...
      function (t) {
        return "none" === t
          ...
          : (Qs ||
              ...
              (Ks = document.defaultView)),
            (Qs.style.transform = t),
            (t = Ks.getComputedStyle(Js.appendChild(Qs), null).getPropertyValue(
              "transform"
            )),
            Js.removeChild(Qs),
            (t = t.slice(7, -1).split(",")),
            vn(+t[0], +t[1], +t[2], +t[3], +t[4], +t[5]));
      },
      "px, ",
      "px)",
      "deg)"
    ...
    ll = gn(
      function (t) {
        return null == t
          ? cl
          : (tl ||
              (tl = document.createElementNS(
                "http://www.w3.org/2000/svg",
                "g"
              )),
            tl.setAttribute("transform", t),
            (t = tl.transform.baseVal.consolidate())
  ...
  An.prototype = Tn.prototype = {
    ...
    restart: function (t, n, e) {
      ...
      (e = (null == e ? wn() : +e) + (null == n ? 0 : +n)),
        this._next ||
          el === this ||
          (el ? (el._next = this) : (nl = this), (el = this)),
        (this._call = t),
        (this._time = e),
        kn();
    },
  ...
  On.prototype = Yn.prototype = {
    ...
    select: function (t) {
      ...
      for (
        ...
        for (
          var u, f, c = r[a], s = c.length, l = (o[a] = new Array(s)), h = 0;
          h < s;
          ++h
        )
          (u = c[h]) &&
            ...
            "function" == typeof n
              ? (function (t, n, e) {
                  ...
                  return function () {
                    ...
                    return (
                      null == u &&
                        (this.style.removeProperty(t), (u = F(this, t))),
                      a === u
                        ? null
                        : a === r && u === i
                        ? o
    ...
    tween: function (t, n) {
      ...
      if (((t += ""), arguments.length < 2)) {
        for (
          var r, i = Ln(this.node(), e).tween, o = 0, a = i.length;
          o < a;
          ++o
        )
          ...
          : function (t, n, e) {
              ...
              return function () {
                ...
                if (a !== r) {
                  i = (r = a).slice();
                  for (
                    var u = { name: n, value: e }, f = 0, c = i.length;
                    f < c;
                    ++f
                  )
                    if (i[f].name === n) {
  ...
  var jl = (function t(n) {
    ...
    lh = { time: null, delay: 0, duration: 250, ease: In };
  (ft.prototype.interrupt = function (t) {
    ...
    (ft.prototype.transition = function (t) {
      ...
      t instanceof On
        ? ((n = t._id), (t = t._name))
        : ((n = Bn()), ((e = lh).time = wn()), (t = null == t ? null : t + ""));
  ...
  var hh = [null],
    ...
    bh = {
      name: "xy",
      handles: ["n", "e", "s", "w", "nw", "ne", "se", "sw"].map(Qn),
      input: function (t) {
        return t;
      },
      output: function (t) {
      ...
      if (null === this._x1)
        ...
        if (Math.abs(s * u - f * c) > 1e-6 && i) {
          var h = e - o,
            ...
            g = Math.sqrt(p),
            y = Math.sqrt(l),
            _ = i * Math.tan((zh - Math.acos((p + l - v) / (2 * g * y))) / 2),
            b = _ / y,
            m = _ / g;
          Math.abs(b - 1) > 1e-6 &&
            (this._ += "L" + (t + b * c) + "," + (n + b * s)),
            (this._ +=
              "A" +
              i +
              "," +
  ...
  (id.copy = function () {
    ...
    (id.addAll = function (t) {
      ...
      for (e = 0; e < o; ++e)
        isNaN((r = +this._x.call(null, (n = t[e])))) ||
          ...
          i > l && (l = i));
      for (
        s < f && ((f = this._x0), (s = this._x1)),
          l < c && ((c = this._y0), (l = this._y1)),
          this.cover(f, c).cover(s, l),
          e = 0;
        e < o;
        ++e
      )
    ...
    (id.visit = function (t) {
      var n,
        ...
        f = this._root;
      for (
        f && u.push(new Be(f, this._x0, this._y0, this._x1, this._y1));
        (n = u.pop());

      )
        if (
          !t((f = n.node), (r = n.x0), (i = n.y0), (o = n.x1), (a = n.y1)) &&
          f.length
        ) {
          var c = (r + o) / 2,
            s = (i + a) / 2;
          (e = f[3]) && u.push(new Be(e, c, s, o, a)),
            (e = f[2]) && u.push(new Be(e, r, s, c, a)),
            (e = f[1]) && u.push(new Be(e, c, i, o, s)),
            (e = f[0]) && u.push(new Be(e, r, i, c, s));
        }
      return this;
    }),
    (id.visitAfter = function (t) {
      ...
      for (
        this._root &&
        e.push(new Be(this._root, this._x0, this._y0, this._x1, this._y1));
        (n = e.pop());
        ...
        if (i.length) {
          var o,
            ...
            s = (a + f) / 2,
            l = (u + c) / 2;
          (o = i[0]) && e.push(new Be(o, a, u, s, l)),
            (o = i[1]) && e.push(new Be(o, s, u, f, l)),
            (o = i[2]) && e.push(new Be(o, a, l, s, c)),
            (o = i[3]) && e.push(new Be(o, s, l, f, c));
        }
        r.push(n);
      }
  ...
  var fd,
    ...
    sd = {
      ...
      s: function (t, n) {
        ...
        var r = e[0],
          i = e[1],
          o = i - (fd = 3 * Math.max(-8, Math.min(8, Math.floor(i / 3)))) + 1,
          a = r.length;
        return o === a
          ? r
          : o > a
  ...
  or({ decimal: ".", thousands: ",", grouping: [3], currency: ["$", ""] }),
    (sr.prototype = {
      constructor: sr,
      reset: function () {
        this.s = this.t = 0;
  ...
  var hd,
    ...
    pp = {
      ...
      polygonEnd: function () {
        var t = +hp;
        dp.add(t < 0 ? Wd + t : t),
          (this.lineStart = this.lineEnd = this.point = vr);
      },
      sphere: function () {
        dp.add(Wd);
      },
  ...
  var _p,
    ...
    Dp = [null, null],
    Up = { type: "LineString", coordinates: Dp },
    qp = {
      Feature: function (t, n) {
      ...
      switch (this._point) {
        ...
        default:
          this._context.moveTo(t + this._radius, n),
            this._context.arc(t, n, this._radius, 0, Wd);
      }
    },
    result: vr,
  };
  ...
  var vv = Array.prototype.slice,
    gv = "$",
    yv = { depth: -1 },
    _v = {};
  ca.prototype = Object.create(Do.prototype);
  var bv = (1 + Math.sqrt(5)) / 2,
    mv = (function t(n) {
    ...
    xv = (function t(n) {
      function e(t, e, r, i, o) {
        if ((a = t._squarify) && a.ratio === n)
          for (
            var a, u, f, c, s, l = -1, h = a.length, d = t.value;
            ++l < h;

          ) {
            for (
              f = (u = a[l]).children, c = u.value = 0, s = f.length;
              c < s;
              ++c
            )
              u.value += f[c].value;
            u.dice
              ? na(u, e, r, i, (r += ((o - r) * u.value) / d))
              : sa(u, e, r, (e += ((i - e) * u.value) / d), o),
              (d -= u.value);
          }
  ...
  var Uv = Dv.range,
    ...
    Xv = Ia(
      ...
      function (t, n) {
        return (
          (n - t - (n.getTimezoneOffset() - t.getTimezoneOffset()) * qv) / 864e5
        );
      },
      function (t) {
        return t.getDate() - 1;
  ...
  var Bg = "%Y-%m-%dT%H:%M:%S.%LZ",
    Fg = Date.prototype.toISOString
      ? function (t) {
          return t.toISOString();
        }
      : t.utcFormat(Bg),
    Ig = +new Date("2000-01-01T00:00:00.000Z")
      ? function (t) {
          var n = new Date(t);
    ...
    r_ = new Array(3)
      ...
      .map(ff),
    i_ = cf(r_),
    o_ = xl(Zt(300, 0.5, 0), Zt(-240, 0.5, 1)),
    a_ = xl(Zt(-100, 0.75, 0.35), Zt(80, 1.5, 0.8)),
    u_ = xl(Zt(260, 0.75, 0.35), Zt(80, 1.5, 0.8)),
    f_ = Zt(),
    c_ = Rt(),
    s_ = Math.PI / 3,
    l_ = (2 * Math.PI) / 3,
  ...
  var E_ = Array.prototype.slice,
    ...
    L_ = Math.sin(A_ / 10) / Math.sin((7 * A_) / 10),
    D_ = Math.sin(N_ / 10) * L_,
    U_ = -Math.cos(N_ / 10) * L_,
    q_ = {
      draw: function (t, n) {
    ...
    H_ = {
      draw: function (t, n) {
        ...
        t.moveTo(r, i),
          t.lineTo(o, a),
          t.lineTo(u, f),
          t.lineTo(-0.5 * r - F_ * i, F_ * r + -0.5 * i),
          t.lineTo(-0.5 * o - F_ * a, F_ * o + -0.5 * a),
          t.lineTo(-0.5 * u - F_ * f, F_ * u + -0.5 * f),
          t.lineTo(-0.5 * r + F_ * i, -0.5 * i - F_ * r),
          t.lineTo(-0.5 * o + F_ * a, -0.5 * a - F_ * o),
          t.lineTo(-0.5 * u + F_ * f, -0.5 * f - F_ * u),
          t.closePath();
      },
    },
  ...
  (Ff.prototype = {
    ...
    (Hf.prototype = {
      ...
      lineEnd: function () {
        ...
        if (e > 0)
          for (
            var r, i = t[0], o = n[0], a = t[e] - i, u = n[e] - o, f = -1;
            ++f <= e;

          )
            (r = f / e),
              this._basis.point(
                this._beta * t[f] + (1 - this._beta) * (i + r * a),
                this._beta * n[f] + (1 - this._beta) * (o + r * u)
              );
      ...
      lineEnd: function () {
        ...
        if (e)
          if (
            ...
            for (var r = fc(t), i = fc(n), o = 0, a = 1; a < e; ++o, ++a)
      ...
      insert: function (t, n) {
        ...
        for (n.L = n.R = null, n.U = e, n.C = !0, t = n; e && e.C; )
          e === (r = e.U).L
            ? (i = r.R) && i.C
              ? ((e.C = i.C = !1), (r.C = !0), (t = r))
              : (t === e.R && (mc(this, e), (e = (t = e).U)),
                (e.C = !1),
                (r.C = !0),
                xc(this, r))
            : (i = r.L) && i.C
            ? ((e.C = i.C = !1), (r.C = !0), (t = r))
            : (t === e.L && (xc(this, e), (e = (t = e).U)),
              (e.C = !1),
              (r.C = !0),
              mc(this, r)),
            (e = t.U);
          ...
          if (t && t.C) t.C = !1;
            ...
            do {
              ...
              if (t === i.L) {
                if (
                  ((n = i.R).C &&
                    ((n.C = !1), (i.C = !0), mc(this, i), (n = i.R)),
                  (n.L && n.L.C) || (n.R && n.R.C))
                ) {
                  (n.R && n.R.C) ||
                    ((n.L.C = !1), (n.C = !0), xc(this, n), (n = i.R)),
                    (n.C = i.C),
                    (i.C = n.R.C = !1),
                    mc(this, i),
                    (t = this._);
                ...
                ((n = i.L).C &&
                  ((n.C = !1), (i.C = !0), xc(this, i), (n = i.L)),
                (n.L && n.L.C) || (n.R && n.R.C))
              ) {
                (n.L && n.L.C) ||
                  ((n.R.C = !1), (n.C = !0), mc(this, n), (n = i.L)),
                  (n.C = i.C),
                  (i.C = n.L.C = !1),
                  xc(this, i),
                  (t = this._);
  ...
  (Bc.prototype = {
          ...
          if ((o = (i = e.halfedges).length))
            for (
              var i,
                ...
                f = -1,
                c = n[i[o - 1]],
                s = c.left === u ? c.right : c.left;
              ++f < o;

            )
              (a = s),
                (s = (c = n[i[f]]).left === u ? c.right : c.left),
                a &&
                  s &&
                  r < a.index &&
                  r < s.index &&
    ...
    (Ic.prototype = {
      ...
      translate: function (t, n) {
        return (0 === t) & (0 === n)
          ? this
          : new Ic(this.k, this.x + this.k * t, this.y + this.k * n);
      },
      apply: function (t) {
  ...
  (jc.prototype = Ic.prototype),
    ...
    (t.cross = function (t, n, e) {
      var i,
        ...
        c = n.length,
        s = new Array(f * c);
      for (null == e && (e = r), i = a = 0; i < f; ++i)
        for (u = t[i], o = 0; o < c; ++o, ++a) s[a] = e(u, n[o]);
      return s;
    }),
    ...
    (t.histogram = function () {
      function t(t) {
        ...
        Array.isArray(h) ||
          ((h = d(c, l, h)),
          (h = s(Math.ceil(c / h) * h, Math.floor(l / h) * h, h)));
        for (var p = h.length; h[0] <= c; ) h.shift(), --p;
        for (; h[p - 1] > l; ) h.pop(), --p;
        var v,
          g = new Array(p + 1);
        for (i = 0; i <= p; ++i)
          ((v = g[i] = []).x0 = i > 0 ? h[i - 1] : c),
            (v.x1 = i < p ? h[i] : l);
        for (i = 0; i < a; ++i)
          c <= (o = u[i]) && o <= l && g[Kc(h, o, 0, p)].push(t[i]);
        return g;
      }
      var n = c,
        e = u,
      ...
      return (
        (t.value = function (e) {
          return arguments.length
            ? ((n = "function" == typeof e ? e : f(e)), t)
            : n;
        }),
        (t.domain = function (n) {
          return arguments.length
            ? ((e = "function" == typeof n ? n : f([n[0], n[1]])), t)
            : e;
        }),
        (t.thresholds = function (n) {
          return arguments.length
    ...
    (t.thresholdFreedmanDiaconis = function (t, e, r) {
      return (
        (t = rs.call(t, i).sort(n)),
        Math.ceil(
          (r - e) / (2 * (v(t, 0.75) - v(t, 0.25)) * Math.pow(t.length, -1 / 3))
        )
      );
    }),
    ...
    (t.mean = function (t, n) {
      var e,
        ...
        a = -1,
        u = 0;
      if (null == n) for (; ++a < r; ) isNaN((e = i(t[a]))) ? --o : (u += e);
      else for (; ++a < r; ) isNaN((e = i(n(t[a], a, t)))) ? --o : (u += e);
      if (o) return u / o;
    }),
    (t.median = function (t, e) {
      var r,
        ...
        a = -1,
        u = [];
      if (null == e) for (; ++a < o; ) isNaN((r = i(t[a]))) || u.push(r);
      else for (; ++a < o; ) isNaN((r = i(e(t[a], a, t)))) || u.push(r);
      return v(u.sort(n), 0.5);
    }),
    (t.merge = y),
    (t.min = _),
    (t.pairs = function (t, n) {
      null == n && (n = r);
      for (
        var e = 0, i = t.length - 1, o = t[0], a = new Array(i < 0 ? 0 : i);
        e < i;
    ...
    (t.chord = function () {
      function t(t) {
        ...
        for (
          ...
          (y[b] = { index: b, startAngle: u, endAngle: a, value: d[b] }),
            (a += f);
        }
        for (c = -1; ++c < h; )
          for (l = c - 1; ++l < h; ) {
    ...
    (t.ribbon = function () {
      function t() {
        ...
        if (
          ...
          a.arc(0, 0, s, l, h),
          (l === g && h === y) ||
            (a.quadraticCurveTo(0, 0, v * Th(g), v * Nh(g)),
            a.arc(0, 0, v, g, y)),
          a.quadraticCurveTo(0, 0, d, p),
          a.closePath(),
          t)
        )
      ...
      return (
        (t.radius = function (n) {
          return arguments.length
            ? ((r = "function" == typeof n ? n : re(+n)), t)
            : r;
        }),
        (t.startAngle = function (n) {
          return arguments.length
            ? ((i = "function" == typeof n ? n : re(+n)), t)
            : i;
        }),
        (t.endAngle = function (n) {
          return arguments.length
            ? ((o = "function" == typeof n ? n : re(+n)), t)
            : o;
        }),
        (t.source = function (e) {
    ...
    (t.nest = function () {
      function t(n, i, a, u) {
        ...
        for (
          var f, c, s, l = -1, h = n.length, d = o[i++], p = he(), v = a();
          ++l < h;
    ...
    (t.contourDensity = function () {
      function t(t) {
        ...
        t.forEach(function (t, n, r) {
          ...
          Ae(
            { width: v, height: y, data: e },
            { width: v, height: y, data: r },
            l >> h
          ),
          Te(
            { width: v, height: y, data: r },
      ...
      return (
        (t.x = function (n) {
          return arguments.length
            ? ((a = "function" == typeof n ? n : me(+n)), t)
            : a;
        }),
        (t.y = function (n) {
          return arguments.length
            ? ((u = "function" == typeof n ? n : me(+n)), t)
            : u;
        }),
        (t.size = function (t) {
    ...
    (t.drag = function () {
      ...
      function o() {
        if (d.apply(this, arguments)) {
          var n,
            ...
            o = r.length;
          for (n = 0; n < o; ++n)
            (e = f(r[n].identifier, i, vt, this, arguments)) &&
              (gt(), e("start"));
        }
      }
      function a() {
      ...
      function f(e, r, i, o, a) {
        ...
        if (
          ot(
            new xt(n, "beforestart", u, e, b, s[0], s[1], 0, 0, l),
            function () {
              return (
                null != (t.event.subject = u = v.apply(o, a)) &&
                ((f = u.x - s[0] || 0), (c = u.y - s[1] || 0), !0)
              );
            }
          )
        )
      ...
      return (
        (n.filter = function (t) {
          return arguments.length
            ? ((d = "function" == typeof t ? t : mt(!!t)), n)
            : d;
        }),
        (n.container = function (t) {
          return arguments.length
            ? ((p = "function" == typeof t ? t : mt(t)), n)
            : p;
        }),
        (n.subject = function (t) {
          return arguments.length
            ? ((v = "function" == typeof t ? t : mt(t)), n)
            : v;
        }),
        (n.touchable = function (t) {
          return arguments.length
            ? ((g = "function" == typeof t ? t : mt(!!t)), n)
            : g;
        }),
        (n.on = function () {
    ...
    (t.forceCollide = function (t) {
      ...
      var i,
        ...
        u = 1;
      return (
        "function" != typeof t && (t = qe(null == t ? 1 : +t)),
        ...
        (n.radius = function (e) {
          return arguments.length
            ? ((t = "function" == typeof e ? e : qe(+e)), r(), n)
            : t;
        }),
        n
      );
    ...
    (t.forceLink = function (t) {
      function n(n) {
        for (var e = 0, r = t.length; e < d; ++e)
          for (var i, u, f, s, l, h, p, v = 0; v < r; ++v)
            (u = (i = t[v]).source),
              (s = (f = i.target).x + f.vx - u.x - u.vx || Oe()),
              (l = f.y + f.vy - u.y - u.vy || Oe()),
              (s *= h =
                (((h = Math.sqrt(s * s + l * l)) - a[v]) / h) * n * o[v]),
              (l *= h),
              (f.vx -= s * (p = c[v])),
              (f.vy -= l * p),
              (u.vx += s * (p = 1 - p)),
      ...
      function e() {
        if (u) {
          var n,
            ...
            h = t.length,
            d = he(u, s);
          for (n = 0, f = new Array(l); n < h; ++n)
            ((e = t[n]).index = n),
              "object" != typeof e.source && (e.source = We(d, e.source)),
              "object" != typeof e.target && (e.target = We(d, e.target)),
              (f[e.source.index] = (f[e.source.index] || 0) + 1),
              (f[e.target.index] = (f[e.target.index] || 0) + 1);
          for (n = 0, c = new Array(h); n < h; ++n)
            (e = t[n]),
              (c[n] =
                f[e.source.index] / (f[e.source.index] + f[e.target.index]));
      ...
      return (
        ...
        (n.strength = function (t) {
          return arguments.length
            ? ((l = "function" == typeof t ? t : qe(+t)), r(), n)
            : l;
        }),
        (n.distance = function (t) {
          return arguments.length
            ? ((h = "function" == typeof t ? t : qe(+t)), i(), n)
            : h;
        }),
        n
      );
    ...
    (t.forceManyBody = function () {
      ...
      return (
        ...
        (t.strength = function (e) {
          return arguments.length
            ? ((f = "function" == typeof e ? e : qe(+e)), n(), t)
            : f;
        }),
    ...
    (t.forceRadial = function (t, n, e) {
      ...
      function i() {
        if (o) {
          var n,
            e = o.length;
          for (a = new Array(e), u = new Array(e), n = 0; n < e; ++n)
      ...
      return (
        ...
        (r.strength = function (t) {
          return arguments.length
            ? ((f = "function" == typeof t ? t : qe(+t)), i(), r)
            : f;
        }),
        (r.radius = function (n) {
          return arguments.length
            ? ((t = "function" == typeof n ? n : qe(+n)), i(), r)
            : t;
        }),
        (r.x = function (t) {
    ...
    (t.forceX = function (t) {
      ...
      var r,
        ...
        a = qe(0.1);
      return (
        "function" != typeof t && (t = qe(null == t ? 0 : +t)),
        (n.initialize = function (t) {
          (r = t), e();
        }),
        (n.strength = function (t) {
          return arguments.length
            ? ((a = "function" == typeof t ? t : qe(+t)), e(), n)
            : a;
        }),
        (n.x = function (r) {
          return arguments.length
            ? ((t = "function" == typeof r ? r : qe(+r)), e(), n)
            : t;
        }),
        n
      );
    ...
    (t.formatDefaultLocale = or),
    (t.formatLocale = ir),
    (t.formatSpecifier = tr),
    (t.precisionFixed = ar),
    (t.precisionPrefix = ur),
    (t.precisionRound = fr),
    ...
    (t.geoBounds = function (t) {
      var n, e, r, i, o, a, u;
      if (
        ((md = bd = -(yd = _d = 1 / 0)), (Td = []), br(t, gp), (e = Td.length))
      ) {
        for (Td.sort(Yr), n = 1, o = [(r = Td[0])]; n < e; ++n)
          Br(r, (i = Td[n])[0]) || Br(r, i[1])
            ? (Or(r[0], i[1]) > Or(r[0], r[1]) && (r[1] = i[1]),
              Or(i[0], r[1]) > Or(r[0], r[1]) && (r[0] = i[0]))
            : o.push((r = i));
        for (a = -1 / 0, n = 0, r = o[(e = o.length - 1)]; n <= e; r = i, ++n)
          (i = o[n]),
            (u = Or(r[1], i[0])) > a && ((a = u), (yd = i[0]), (bd = r[1]));
      }
      return (
        (Td = Nd = null),
        yd === 1 / 0 || _d === 1 / 0
    ...
    (t.geoCentroid = function (t) {
      ...
      return i < Xd &&
        ...
        (e = Rd),
        (r = Ld),
        Ed < Hd && ((n = kd), (e = Cd), (r = Pd)),
        (i = n * n + e * e + r * r) < Xd)
        ? [NaN, NaN]
        : [tp(e, n) * Zd, dr(r / fp(i)) * Zd];
    }),
    (t.geoCircle = function () {
      function t() {
        var t = r.apply(this, arguments),
          u = i.apply(this, arguments) * Qd,
          f = o.apply(this, arguments) * Qd;
        return (
          (n = []),
          (e = ti(-t[0] * Qd, -t[1] * Qd, 0).invert),
          oi(a, u, f, 1),
          (t = { type: "Polygon", coordinates: [n] }),
          (n = e = null),
          t
        );
      }
      ...
      return (
        (t.center = function (n) {
          return arguments.length
            ? ((r = "function" == typeof n ? n : Qr([+n[0], +n[1]])), t)
            : r;
        }),
        (t.radius = function (n) {
          return arguments.length
            ? ((i = "function" == typeof n ? n : Qr(+n)), t)
            : i;
        }),
        (t.precision = function (n) {
          return arguments.length
            ? ((o = "function" == typeof n ? n : Qr(+n)), t)
            : o;
        }),
        t
      );
    }),
    (t.geoClipAntimeridian = Cp),
    (t.geoClipCircle = gi),
    ...
    (t.geoPath = function (t, n) {
      ...
      return (
        ...
        (e.projection = function (n) {
          return arguments.length
            ? ((r = null == n ? ((t = null), zi) : (t = n).stream), e)
            : t;
        }),
        (e.context = function (t) {
          return arguments.length
            ? ((i = null == t ? ((n = null), new Wi()) : new Gi((n = t))),
    ...
    (t.geoAlbersUsa = function () {
      ...
      return (
        ...
        (t.precision = function (t) {
          return arguments.length
            ? (f.precision(t), c.precision(t), s.precision(t), n())
            : f.precision();
        }),
        (t.scale = function (n) {
          return arguments.length
        ...
        (t.translate = function (t) {
          ...
          return (
            ...
            (o = c
              ...
              .clipExtent([
                [r - 0.425 * e + Hd, u + 0.12 * e + Hd],
                [r - 0.214 * e - Hd, u + 0.234 * e - Hd],
              ])
              .stream(l)),
            (a = s
              .translate([r - 0.205 * e, u + 0.212 * e])
              .clipExtent([
                [r - 0.214 * e + Hd, u + 0.166 * e + Hd],
                [r - 0.115 * e - Hd, u + 0.234 * e - Hd],
              ])
              .stream(l)),
            n()
          );
    ...
    (t.geoIdentity = function () {
      ...
      return (a = {
        ...
        scale: function (n) {
          return arguments.length
            ? ((h = wo((u = +n) * s, u * l, f, c)), t())
            : u;
        },
        translate: function (n) {
          return arguments.length
            ? ((h = wo(u * s, u * l, (f = +n[0]), (c = +n[1]))), t())
            : [f, c];
        },
        reflectX: function (n) {
          return arguments.length
            ? ((h = wo(u * (s = n ? -1 : 1), u * l, f, c)), t())
            : s < 0;
        },
        reflectY: function (n) {
          return arguments.length
            ? ((h = wo(u * s, u * (l = n ? -1 : 1), f, c)), t())
            : l < 0;
        },
    ...
    (t.pack = function () {
      function t(t) {
        return (
          ...
          (t.y = r / 2),
          n
            ? t.eachBefore(Qo(n)).eachAfter(Jo(i, 0.5)).eachBefore(Ko(1))
            : t
                .eachBefore(Qo(Zo))
                .eachAfter(Jo($o, 1))
                .eachAfter(Jo(i, t.r / Math.min(e, r)))
                .eachBefore(Ko(Math.min(e, r) / (2 * t.r))),
          t
        );
      }
      var n = null,
    ...
    (t.tree = function () {
      function t(t) {
        ...
        if ((f.eachAfter(n), (f.parent.m = -f.z), f.eachBefore(e), u))
          t.eachBefore(r);
        else {
          var c = t,
            s = t,
        ...
        t.parent.A = (function (t, n, e) {
          if (n) {
            for (
              ...
              (f = oa(f)),
                ((a = aa(a)).a = t),
                (r = u.z + l - o.z - c + i(u._, o._)) > 0 &&
                  (ua(fa(u, t, e), t, r), (c += r), (s += r)),
                (l += u.m),
                (c += o.m),
                (h += f.m),
                (s += a.m);
            u && !aa(a) && ((a.t = u), (a.m += l - s)),
              o && !oa(f) && ((f.t = o), (f.m += c - h), (e = t));
          }
          return e;
        })(t, r, t.parent.A || e[0]);
      }
    ...
    (t.treemap = function () {
      ...
      return (
        ...
        (t.paddingTop = function (n) {
          return arguments.length
            ? ((f = "function" == typeof n ? n : Wo(+n)), t)
            : f;
        }),
        (t.paddingRight = function (n) {
          return arguments.length
            ? ((c = "function" == typeof n ? n : Wo(+n)), t)
            : c;
        }),
        (t.paddingBottom = function (n) {
          return arguments.length
            ? ((s = "function" == typeof n ? n : Wo(+n)), t)
            : s;
        }),
        (t.paddingLeft = function (n) {
          return arguments.length
            ? ((l = "function" == typeof n ? n : Wo(+n)), t)
            : l;
        }),
        t
      );
    ...
    (t.treemapSquarify = mv),
    (t.treemapResquarify = xv),
    (t.interpolate = dn),
    (t.interpolateArray = fn),
    (t.interpolateBasis = Kt),
    (t.interpolateBasisClosed = tn),
    (t.interpolateDate = cn),
    (t.interpolateNumber = sn),
    (t.interpolateObject = ln),
    (t.interpolateRound = pn),
    (t.interpolateString = hn),
    (t.interpolateTransformCss = sl),
    (t.interpolateTransformSvg = ll),
    (t.interpolateZoom = _n),
    (t.interpolateRgb = rl),
    (t.interpolateRgbBasis = il),
    (t.interpolateRgbBasisClosed = ol),
    (t.interpolateHsl = gl),
    (t.interpolateHslLong = yl),
    ...
    (t.interpolateHcl = _l),
    (t.interpolateHclLong = bl),
    (t.interpolateCubehelix = ml),
    (t.interpolateCubehelixLong = xl),
    ...
    (t.polygonCentroid = function (t) {
      for (
        var n, e, r = -1, i = t.length, o = 0, a = 0, u = t[i - 1], f = 0;
        ++r < i;
    ...
    (t.polygonLength = function (t) {
      for (
        var n, e, r = -1, i = t.length, o = t[i - 1], a = o[0], u = o[1], f = 0;
        ++r < i;
    ...
    (t.randomUniform = wv),
    (t.randomNormal = Mv),
    (t.randomLogNormal = Av),
    (t.randomBates = Nv),
    (t.randomIrwinHall = Tv),
    (t.randomExponential = Sv),
    (t.scaleBand = ya),
    ...
    (t.scaleSqrt = function () {
      return Oa().exponent(0.5);
    }),
    (t.scaleQuantile = Ya),
    (t.scaleQuantize = Ba),
    (t.scaleThreshold = Fa),
    (t.scaleTime = function () {
      return of(cg, ug, Vv, Xv, jv, Fv, Yv, Dv, t.timeFormat).domain([
        new Date(2e3, 0, 1),
        new Date(2e3, 0, 2),
      ]);
    }),
    (t.scaleUtc = function () {
      return of(Rg, Pg, yg, vg, dg, lg, Yv, Dv, t.utcFormat).domain([
        Date.UTC(2e3, 0, 1),
        Date.UTC(2e3, 0, 2),
      ]);
    }),
    (t.scaleSequential = af),
    (t.scaleDiverging = uf),
    (t.schemeCategory10 = Zg),
    (t.schemeAccent = Qg),
    (t.schemeDark2 = Jg),
    (t.schemePaired = Kg),
    (t.schemePastel1 = ty),
    ...
    (t.schemeSet2 = ry),
    (t.schemeSet3 = iy),
    (t.interpolateBrBG = ay),
    (t.schemeBrBG = oy),
    (t.interpolatePRGn = fy),
    (t.schemePRGn = uy),
    (t.interpolatePiYG = sy),
    (t.schemePiYG = cy),
    (t.interpolatePuOr = hy),
    (t.schemePuOr = ly),
    (t.interpolateRdBu = py),
    (t.schemeRdBu = dy),
    (t.interpolateRdGy = gy),
    (t.schemeRdGy = vy),
    (t.interpolateRdYlBu = _y),
    (t.schemeRdYlBu = yy),
    (t.interpolateRdYlGn = my),
    (t.schemeRdYlGn = by),
    (t.interpolateSpectral = wy),
    (t.schemeSpectral = xy),
    (t.interpolateBuGn = Ay),
    (t.schemeBuGn = My),
    (t.interpolateBuPu = Ny),
    (t.schemeBuPu = Ty),
    (t.interpolateGnBu = Ey),
    (t.schemeGnBu = Sy),
    (t.interpolateOrRd = Cy),
    (t.schemeOrRd = ky),
    (t.interpolatePuBuGn = zy),
    (t.schemePuBuGn = Py),
    (t.interpolatePuBu = Ly),
    (t.schemePuBu = Ry),
    (t.interpolatePuRd = Uy),
    (t.schemePuRd = Dy),
    (t.interpolateRdPu = Oy),
    (t.schemeRdPu = qy),
    (t.interpolateYlGnBu = By),
    (t.schemeYlGnBu = Yy),
    (t.interpolateYlGn = Iy),
    (t.schemeYlGn = Fy),
    (t.interpolateYlOrBr = Hy),
    (t.schemeYlOrBr = jy),
    (t.interpolateYlOrRd = Gy),
    (t.schemeYlOrRd = Xy),
    (t.interpolateBlues = $y),
    (t.schemeBlues = Vy),
    (t.interpolateGreens = Zy),
    (t.schemeGreens = Wy),
    (t.interpolateGreys = Jy),
    (t.schemeGreys = Qy),
    (t.interpolatePurples = t_),
    (t.schemePurples = Ky),
    (t.interpolateReds = e_),
    (t.schemeReds = n_),
    (t.interpolateOranges = i_),
    (t.schemeOranges = r_),
    (t.interpolateCubehelixDefault = o_),
    ...
    (t.interpolateWarm = a_),
    (t.interpolateCool = u_),
    (t.interpolateSinebow = function (t) {
      var n;
      return (
        (t = (0.5 - t) * Math.PI),
        (c_.r = 255 * (n = Math.sin(t)) * n),
        (c_.g = 255 * (n = Math.sin(t + s_)) * n),
        (c_.b = 255 * (n = Math.sin(t + l_)) * n),
        c_ + ""
      );
    }),
    (t.interpolateViridis = h_),
    (t.interpolateMagma = d_),
    (t.interpolateInferno = p_),
    (t.interpolatePlasma = v_),
    (t.create = function (t) {
    ...
    (t.arc = function () {
      function t() {
        var t,
          ...
          h = o.apply(this, arguments) - T_,
          d = a.apply(this, arguments) - T_,
          p = g_(d - h),
          v = d > h;
        if ((f || (f = t = oe()), l < s && ((c = l), (l = s), (s = c)), l > M_))
          if (p > N_ - M_)
            f.moveTo(l * __(h), l * x_(h)),
              f.arc(0, 0, l, h, d, !v),
              s > M_ &&
                (f.moveTo(s * __(d), s * x_(d)), f.arc(0, 0, s, d, h, v));
          else {
            var g,
              y,
              _ = h,
              ...
              N = m_(g_(l - s) / 2, +r.apply(this, arguments)),
              S = N,
              E = N;
            if (T > M_) {
              var k = hf((T / s) * x_(A)),
            ...
            M > M_
              ? E > M_
                ? ((g = _f(q, O, P, z, l, E, v)),
                  (y = _f(D, U, R, L, l, E, v)),
                  f.moveTo(g.cx + g.x01, g.cy + g.y01),
                  E < N
                    ? f.arc(
                        g.cx,
                        g.cy,
                    ...
                    : (f.arc(
                      ...
                      f.arc(
                        ...
                        0,
                        l,
                        y_(g.cy + g.y11, g.cx + g.x11),
                        y_(y.cy + y.y11, y.cx + y.x11),
                        !v
                      ),
                      f.arc(
                        y.cx,
                ...
                : (f.moveTo(P, z), f.arc(0, 0, l, _, b, !v))
              : f.moveTo(P, z),
              s > M_ && w > M_
                ? S > M_
                  ? ((g = _f(R, L, D, U, s, -S, v)),
                    (y = _f(P, z, q, O, s, -S, v)),
                    f.lineTo(g.cx + g.x01, g.cy + g.y01),
                    S < N
                      ? f.arc(
                          g.cx,
                          g.cy,
      ...
      return (
        ...
        (t.padRadius = function (n) {
          return arguments.length
            ? ((i = null == n ? null : "function" == typeof n ? n : lf(+n)), t)
            : i;
        }),
        (t.startAngle = function (n) {
          return arguments.length
            ? ((o = "function" == typeof n ? n : lf(+n)), t)
            : o;
        }),
        (t.endAngle = function (n) {
          return arguments.length
    ...
    (t.curveBundle = G_),
    (t.curveCardinalClosed = $_),
    (t.curveCardinalOpen = W_),
    (t.curveCardinal = V_),
    (t.curveCatmullRomClosed = Q_),
    (t.curveCatmullRomOpen = J_),
    (t.curveCatmullRom = Z_),
    ...
    (t.stack = function () {
      ...
      return (
        (t.keys = function (e) {
          return arguments.length
            ? ((n = "function" == typeof e ? e : lf(E_.call(e))), t)
            : n;
        }),
        (t.value = function (n) {
          return arguments.length
        ...
        (t.order = function (n) {
          return arguments.length
            ? ((e =
                null == n ? lc : "function" == typeof n ? n : lf(E_.call(n))),
              t)
            : e;
        }),
        (t.offset = function (n) {
    ...
    (t.timeInterval = Ia),
    (t.timeMillisecond = Dv),
    (t.timeMilliseconds = Uv),
    (t.utcMillisecond = Dv),
    (t.utcMilliseconds = Uv),
    (t.timeSecond = Yv),
    (t.timeSeconds = Bv),
    (t.utcSecond = Yv),
    (t.utcSeconds = Bv),
    ...
    (t.utcYear = Rg),
    (t.utcYears = Dg),
    (t.timeFormatDefaultLocale = nf),
    (t.timeFormatLocale = $a),
    (t.isoFormat = Fg),
    (t.isoParse = Ig),
    (t.now = wn),
    (t.timer = Tn),
    ...
    (t.active = function (t, n) {
      ...
      if (i) {
        n = null == n ? null : n + "";
        for (r in i)
          if ((e = i[r]).state > Ll && e.name === n)
            return new On([[t]], hh, n, +r);
      }
      return null;
    }),
    (t.interrupt = Dn),
    (t.voronoi = function () {
      function t(t) {
        return new Bc(
          t.map(function (r, i) {
            var o = [
              Math.round(n(r, i, t) / ab) * ab,
              Math.round(e(r, i, t) / ab) * ab,
            ];
      ...
      return (
        ...
        (t.x = function (e) {
          return arguments.length
            ? ((n = "function" == typeof e ? e : vc(+e)), t)
            : n;
        }),
        (t.y = function (n) {
          return arguments.length
            ? ((e = "function" == typeof n ? n : vc(+n)), t)
            : e;
        }),
        (t.extent = function (n) {
          return arguments.length
    ...
    (t.zoom = function () {
      ...
      function e(t, n) {
        return (n = Math.max(x[0], Math.min(x[1], n))) === t.k
          ? t
          : new Ic(n, t.x, t.y);
      }
      function r(t, n, e) {
      ...
      function f() {
        if (g.apply(this, arguments)) {
          var t = a(this, arguments),
            ...
            i = Math.max(
              x[0],
              Math.min(x[1], n.k * Math.pow(2, b.apply(this, arguments)))
            ),
            o = pt(this);
          if (t.wheel)
          ...
          Xc(),
            ...
            t.zoom("mouse", _(r(e(n, i), t.mouse[0], t.mouse[1]), t.extent, w));
        }
      }
      function c() {
              ...
              .on(
                ...
                function () {
                  ...
                  n.zoom(
                    "mouse",
                    _(
                      r(n.that.__zoom, (n.mouse[0] = pt(n.that)), n.mouse[1]),
                      n.extent,
                      w
                    )
                  );
      ...
      function s() {
        if (g.apply(this, arguments)) {
          var i = this.__zoom,
            a = pt(this),
            u = i.invert(a),
            f = i.k * (t.event.shiftKey ? 0.5 : 2),
            c = _(r(e(i, f), a, u), y.apply(this, arguments), w);
          Xc(),
            M > 0
              ? ct(this).transition().duration(M).call(o, c, a)
              : ct(this).call(n.transform, c);
        }
      }
      function l() {
        if (g.apply(this, arguments)) {
          ...
          for (Hc(), e = 0; e < f; ++e)
            (i = [
              ...
              o.touch0
                ? o.touch1 || (o.touch1 = i)
                : ((o.touch0 = i), (n = !0));
          if (p && ((p = clearTimeout(p)), !o.touch1))
            return (
              o.end(),
              void (
                (i = ct(this).on("dblclick.zoom")) && i.apply(this, arguments)
              )
            );
          n &&
      ...
      function h() {
        var n,
          ...
          s = c.length;
        for (Xc(), p && (p = clearTimeout(p)), n = 0; n < s; ++n)
          (o = vt(this, c, (i = c[n]).identifier)),
            f.touch0 && f.touch0[2] === i.identifier
              ? (f.touch0[0] = o)
              : f.touch1 && f.touch1[2] === i.identifier && (f.touch1[0] = o);
      ...
      return (
        ...
        (u.prototype = {
          start: function () {
            return (
              1 == ++this.active &&
                ((this.index = T.push(this) - 1), this.emit("start")),
              this
            );
          },
          zoom: function (t, n) {
            ...
            return (
              0 == --this.active &&
                (T.splice(this.index, 1), (this.index = -1), this.emit("end")),
              this
            );
          },
          emit: function (t) {
        ...
        (n.wheelDelta = function (t) {
          return arguments.length
            ? ((b = "function" == typeof t ? t : Fc(+t)), n)
            : b;
        }),
        (n.filter = function (t) {
          return arguments.length
            ? ((g = "function" == typeof t ? t : Fc(!!t)), n)
            : g;
        }),
        (n.touchable = function (t) {
          return arguments.length
            ? ((m = "function" == typeof t ? t : Fc(!!t)), n)
            : m;
        }),
        (n.extent = function (t) {
          return arguments.length
