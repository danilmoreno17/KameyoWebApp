        ...
        function (require, module, exports) {
          ...
          (function (global, factory) {
            ...
            momentPrototype__proto.millisecond =
              momentPrototype__proto.milliseconds = getSetMillisecond;
            ...
            utils_hooks__hooks.relativeTimeRounding =
          ...
          module.exports = function (Chart) {
            ...
            Chart.controllers.line = Chart.DatasetController.extend({
              ...
              updateBezierControlPoints: function () {
                ...
                var points = (meta.data || []).filter(function (pt) {
                ...
                for (i = 0, ilen = points.length; i < ilen; ++i) {
                  ...
                  model.controlPointPreviousX = capIfNecessary(
                    controlPoints.previous.x,
                    area.left,
                    area.right
                  );
                  model.controlPointPreviousY = capIfNecessary(
                    controlPoints.previous.y,
                    area.top,
                    area.bottom
                  );
                  model.controlPointNextX = capIfNecessary(
                    controlPoints.next.x,
                    area.left,
                    area.right
                  );
                  model.controlPointNextY = capIfNecessary(
          ...
          module.exports = function (Chart) {
            ...
            var LinearRadialScale = Chart.LinearScaleBase.extend({
              ...
              getIndexAngle: function (index) {
                ...
                return (
                  index * angleMultiplier - Math.PI / 2 + startAngleRadians
                );
              },
