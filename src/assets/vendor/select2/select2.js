...
(function ($, undefined) {
  ...
  function ajax(options) {
    ...
    return function (query) {
      ...
      timeout = window.setTimeout(function () {
        ...
        url =
          typeof url === "function"
            ? url.call(self, query.term, query.page, query.context)
            : url;
  ...
  AbstractSelect2 = clazz(Object, {
          ...
          if ("ajax" in opts) {
            ...
            if (opts.initSelection === undefined) {
              opts.initSelection = function (element, callback) {
                var data = [];
                $(
                  splitVal(element.val(), opts.separator, opts.transformVal)
                ).each(function () {
    ...
    monitorSource: function () {
      ...
      this._sync = this.bind(function () {
        ...
        if (this.container) {
          ...
          this.container.addClass(
            evaluate(this.opts.containerCssClass, this.opts.element)
          );
        }
        ...
        if (this.dropdown) {
          ...
          this.dropdown.addClass(
            evaluate(this.opts.dropdownCssClass, this.opts.element)
          );
        }
      });
    ...
    positionDropdown: function () {
      var $dropdown = this.dropdown,
        ...
        enoughRoomOnLeft = function () {
          return (
            offset.left + viewPortRight + container.outerWidth(false) >
            dropWidth
          );
        },
      ...
      if (this.opts.dropdownAutoWidth) {
        ...
        dropWidth =
          ...
          (resultsListNode.scrollHeight === resultsListNode.clientHeight
            ? 0
    ...
    prefillNextSearchTerm: function () {
      ...
      var nextSearchTerm = this.opts.nextSearchTerm(
        this.data(),
        this.lastSearchTerm
      );
      ...
      opts.query({
        ...
        callback: this.bind(function (data) {
          ...
          if (
            ...
            checkFormatter(opts.formatAjaxError, "formatAjaxError")
          ) {
            render(
          ...
          if (
            ...
            results.append(
              "<li class='select2-more-results'>" +
                opts.escapeMarkup(
                  evaluate(opts.formatLoadMore, opts.element, this.resultsPage)
                ) +
                "</li>"
            );
            window.setTimeout(function () {
    ...
    getPlaceholder: function () {
      ...
      return (
        ...
        ((placeholderOption = this.getPlaceholderOption()) !== undefined
    ...
    postprocessResults: function (data, initial, noHighlightUpdate) {
      ...
      compound.each2(function (i, choice) {
        ...
        if (
          ...
          choice.find(".select2-result-selectable:not(.select2-selected)")
            .length === 0
        ) {
          choice.addClass("select2-selected");
        }
      ...
      if (
        ...
        !choices.filter(".select2-result:not(.select2-selected)").length > 0
      ) {
        if (
          !data ||
          (data &&
