    ...
    (a.jstree = {
      ...
      (a.jstree.defaults.core = {
        ...
        keyboard: {
          ...
          left: function (b) {
            if ((b.preventDefault(), this.is_open(b.currentTarget)))
              this.close_node(b.currentTarget);
            else {
              var c = this.get_parent(b.currentTarget);
              c &&
                c.id !== a.jstree.root &&
                this.get_node(c, !0).children(".jstree-anchor").focus();
            }
          },
          up: function (a) {
            a.preventDefault();
          ...
          right: function (b) {
            if ((b.preventDefault(), this.is_closed(b.currentTarget)))
              ...
              var c = this.get_node(b.currentTarget, !0).children(
                ".jstree-children"
              )[0];
      ...
      (a.jstree.core.prototype = {
        ...
        load_node: function (b, c) {
          ...
          if (b.state.loaded) {
            for (b.state.loaded = !1, f = 0, g = b.parents.length; g > f; f++)
              this._model.data[b.parents[f]].children_d = a.vakata.array_filter(
            ...
            h &&
              (this._data.core.selected = a.vakata.array_filter(
            ...
            this._load_node(
              ...
              a.proxy(function (a) {
                ...
                b.state.loaded &&
                  d &&
                  d.length &&
                  (d.removeClass("jstree-closed jstree-open jstree-leaf"),
                  h
                    ? "#" !== b.id &&
                      d.addClass(
                        b.state.opened ? "jstree-open" : "jstree-closed"
                      )
                    : d.addClass("jstree-leaf")),
        ...
        _load_nodes: function (a, b, c, d) {
          ...
          for (h = 0, i = a.length; i > h; h++)
            g[a[h]] &&
              ((!g[a[h]].state.loaded && !g[a[h]].state.failed) || (!c && d)) &&
              (this.is_loading(a[h]) || this.load_node(a[h], f), (e = !1));
          if (e) {
            for (h = 0, i = a.length; i > h; h++)
                      ...
                      a.proxy(function (d, e, g) {
                        ...
                        return (h && -1 !== h.indexOf("json")) ||
                          ...
                          : ((this._data.core.last_error = {
                              ...
                              data: JSON.stringify({ id: b.id, xhr: g }),
                            }),
        ...
        _node_changed: function (b) {
          (b = this.get_node(b)),
            b &&
              -1 === a.inArray(b.id, this._model.changed) &&
              this._model.changed.push(b.id);
        },
                ...
                if (c.length && c[0].id !== b && c[0].parent !== b) {
                  ...
                  for (o = 0, p = c.length; p > o; o++)
                    k[c[o].parent.toString()]
                      ? (k[c[o].parent.toString()].children.push(
                          c[o].id.toString()
                        ),
                ...
                if (null !== this.element) {
                  ...
                  if (((this._model.data = b.mod), c)) {
                    ...
                    if (
                      ((f = this._model.data),
                      i.length !== j.length ||
                        a.vakata.array_unique(i.concat(j)).length !== i.length)
                    ) {
                      for (e = 0, g = i.length; g > e; e++)
                        -1 === a.inArray(i[e], h) &&
                          -1 === a.inArray(i[e], j) &&
                          (f[i[e]].state.selected = !1);
                      for (e = 0, g = j.length; g > e; e++)
                        -1 === a.inArray(j[e], i) &&
                          (f[j[e]].state.selected = !0);
                    }
                  }
                  b.add.length &&
        ...
        redraw_node: function (b, c, d, e) {
          ...
          if (
            ...
            h = a.inArray(
              f.id,
              null === g ? p[a.jstree.root].children : p[f.parent].children
            );
          }
          ...
          if (
            ...
            p[f.parent] &&
            !f.state.hidden &&
            ((k = a.inArray(f.id, p[f.parent].children)), (w = f.id), -1 !== k)
          )
            for (k++, l = p[f.parent].children.length; l > k; k++)
              if (
                (p[p[f.parent].children[k]].state.hidden ||
                  (w = p[f.parent].children[k]),
                w !== f.id)
              )
                break;
          ...
          for (l in f.a_attr)
            if (f.a_attr.hasOwnProperty(l)) {
              ...
              "class" !== l
                ? b.childNodes[1].setAttribute(l, f.a_attr[l])
                : (n += " " + f.a_attr[l]);
            }
          if (
            ...
            this.settings.core.force_text
              ? b.childNodes[1].appendChild(o.createTextNode(f.text))
          ...
          if ((j && b.appendChild(j), !d)) {
            for (
              g || (g = this.element[0]), k = 0, l = g.childNodes.length;
              l > k;
              k++
            )
              if (
                g.childNodes[k] &&
                g.childNodes[k].className &&
                -1 !== g.childNodes[k].className.indexOf("jstree-children")
              ) {
                s = g.childNodes[k];
                break;
              }
              ...
              for (h = 0, i = f.length; i > h; h += 1)
                f[h] === d && (g = !g),
                  ...
                  this.is_disabled(f[h]) || (!g && f[h] !== d && f[h] !== e)
                    ...
                    : this.is_hidden(f[h]) || this.select_node(f[h], !0, !1, c);
              this.trigger("changed", {
                action: "select_node",
        ...
        get_state: function () {
          ...
          for (c in this._model.data)
            this._model.data.hasOwnProperty(c) &&
              c !== a.jstree.root &&
              (this._model.data[c].state.loaded &&
                this.settings.core.loaded_state &&
                b.core.loaded.push(c),
        ...
        set_state: function (c, d) {
          if (c) {
            if (
              (c.core &&
                c.core.selected &&
                c.core.initial_selection === b &&
                (c.core.initial_selection = this._data.core.selected
                  .concat([])
                  .sort()
                  .join(",")),
              c.core)
              ...
              if (c.core.loaded)
                return (
                  this.settings.core.loaded_state &&
                  a.isArray(c.core.loaded) &&
                  c.core.loaded.length
                    ? this._load_nodes(c.core.loaded, function (a) {
        ...
        get_json: function (b, c, d) {
          ...
          var e = {
              ...
              data:
                c && c.no_data
                  ? !1
                  : a.extend(!0, a.isArray(b.data) ? [] : {}, b.data),
            },
            f,
            g;
          if (
        ...
        create_node: function (c, d, e, f, g) {
          ...
          d || (d = { text: this.get_string("New node") }),
            (d = "string" == typeof d ? { text: d } : a.extend(!0, {}, d)),
        ...
        delete_node: function (b) {
          ...
          for (
            ...
            this._model.data[b.parents[h]].children_d = a.vakata.array_filter(
          ...
          return (
            -1 !== a.inArray(this._data.core.focused, g) &&
              ...
              e.id === a.jstree.root
                ? this._model.data[a.jstree.root].children[0] &&
        ...
        check: function (b, c, d, e, f) {
          ...
          return ("move_node" !== b && "copy_node" !== b) ||
            (f && f.is_multi) ||
            (c.id !== d.id &&
              ("move_node" !== b || a.inArray(c.id, d.children) !== e) &&
                ...
                (l = a("<input />", {
                  ...
                  blur: a.proxy(function (c) {
                    ...
                    "" === f && (f = j),
                      ...
                      (j = i
                        ? j
                        : a("<div></div>").append(a.parseHTML(j)).html()),
                      this.set_text(b, j),
                      (m = !!this.rename_node(
                        b,
                        i
    ...
    (j.className = "jstree-icon jstree-checkbox"),
                  ...
                  a.proxy(function (b, c) {
                    ...
                    if (-1 !== l.indexOf("up"))
                      while (g && g.id !== a.jstree.root) {
                        for (j = 0, h = 0, i = g.children.length; i > h; h++)
                          j +=
                            f[g.children[h]].state[m ? "selected" : "checked"];
                        if (j !== i) break;
            ...
            for (d = 0, e = k.length; e > d; d++)
              if (i[k[d]] && i[k[d]].parents)
                for (f = 0, g = i[k[d]].parents.length; g > f; f++) {
                  ...
                  i[k[d]].parents[f] !== a.jstree.root &&
                    ((h[i[k[d]].parents[f]] = !0), l.push(i[k[d]].parents[f]));
                }
            for (
              this.element
                .find(".jstree-closed")
                      ...
                      for (d = 0, e = c.children_d.length; e > d; d++)
                        if (
                          ...
                          for (
                            ...
                            h[j.parents[f]] === b &&
                              j.parents[f] !== a.jstree.root &&
                              ((h[j.parents[f]] = !0), l.push(j.parents[f]));
                    } else if (
                      c.original &&
                      c.original.state &&
                      c.original.state.undetermined &&
                      c.original.state.undetermined === !0
                    )
                      for (
                        h[c.id] === b &&
                          c.id !== a.jstree.root &&
                          ((h[c.id] = !0), l.push(c.id)),
                          f = 0,
                          g = c.parents.length;
                        g > f;
                        f++
                        ...
                        h[c.parents[f]] === b &&
                          c.parents[f] !== a.jstree.root &&
                          ((h[c.parents[f]] = !0), l.push(c.parents[f]));
                }),
                d = 0,
                e = l.length;
              e > d;
              ...
              i[l[d]].state[j ? "selected" : "checked"] ||
                n.push(c ? i[l[d]] : l[d]);
            return n;
          }),
            ...
            if ((b = d.redraw_node.apply(this, arguments))) {
              ...
              i &&
                ...
                this._model.data[b.id].state.checkbox_disabled &&
                  (k.className += " jstree-checkbox-disabled"),
          ...
          (this._cascade_new_checked_state = function (a, b) {
            ...
            if (
              (!this.settings.checkbox.cascade_to_disabled &&
                e.state.disabled) ||
              (!this.settings.checkbox.cascade_to_hidden && e.state.hidden)
            )
              ...
              e.original &&
                ...
                (e.original.state.undetermined = m),
                m
      ...
      (a.jstree.plugins.conditionalselect = function (a, b) {
        this.activate_node = function (a, c) {
          return this.settings.conditionalselect.call(this, this.get_node(a), c)
          ...
          this.element
            ...
            .on("touchmove.vakata.jstree", function (b) {
              c &&
                ...
                b.originalEvent.changedTouches &&
                b.originalEvent.changedTouches[0] &&
                (Math.abs(e - b.originalEvent.changedTouches[0].clientX) > 10 ||
                  Math.abs(f - b.originalEvent.changedTouches[0].clientY) >
                    10) &&
                (clearTimeout(c), a.vakata.context.hide());
            })
        ...
        (a.vakata.context = {
          ...
          _show_submenu: function (c) {
            if (((c = a(c)), c.length && c.children("ul").length)) {
              ...
              b
                ? c[
                    f - (h + 10 + c.outerWidth()) < 0
                      ? "addClass"
                      : "removeClass"
                  ]("vakata-context-left")
                : c[f + h > j && e > j - f ? "addClass" : "removeClass"](
                    "vakata-context-right"
                  ),
                g + i + 10 > k && d.css("bottom", "-1px"),
                c.hasClass("vakata-context-right")
                  ? h > e && d.css("margin-right", e - h)
                  : h > j - f && d.css("margin-left", j - f - h),
                d.show();
            }
          },
          show: function (d, e, f) {
      ...
      (this.init = function (a, b) {
        c.init.call(this, a, b),
          (this.settings.dnd.use_html5 =
            this.settings.dnd.use_html5 &&
            "draggable" in i.createElement("span"));
      }),
        (this.bind = function () {
          c.bind.call(this),
            this.element.on(
        ...
        (this.redraw_node = function (a, b, d, e) {
          if (
            ((a = c.redraw_node.apply(this, arguments)),
            ...
            if (this.settings.dnd.large_drag_target)
              ...
              for (f = 0, g = a.childNodes.length; g > f; f++)
                if (
                  a.childNodes[f] &&
                  a.childNodes[f].className &&
                  -1 !== a.childNodes[f].className.indexOf("jstree-anchor")
                ) {
                  h = a.childNodes[f];
                  break;
                }
      ...
      a(function () {
        ...
        a(i)
          .on("dnd_start.vakata.jstree", function (a, b) {
            (c = !1),
              (e = !1),
              b && b.data && b.data.jstree && g.appendTo("body");
          })
          .on("dnd_move.vakata.jstree", function (h, i) {
            ...
            if (
              ...
              i &&
                i.data &&
                i.data.jstree &&
                (!i.event.target.id || "jstree-marker" !== i.event.target.id))
            ) {
              e = i.event;
              ...
              if (k && k._data && k._data.dnd)
                if (
                  (g.attr(
                    ...
                    "jstree-" +
                      k.get_theme() +
                      (k.settings.core.themes.responsive
                        ? " jstree-dnd-responsive"
                        : "")
                  ),
                  (D =
                    i.data.origin &&
                    (i.data.origin.settings.dnd.always_copy ||
                      (i.data.origin.settings.dnd.copy &&
                        (i.event.metaKey || i.event.ctrlKey)))),
                  i.helper
                    .children()
                    .attr(
                      "class",
                    ...
                    .first()
                    [D ? "show" : "hide"](),
                  (i.event.target !== k.element[0] &&
                    i.event.target !== k.get_container_ul()[0]) ||
                    0 !== k.get_container_ul().children().length)
                ) {
                  if (
                    ((l = k.settings.dnd.large_drop_target
                      ? a(i.event.target)
                          .closest(".jstree-node")
                          .children(".jstree-anchor")
                      : a(i.event.target).closest(".jstree-anchor")),
                    l &&
                      l.length &&
                      l
                        .parent()
                      ...
                      (n =
                        (i.event.pageY !== b
                          ? i.event.pageY
                          : i.event.originalEvent.pageY) - m.top),
                      (r = l.outerHeight()),
                      (u =
                        r / 3 > n
                          ? ["b", "i", "a"]
                      ...
                      a.each(u, function (b, e) {
                        ...
                        for (v = !0, w = 0, x = i.data.nodes.length; x > w; w++)
                          if (
                            ...
                            "move_node" === y &&
                              ...
                              ((A = k.get_node(s)),
                              z > a.inArray(i.data.nodes[w], A.children) &&
                                (z -= 1)),
                            (v =
                              v &&
                              ((k &&
                                k.settings &&
                                k.settings.dnd &&
                                k.settings.dnd.check_while_dragging === !1) ||
                                k.check(
                                  y,
                                  i.data.origin && i.data.origin !== k
                                    ? i.data.origin.get_node(i.data.nodes[w])
                                    : i.data.nodes[w],
                                  s,
                                  z,
                                  {
                        ...
                        return (
                          ...
                          v
                            ? ((E = k.get_node(s, !0)),
                              E.hasClass(".jstree-dnd-parent") ||
                                (a(".jstree-dnd-parent").removeClass(
                                  "jstree-dnd-parent"
                                ),
                              ...
                              i.event.originalEvent &&
                                i.event.originalEvent.dataTransfer &&
                                (i.event.originalEvent.dataTransfer.dropEffect =
                                  D ? "copy" : "move"),
                              (d = {}),
                              (u = !0),
                              !1)
                  ...
                  if (v)
                    return (
                      ...
                      void (
                        i.event.originalEvent &&
                        i.event.originalEvent.dataTransfer &&
                        (i.event.originalEvent.dataTransfer.dropEffect = D
                          ? "copy"
                          : "move")
                      )
                    );
              ...
              a(".jstree-dnd-parent").removeClass("jstree-dnd-parent"),
                ...
                i.event.originalEvent &&
                  i.event.originalEvent.dataTransfer &&
                  (i.event.originalEvent.dataTransfer.dropEffect = "none"),
                g.hide();
            }
          })
              ...
              if (c) {
                ...
                c.ins[
                  ...
                  (h.data.origin.settings.dnd.always_copy ||
                    ...
                    ? "copy_node"
                    : "move_node"
                ](k, c.par, c.pos, !1, !1, !1, h.data.origin);
              } else
        ...
        a.vakata.dnd = {
          ...
          _scroll: function (b) {
            if (!c.scroll_e || (!c.scroll_l && !c.scroll_t))
              return (
                c.scroll_i && (clearInterval(c.scroll_i), (c.scroll_i = !1)), !1
              );
            if (!c.scroll_i)
              return (c.scroll_i = setInterval(a.vakata.dnd._scroll, 100)), !1;
            if (b === !0) return !1;
            var d = c.scroll_e.scrollTop(),
              e = c.scroll_e.scrollLeft();
            c.scroll_e.scrollTop(
              d + c.scroll_t * a.vakata.dnd.settings.scroll_speed
            ),
              c.scroll_e.scrollLeft(
                e + c.scroll_l * a.vakata.dnd.settings.scroll_speed
              ),
              (d !== c.scroll_e.scrollTop() || e !== c.scroll_e.scrollLeft()) &&
                a.vakata.dnd._trigger("scroll", c.scroll_e);
          },
          start: function (b, d, e) {
            "touchstart" === b.type &&
              ...
              (b.target = i.elementFromPoint(
                b.originalEvent.changedTouches[0].pageX - window.pageXOffset,
                b.originalEvent.changedTouches[0].pageY - window.pageYOffset
              ))),
            ...
            try {
              (b.currentTarget.unselectable = "on"),
                ...
                b.currentTarget.style &&
                  ((b.currentTarget.style.touchAction = "none"),
            ...
            return (
              ...
              e !== !1 &&
                (c.helper = a("<div id='vakata-dnd'></div>").html(e).css({
                  display: "block",
                  margin: "0",
                  padding: "0",
                  position: "absolute",
            ...
            if (
              ...
              return (
                    ...
                    return (
                      this.scrollHeight > this.offsetHeight &&
                        ...
                        b.pageY - e.top <
                          ...
                          (c.scroll_t = -1)),
                      this.scrollWidth > this.offsetWidth &&
                        (e.left + d.width() - b.pageX <
                          a.vakata.dnd.settings.scroll_proximity &&
                          (c.scroll_l = 1),
                        b.pageX - e.left <
                          a.vakata.dnd.settings.scroll_proximity &&
                          (c.scroll_l = -1)),
                      c.scroll_t || c.scroll_l
                        ? ((c.scroll_e = a(this)), !1)
                        : void 0
                    );
                  }),
                c.scroll_e ||
                  ...
                  (l = d.scrollLeft()),
                  f > g &&
                    b.pageY - k < a.vakata.dnd.settings.scroll_proximity &&
                    (c.scroll_t = -1),
                  f > g &&
                    g - (b.pageY - k) <
                      a.vakata.dnd.settings.scroll_proximity &&
                    (c.scroll_t = 1),
                  h > j &&
                    b.pageX - l < a.vakata.dnd.settings.scroll_proximity &&
                    (c.scroll_l = -1),
                  h > j &&
                    j - (b.pageX - l) <
                      a.vakata.dnd.settings.scroll_proximity &&
                ...
                c.helper &&
                  ((m = parseInt(
                    b.pageY + a.vakata.dnd.settings.helper_top,
                    10
                  )),
                  (n = parseInt(
          ...
          (this._load_nodes = function (b, d, e, f) {
            ...
            if (!e) {
              for (k = 0, l = b.length; l > k; k++)
                (!j[b[k]] ||
                  (!j[b[k]].state.loaded && !j[b[k]].state.failed) ||
                  f) &&
                  (i.push(b[k]),
                  (m = this.get_node(b[k], !0)),
                  m &&
                    m.length &&
                    m.addClass("jstree-loading").attr("aria-busy", !0));
                  ...
                  return g.call(
                    ...
                    a.proxy(function (a) {
                      ...
                      if (a)
                        for (g in a)
                          a.hasOwnProperty(g) &&
                            (this._data.massload[g] = a[g]);
                      for (g = 0, h = b.length; h > g; g++)
                        (m = this.get_node(b[g], !0)),
                          m &&
                            m.length &&
                            m
                      ...
                      .done(
                        a.proxy(function (a, g, h) {
                          ...
                          if (a)
                            for (i in a)
                              a.hasOwnProperty(i) &&
                                (this._data.massload[i] = a[i]);
                          for (i = 0, j = b.length; j > i; i++)
                            (m = this.get_node(b[i], !0)),
                              m &&
                                m.length &&
                                m
                                  .removeClass("jstree-loading")
          ...
          (this._load_node = function (b, d) {
            ...
            return e
              ? ((f = this[
                ...
                g &&
                  g.length &&
                  g.removeClass("jstree-loading").attr("aria-busy", !1),
                  ...
                  if (this._data.search.som && c.res.length) {
                    ...
                    for (e = 0, f = c.res.length; f > e; e++)
                      if (
                        ...
                        for (
                          h = 0, i = d[c.res[e]].children_d.length;
                          i > h;
                          h++
                        )
                          d[d[c.res[e]].children_d[h]] &&
                            !d[d[c.res[e]].children_d[h]].state.hidden &&
                            g.push(d[c.res[e]].children_d[h]);
      ...
      (a.jstree.plugins.types = function (c, d) {
        (this.init = function (c, e) {
          ...
          (this.set_type = function (c, d) {
            ...
            if (
              ((f = this.settings.types), (c = this.get_node(c)), !f[d] || !c)
            )
              return !1;
            if (
              ((l = this.get_node(c, !0)),
              ...
              (j = this.get_icon(c)),
              (c.type = d),
              (j === !0 || !f[i] || (f[i].icon !== b && j === f[i].icon)) &&
                this.set_icon(c, f[d].icon !== b ? f[d].icon : !0),
              ...
              for (k in f[i].li_attr)
                if (f[i].li_attr.hasOwnProperty(k)) {
                  if ("id" === k) continue;
                  "class" === k
                    ? ((e[c.id].li_attr["class"] = (
                        e[c.id].li_attr["class"] || ""
                      ).replace(f[i].li_attr[k], "")),
                      l && l.removeClass(f[i].li_attr[k]))
                    : e[c.id].li_attr[k] === f[i].li_attr[k] &&
                      ((e[c.id].li_attr[k] = null), l && l.removeAttr(k));
                }
              ...
              for (k in f[i].a_attr)
                if (f[i].a_attr.hasOwnProperty(k)) {
                  ...
                  "class" === k
                    ? ((e[c.id].a_attr["class"] = (
                        e[c.id].a_attr["class"] || ""
                      ).replace(f[i].a_attr[k], "")),
                      m && m.removeClass(f[i].a_attr[k]))
                    : e[c.id].a_attr[k] === f[i].a_attr[k] &&
                      ("href" === k
                        ? ((e[c.id].a_attr[k] = "#"), m && m.attr("href", "#"))
                        : (delete e[c.id].a_attr[k], m && m.removeAttr(k)));
                }
            if (f[d].li_attr !== b && "object" == typeof f[d].li_attr)
              for (k in f[d].li_attr)
                if (f[d].li_attr.hasOwnProperty(k)) {
                  if ("id" === k) continue;
                  e[c.id].li_attr[k] === b
                    ? ((e[c.id].li_attr[k] = f[d].li_attr[k]),
                      l &&
                        ("class" === k
                          ? l.addClass(f[d].li_attr[k])
                          : l.attr(k, f[d].li_attr[k])))
                    : "class" === k &&
                      ((e[c.id].li_attr["class"] =
                        f[d].li_attr[k] + " " + e[c.id].li_attr["class"]),
            ...
            if (f[d].a_attr !== b && "object" == typeof f[d].a_attr)
              for (k in f[d].a_attr)
                if (f[d].a_attr.hasOwnProperty(k)) {
                  if ("id" === k) continue;
                  e[c.id].a_attr[k] === b
                    ? ((e[c.id].a_attr[k] = f[d].a_attr[k]),
                      m &&
                        ("class" === k
                          ? m.addClass(f[d].a_attr[k])
                          : m.attr(k, f[d].a_attr[k])))
                    : "href" === k && "#" === e[c.id].a_attr[k]
                    ? ((e[c.id].a_attr.href = f[d].a_attr.href),
                      m && m.attr("href", f[d].a_attr.href))
                    : "class" === k &&
                      ((e[c.id].a_attr["class"] =
                        f[d].a_attr["class"] + " " + e[c.id].a_attr["class"]),
      ...
      (a.jstree.plugins.unique = function (c, d) {
        (this.check = function (b, c, e, f, g) {
          ...
          var h = "rename_node" === b ? f : c.text,
            ...
            n,
            o;
          for (m = 0, n = e.children.length; n > m; m++)
