...
(function (g) {
  ...
  r.prototype = {
    ...
    pointerUp: function (a) {
      if (this.current_plugin === this.plugin_count && this.is_active) {
        ...
        if (g.contains(this.$cache.cont[0], a.target) || this.dragging)
        ...
        : (a.from_shadow && (d || c)
          ...
          a.to_shadow && (e || f)
            ? ((e = this.convertToPercent(e ? a.to_min : a.min)),
              (a = this.convertToPercent(f ? a.to_max : a.max) - e),
    ...
    validate: function () {
      ...
      if (c)
        for (
          ...
          (e = +d[f]),
            isNaN(e) ? (e = d[f]) : ((d[f] = e), (e = this._prettify(e))),
            a.p_values.push(e);
    ...
    update: function (a) {
      this.input &&
        ...
        (this.options = g.extend(this.options, a)),
        this.validate(),
        this.updateResult(a),
        this.toggleInput(),
        this.remove(),
    ...
    destroy: function () {
      this.input &&
        ...
        g.data(this.input, "ionRangeSlider", null),
        this.remove(),
  ...
  g.fn.ionRangeSlider = function (a) {
    return this.each(function () {
      g.data(this, "ionRangeSlider") ||
        g.data(this, "ionRangeSlider", new r(this, a, u++));
    });
  };
  (function () {
    for (
