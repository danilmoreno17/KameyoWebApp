!(function (a, b, c, d) {
  ...
  (g.prototype.init = function (b) {
    (this.tree = []),
      (this.nodes = []),
      b.data &&
        ("string" == typeof b.data && (b.data = a.parseJSON(b.data)),
    ...
    (g.prototype.subscribeEvents = function () {
      this.unsubscribeEvents(),
        ...
        "function" == typeof this.options.onNodeChecked &&
          this.$element.on("nodeChecked", this.options.onNodeChecked),
        "function" == typeof this.options.onNodeCollapsed &&
          this.$element.on("nodeCollapsed", this.options.onNodeCollapsed),
        "function" == typeof this.options.onNodeDisabled &&
          this.$element.on("nodeDisabled", this.options.onNodeDisabled),
        "function" == typeof this.options.onNodeEnabled &&
          this.$element.on("nodeEnabled", this.options.onNodeEnabled),
        "function" == typeof this.options.onNodeExpanded &&
          this.$element.on("nodeExpanded", this.options.onNodeExpanded),
        "function" == typeof this.options.onNodeSelected &&
          this.$element.on("nodeSelected", this.options.onNodeSelected),
        "function" == typeof this.options.onNodeUnchecked &&
          this.$element.on("nodeUnchecked", this.options.onNodeUnchecked),
        "function" == typeof this.options.onNodeUnselected &&
          this.$element.on("nodeUnselected", this.options.onNodeUnselected),
        "function" == typeof this.options.onSearchComplete &&
          this.$element.on("searchComplete", this.options.onSearchComplete),
        "function" == typeof this.options.onSearchCleared &&
      ...
      if (b.nodes) {
        ...
        a.each(b.nodes, function (a, b) {
          (b.nodeId = e.nodes.length),
            ...
            b.state.hasOwnProperty("expanded") ||
              (!b.state.disabled &&
              c < e.options.levels &&
              b.nodes &&
              b.nodes.length > 0
    ...
    (g.prototype.clickHandler = function (b) {
      ...
      if (d && !d.state.disabled) {
        ...
        -1 !== e.indexOf("expand-icon")
          ...
          : (d.selectable
              ? this.toggleSelectedState(d, f.options)
    ...
    (g.prototype.setExpandedState = function (b, c, d) {
      c !== b.state.expanded &&
        (c && b.nodes
          ? ((b.state.expanded = !0),
            d.silent ||
              this.$element.trigger("nodeExpanded", a.extend(!0, {}, b)))
          : c ||
            ((b.state.expanded = !1),
            d.silent ||
              this.$element.trigger("nodeCollapsed", a.extend(!0, {}, b)),
            b.nodes &&
              !d.ignoreChildren &&
              a.each(
                b.nodes,
    ...
    (g.prototype.setSelectedState = function (b, c, d) {
      c !== b.state.selected &&
        (c
          ...
          : ((b.state.selected = !1),
            d.silent ||
              this.$element.trigger("nodeUnselected", a.extend(!0, {}, b))));
    }),
    ...
    (g.prototype.setCheckedState = function (b, c, d) {
      c !== b.state.checked &&
        (c
          ? ((b.state.checked = !0),
            d.silent ||
              this.$element.trigger("nodeChecked", a.extend(!0, {}, b)))
          : ((b.state.checked = !1),
            d.silent ||
              this.$element.trigger("nodeUnchecked", a.extend(!0, {}, b))));
    }),
      ...
      c !== b.state.disabled &&
        (c
          ? ((b.state.disabled = !0),
            ...
            d.silent ||
              this.$element.trigger("nodeDisabled", a.extend(!0, {}, b)))
          : ((b.state.disabled = !1),
            d.silent ||
              this.$element.trigger("nodeEnabled", a.extend(!0, {}, b))));
    }),
      ...
      if (b) {
        ...
        a.each(b, function (b, e) {
          ...
          if (
            (e.nodes
              ? (h.push("expand-icon"),
                h.push(
                  e.state.expanded
                    ? d.options.collapseIcon
                    : d.options.expandIcon
                ))
              : h.push(d.options.emptyIcon),
          ...
          if (d.options.showCheckbox) {
            var h = ["check-icon"];
            h.push(
              e.state.checked ? d.options.checkedIcon : d.options.uncheckedIcon
            ),
              f.append(a(d.template.icon).addClass(h.join(" ")));
          }
          return (
            f.append(
              d.options.enableLinks
                ? a(d.template.link).attr("href", e.href).append(e.text)
                : e.text
            ),
            d.options.showTags &&
              e.tags &&
            ...
            d.$wrapper.append(f),
            e.nodes && e.state.expanded && !e.state.disabled
              ? d.buildTree(e.nodes, c)
              : void 0
          );
        });
      }
    ...
    (g.prototype.buildStyleOverride = function (a) {
      ...
      var b = a.color,
        c = a.backColor;
      return (
        this.options.highlightSelected &&
          a.state.selected &&
          (this.options.selectedColor && (b = this.options.selectedColor),
          this.options.selectedBackColor &&
            (c = this.options.selectedBackColor)),
        this.options.highlightSearchResults &&
          a.searchResult &&
          !a.state.disabled &&
          (this.options.searchResultColor &&
            (b = this.options.searchResultColor),
          this.options.searchResultBackColor &&
            (c = this.options.searchResultBackColor)),
        "color:" + b + ";background-color:" + c + ";"
      );
    }),
    (g.prototype.injectStyle = function () {
      this.options.injectStyle &&
        !c.getElementById(this.styleId) &&
        a(
    ...
    (g.prototype.expandAll = function (b) {
      if (((b = a.extend({}, f.options, b)), b && b.levels))
        ...
        a.proxy(function (a, b) {
          this.setExpandedState(a, !0, b),
            a.nodes &&
              b &&
              b.levels &&
              this.expandLevels(a.nodes, b.levels - 1, b);
        }, this)
      ),
        this.render();
    }),
      ...
      this.forEachIdentifier(
        ...
        a.proxy(function (a, b) {
          for (var c = this.getParent(a); c; )
            this.setExpandedState(c, !0, b), (c = this.getParent(c));
        }, this)
      ),
        this.render();
    }),
    ...
    (g.prototype.search = function (b, c) {
      ...
      return (
        c.revealResults ? this.revealNode(d) : this.render(),
