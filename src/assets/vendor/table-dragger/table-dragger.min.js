!(function (t, e) {
  ...
  return (function (t) {
            ...
            var e = this,
              ...
              r =
                arguments.length > 1 && void 0 !== arguments[1]
                  ? arguments[1]
                  : {};
            if (((0, m.default)(this, t), !o(n)))
              throw new TypeError(
                "table-dragger: el must be TABLE HTMLElement, not " +
                  {}.toString.call(n)
              );
            if (n.rows.length) {
              var i = {
              ...
              if ("free" === c && !a.dragHandler)
                throw new Error(
                  "table-dragger: please specify dragHandler in free mode"
                );
              [
                "onTap",
                "destroy",
              ...
              var f = void 0;
              if (a.dragHandler) {
                if (((f = n.querySelectorAll(a.dragHandler)), f && !f.length))
                  throw new Error(
                    "table-dragger: no element match dragHandler selector"
                  );
              } else
                f =
                  "column" === c
                    ? n.rows[0]
                      ? n.rows[0].children
                      : []
                    : (0, d.default)(n.rows).map(function (t) {
                        return t.children[0];
                      });
              (this.handlers = (0, d.default)(f)),
              ...
              [
                {
                  ...
                  value: function () {
                    ...
                    try {
                      for (
                        var r, o = (0, f.default)(this.handlers);
                        !(t = (r = o.next()).done);
                        t = !0
                      ) {
                        var i = r.value;
                        (0, S.touchy)(i, "add", "mousedown", this.onTap);
                      }
                    } catch (t) {
                      (e = !0), (n = t);
                    } finally {
                ...
                },
                {
                  ...
                  value: function (t) {
                    ...
                    r ||
                      ...
                      (this.tappedCoord = { x: t.clientX, y: t.clientY }),
                      this.eventualStart(!1),
                      (0, S.touchy)(document, "add", "mouseup", function () {
                        e.eventualStart(!0);
                      }));
                  },
                },
                {
                  ...
                  value: function (t) {
                    ...
                    if (0 !== r || 0 !== o) {
                      i && (u = r < o ? "row" : "column");
                      var a = new w.default({ mode: u, originTable: this });
                      this.eventualStart(!0),
                        (0, S.touchy)(document, "add", "mouseup", a.destroy);
                    }
                  },
                },
                {
                  ...
                  value: function () {
                    ...
                    try {
                      for (
                        ...
                        var i = r.value;
                        (0, S.touchy)(i, "remove", "mousedown", this.onTap);
                      }
                    } catch (t) {
                      (e = !0), (n = t);
                    } finally {
                ...
                },
                {
                  ...
                  value: function (t, e) {
                    if (t !== e) {
                      var n = this.el;
                      (0, d.default)(n.rows).forEach(function (n) {
                        (0, S.sort)({ list: n.children, from: t, to: e });
                      });
                      var r = n.querySelectorAll("col");
                      r.length && (0, S.sort)({ list: r, from: t, to: e });
                    }
                  },
                },
                {
    ...
    function (t, e, n) {
      ...
      t.exports = function (t, e, n, y, b, w, x) {
        ...
        var E,
          ...
          k = M[d] || M[v] || (b && M[b]),
          L = k || O(b),
          P = b ? (C ? O("entries") : L) : void 0,
          A = "Array" == e ? M.entries || k : k;
        if (
          (A &&
            ((T = l(A.call(new t()))),
            T !== Object.prototype &&
              (f(T, _, !0), r || a(T, d) || u(T, d, g))),
          C &&
            k &&
            k.name !== m &&
            ((j = !0),
          ...
          if (
            ((E = { values: C ? L : O(m), keys: w ? L : O(h), entries: P }), x)
          )
            for (S in E) S in M || i(M, S, E[S]);
          else o(o.P + o.F * (p || j), e, E);
        return E;
      };
    },
    function (t, e) {
    ...
    function (t, e, n) {
      ...
      var r = n(16),
        ...
        $ = function (t) {
          ...
          return (
            !(this === z && o(D, t) && !o(U, t)) &&
            (!(e || !o(this, t) || !o(D, t) || (o(this, B) && this[B][t])) || e)
          );
        },
        Q = function (t, e) {
          if (((t = w(t)), (e = x(e, !0)), t !== z || !o(D, e) || o(U, e))) {
            var n = j(t, e);
            return (
              !n || !o(D, e) || (o(t, B) && t[B][e]) || (n.enumerable = !0), n
            );
          }
        },
        Z = function (t) {
          for (var e, n = k(w(t)), r = [], i = 0; n.length > i; )
            o(D, (e = n[i++])) || e == B || e == c || r.push(e);
          return r;
        },
        tt = function (t) {
          for (
            var e, n = t === z, r = k(n ? U : w(t)), i = [], u = 0;
            r.length > u;
      ...
      Y ||
        ((L = function () {
          ...
          return i && W && H(z, t, { configurable: !0, set: e }), K(t);
        }),
        a(L[N], "toString", function () {
          return this._k;
        }),
        (O.f = Q),
        (_.f = J),
        ...
        (n(66).f = $),
        (n(65).f = tt),
        i && !n(14) && a(z, "propertyIsEnumerable", $, !0),
        (v.f = function (t) {
          return K(p(t));
        })),
        u(u.G + u.W + u.F * !Y, { Symbol: L });
      for (
        var et =
        ...
        p(et[nt++]);
      for (var et = C(p.store), nt = 0; et.length > nt; ) h(et[nt++]);
      u(u.S + u.F * !Y, "Symbol", {
        for: function (t) {
        ...
        "Array",
        {
          from: function (t) {
            ...
            if (
              ...
              for (l = y.call(d), n = new p(); !(o = l.next()).done; g++)
    ...
    function (t, e, n) {
      var r = n(15);
      r(r.S + r.F * !n(25), "Object", { defineProperty: n(21).f });
    },
    function (t, e, n) {
      "use strict";
      function r(t) {
      ...
      function o(t) {
        (0, b.css)(t, {
          ...
          (0, f.default)(t.querySelectorAll("col")).forEach(function (t) {
      ...
      function u(t) {
        return (0, f.default)(t.rows).map(function (e) {
          var n = t.cloneNode(!0);
          o(n),
            (0, f.default)(n.children).forEach(function (t) {
              var e = t.nodeName;
              "COL" !== e && "COLGROUP" !== e && n.removeChild(t);
            });
          var r = e.parentElement.cloneNode();
          return (
            (r.innerHTML = ""),
      ...
      function a(t) {
        return (0, f.default)((0, b.getLongestRow)(t).children).map(function (
          e,
          n
        ) {
          return i(t, n);
      ...
      var s = n(79),
        ...
        S = (function () {
          function t(e) {
            ...
            (x = parseInt(document.body.style.paddingRight, 0) || 0),
              ...
              ["destroy", "onDrag", "onDragend", "onShadow", "onOut"].forEach(
                function (t) {
                  n[t] = n[t].bind(n);
                }
              ),
              ...
              (this.drake = (0, m.default)([this.el], {
                animation: 300,
            ...
            (0, v.default)(t, [
              {
                key: "onDrag",
                value: function () {
                  (0, b.css)(document.body, { overflow: "hidden" });
                  var t = (0, b.getScrollBarWidth)();
                  (this.dragger.dragging = !0),
                    t &&
                      (0, b.css)(document.body, {
                        "padding-right": t + x + "px",
                      }),
                    (0, b.touchy)(document, "remove", "mouseup", this.destroy),
                    this.dragger.emit(
                      "drag",
                      this.originTable.el,
                      this.options.mode
              ...
              },
              {
                ...
                value: function (t) {
                  ...
                  var u = r,
                    a = (0, f.default)(i.children).indexOf(t);
              ...
              },
              {
                ...
                value: function (t) {
                  var e = this.originTable.el,
                    ...
                    i = this.mode,
                    u = r,
                    a = (0, f.default)(o.children).indexOf(t);
              ...
              },
              {
                ...
                value: function () {
                  var t = this;
                  (0, b.remove)(document, "mouseup", this.destroy),
                    this.el.parentElement.classList.remove(y.default.dragging),
                    w || this.el.parentElement.removeChild(this.el),
                    setTimeout(function () {
                      t.drake.destroy();
                    }, 0);
                },
              },
              {
                ...
                value: function () {
                  var t = this.el,
                    e = this.index;
                  t.children[e].dispatchEvent((0, b.getTouchyEvent)());
                },
              },
              {
                key: "renderEl",
                value: function () {
                  ...
                  this.sizeFakes(),
                    ...
                    (0, b.insertBeforeSibling)({ target: n, origin: r });
                  var o = window
                      .getComputedStyle(r)
                    ...
                    u = n.children.length;
                  (0, f.default)(n.children).forEach(function (n, r) {
                    var a = n && n.querySelector("table");
                    t.options.onlyBody &&
                      "row" === e &&
                      !(0, f.default)(a.children).some(function (t) {
              ...
              },
              {
                ...
                value: function () {
                  ...
                  (0, f.default)((0, b.getLongestRow)(e).children).forEach(
                    function (e, n) {
                      var r = e.getBoundingClientRect().width,
                        o = t[n];
                      (0, b.css)(o, { width: r + "px" }),
                        (0, b.css)(o.rows[0].children[0], { width: r + "px" });
                    }
                  );
              ...
              },
              {
                ...
                value: function () {
                  ...
                  t.forEach(function (t) {
                    (0, b.css)(t, { width: r + "px" }),
                      (0, f.default)(t.rows[0].children).forEach(function (
                        t,
                        e
                      ) {
                        (0, b.css)(t, {
    ...
    function (t, e, n) {
      (function (e) {
        ...
        function r(t, e) {
          ...
          function r(t) {
            var e = t ? "remove" : "add";
            o(T, e, "mousedown", C), o(T, e, "mouseup", I);
          }
          function a(t) {
            var e = t ? "remove" : "add";
            o(T, e, "mousemove", j);
          ...
          function h(t) {
            var e = t ? "remove" : "add";
            x[e](T, "selectstart", _), x[e](T, "click", _);
          }
          function y() {
            r(!0), I({});
          }
          ...
          function C(t) {
            ...
            if (!e) {
              ...
              r &&
                ...
                a(),
                "mousedown" === t.type &&
                  (v(n) ? n.focus() : t.preventDefault()));
            }
          }
          function j(t) {
            if (st) {
              if (0 === i(t)) return void I({});
              if (
                void 0 === t.clientX ||
                t.clientX !== rt ||
                void 0 === t.clientY ||
          ...
          function M(t) {
            if (!((dt.dragging && Q) || n(t))) {
              ...
              if (
                ...
                !(
                  lt.invalid(t, e) ||
                  (lt.staticClass && t.classList.contains(lt.staticClass))
                )
              ) {
                var o = lt.moves(t, r, e, m(t));
                if (o) return { item: t, source: r };
              }
            }
          }
          function k(t) {
          ...
          function P(t) {
            V(t.item, t.source) &&
              ((at = t.item.cloneNode(!0)),
              dt.emit("cloned", at, t.item, "copy")),
              (Z = t.source),
              (tt = t.item),
              (it = ut = m(t.item)),
              (dt.dragging = !0),
          ...
          function R(t, e) {
            var n = p(t);
            at && lt.copySortSource && e === Z && n.removeChild(tt),
              z(e) ? dt.emit("cancel", t, Z, Z) : dt.emit("drop", t, e, Z, ut),
              U();
          }
          function F() {
            if (dt.dragging) {
              var t = at || tt,
                e = p(t);
              e && e.removeChild(t),
                dt.emit(at ? "cancel" : "remove", t, e, Z),
                U();
            }
          }
          function D(t) {
            if (dt.dragging) {
              ...
              o === !1 &&
                e &&
                (at ? r && r.removeChild(at) : Z.insertBefore(n, it)),
                o || e
                  ? dt.emit("cancel", n, Z, Z)
                  : dt.emit("drop", n, r, Z, ut),
                U();
            }
          }
          function U() {
            ...
            B(),
              ...
              ct && clearTimeout(ct),
              (dt.dragging = !1),
              ft && dt.emit("out", t, ft, Z),
              dt.emit("dragend", t),
              (Z = tt = at = it = ut = ct = ft = null);
          }
          function z(t, e) {
            var n;
            return (
              (n = void 0 !== e ? e : Q ? ut : m(at || tt)), t === Z && n === it
            );
          }
          function Y(t, e, r) {
            function o() {
          ...
          function X(t) {
            ...
            if (Q) {
              ...
              var o = b("clientX", t),
                ...
                u = o - et,
                a = i - nt;
              (Q.style.left = u + "px"), (Q.style.top = a + "px");
              var s = at || tt,
                f = c(Q, o, i),
                l = Y(f, o, i),
                d = null !== l && l !== ft;
              (d || null === l) && (r(), (ft = l), n());
              var v = p(s);
              if (l === Z && at && !lt.copySortSource)
                return void (v && v.removeChild(s));
              var h,
                y = J(l, f);
              if (null !== y) h = G(l, y, o, i);
              else {
                if (lt.revertOnSpill !== !0 || at)
                  return void (at && v && v.removeChild(s));
                (h = it), (l = Z);
              }
              if ((null === h && d) || (h !== s && h !== m(s))) {
                ...
                var w,
                  ...
                  T = lt.direction,
                  _ = "horizontal" === T ? t.pageX : t.pageY;
                if (
                  ((w =
                    _ < O
                      ? h
                  ...
                  return;
                if (lt.staticClass && w.classList.contains(lt.staticClass))
                  return;
                var C = w && w.getBoundingClientRect();
                l.insertBefore(s, h),
                  E && w && C && (g(C, w, lt.animation), g(S, s, lt.animation)),
                  dt.emit("shadow", s, l, Z);
              }
            }
          }
          function W(t) {
          ...
          function K() {
            if (!Q) {
              ...
              (Q = tt.cloneNode(!0)),
                (Q.style.width = l(t) + "px"),
                (Q.style.height = d(t) + "px"),
                E.rm(Q, "gu-transit"),
                E.add(Q, "gu-mirror"),
                lt.mirrorContainer.appendChild(Q),
                o(T, "add", "mousemove", X),
                E.add(lt.mirrorContainer, "gu-unselectable"),
                dt.emit("cloned", Q, tt, "mirror");
            }
          }
          function q() {
            Q &&
              (E.rm(lt.mirrorContainer, "gu-unselectable"),
              o(T, "remove", "mousemove", X),
              p(Q).removeChild(Q),
              (Q = null));
          }
          function J(t, e) {
          ...
          var Q,
            ...
            ft = null,
            lt = e || {};
          void 0 === lt.moves && (lt.moves = f),
            void 0 === lt.accepts && (lt.accepts = f),
            void 0 === lt.invalid && (lt.invalid = A),
            void 0 === lt.containers && (lt.containers = t || []),
            void 0 === lt.isContainer && (lt.isContainer = s),
            void 0 === lt.copy && (lt.copy = !1),
            void 0 === lt.copySortSource && (lt.copySortSource = !1),
            void 0 === lt.revertOnSpill && (lt.revertOnSpill = !1),
            void 0 === lt.removeOnSpill && (lt.removeOnSpill = !1),
            void 0 === lt.direction && (lt.direction = "vertical"),
            void 0 === lt.ignoreInputTextSelection &&
              (lt.ignoreInputTextSelection = !0),
            void 0 === lt.mirrorContainer && (lt.mirrorContainer = S.body),
            void 0 === lt.animation && (lt.animation = !1),
            void 0 === lt.staticClass && (lt.staticClass = "");
          var dt = w({
          ...
          return (
            lt.removeOnSpill === !0 && dt.on("over", W).on("out", H), r(), dt
          );
        }
        function o(t, n, r, o) {
          var i = {
        ...
        function y(t) {
          return t.targetTouches && t.targetTouches.length
            ? t.targetTouches[0]
    ...
    function (t, e) {
      ...
      function u() {
        h &&
          p &&
          ((h = !1), p.length ? (v = p.concat(v)) : (m = -1), v.length && a());
      }
      function a() {
        if (!h) {
          var t = o(u);
      ...
      (function (e) {
        ...
        function a(t, e, n) {
          function r() {
            ...
            return (
              v.createEvent
                ? ((t = v.createEvent("Event")), t.initEvent(e, !0, !0))
                : v.createEventObject && (t = v.createEventObject()),
              t
            );
          }
          function o() {
        ...
        function s(t, e, n) {
          ...
          return g.push({ wrapper: r, element: t, type: e, fn: n }), r;
        }
        function f(t, e, n) {
          var r = l(t, e, n);
          if (r) {
            var o = g[r].wrapper;
            return g.splice(r, 1), o;
          }
        }
        function l(t, e, n) {
          var r, o;
          for (r = 0; r < g.length; r++)
            if (((o = g[r]), o.element === t && o.type === e && o.fn === n))
              return r;
        }
        var d = n(105),
          p = n(106),
          ...
          m = i,
          g = [];
        e.addEventListener || ((h = o), (m = u)),
          (t.exports = { add: h, remove: m, fabricate: a });
      }.call(
        e,
        (function () {
          return this;
    ...
    function (t, e) {
      ...
      function n(t) {
        var e = i[t];
        return (
          e ? (e.lastIndex = 0) : (i[t] = e = new RegExp(u + t + a, "g")), e
        );
      }
      function r(t, e) {
        var r = t.className;
    ...
    function (t, e, n) {
      ...
      var o = n(110),
        ...
        p =
          ((e.getTouchyEvent = function () {
            var t = void 0;
            return (
              f.navigator.pointerEnabled &&
                (document.createEvent
                  ? ((t = document.createEvent("PointerEvent")),
                    t.initMouseEvent(
                      "pointerdown",
                      !0,
                      !0,
                  ...
                  : (t = new PointerEvent("pointerdown", {
                      cancelable: !0,
                      bubbles: !0,
                      view: window,
                    }))),
          ...
          (e.touchy = function (t, e, n, r) {
            f.navigator.pointerEnabled
              ? s.default[e](t, d[n], r)
              : (s.default[e](t, l[n], r), s.default[e](t, n, r));
          }),
          (e.getLongestRow = function (t) {
            var e = t.rows[0];
            return (
              (0, a.default)(t.rows).forEach(function (t) {
          ...
          (e.appendSibling = function (t) {
            var e = t.target,
              ...
              r = t.parent;
            e &&
              (r || e.parentElement).insertBefore(
                e,
      ...
      (e.sort = function (t) {
        var e = t.list,
          ...
          o = t.parent;
        n < r
          ? p({ target: e[n], origin: e[r], parent: o })
          : v({ target: e[n], origin: e[r] });
      }),
        (e.getScrollBarWidth = function () {
          ...
          var r = t.offsetWidth;
          return (
            n === r && (r = e.clientWidth), document.body.removeChild(e), n - r
          );
        });
    },
    function (t, e, n) {
