...
!(function (a) {
  ...
  function w(a, b, c) {
    return b
      ? void (c.xSteps[a] =
          o([c.xVal[a], c.xVal[a + 1]], b) / n(c.xPct[a], c.xPct[a + 1]))
      : !0;
  }
  function x(a, b, c, d) {
    (this.xPct = []),
  ...
  function P(b, d, n) {
    ...
    function v() {
      ...
      d.dir && (a.reverse(), d.tooltips.reverse()),
        S("update", function (b, c, e) {
          a[c] &&
            (a[c].innerHTML =
              d.tooltips[c] === !0 ? b[c] : d.tooltips[c].to(e[c]));
        });
    }
    function w(a, b, c) {
    ...
    function y(a, b, c) {
      ...
      var h = document.createElement("div"),
        j = "",
        k = [
          d.cssClasses.valueNormal,
          d.cssClasses.valueLarge,
          d.cssClasses.valueSub,
        ],
        l = [
          d.cssClasses.markerNormal,
          d.cssClasses.markerLarge,
          d.cssClasses.markerSub,
        ],
      ...
      return (
        ...
        i(
          h,
          0 === d.ort ? d.cssClasses.pipsHorizontal : d.cssClasses.pipsVertical
        ),
          ...
          a === e &&
            ba[d].forEach(function (a) {
              a.call(
                ...
                g(P()),
                b,
                g(C(Array.prototype.slice.call(aa))),
                c || !1,
                $
              );
            });
    ...
    function D(a, b, c, e) {
      var f = function (b) {
          return Z.hasAttribute("disabled")
            ...
            ? !1
            : ((b = p(b, e.pageOffset)),
              a === Y.start && void 0 !== b.buttons && b.buttons > 1
                ? !1
                : e.hover && b.buttons
                ? !1
    ...
    function E(a, b) {
      ...
      var c,
        ...
        h = e[0] === W[0] ? 0 : 1;
      if (
        ((c = o(g, b.positions, e.length > 1)),
        (f = L(e[0], c[h], 1 === e.length)),
        e.length > 1)
      ) {
      ...
      return (
        ...
        W[b].hasAttribute("disabled")
          ...
          : (L(W[b], f),
            ...
            B("set", b, !0),
            B("change", b, !0),
            void (d.events.snap && H(a, { handles: [W[b]] })))
      );
    }
    function J(a) {
      ...
      return (
        ...
        b === $[e]
          ...
          : (window.requestAnimationFrame
              ...
              : (a.style[d.style] = b + "%"),
            a.previousSibling ||
              (j(a, d.cssClasses.stacking),
              b > 50 && i(a, d.cssClasses.stacking)),
            ($[e] = b),
      ...
      for (d.limit && (a += 1), c = 0; a > c; c += 1)
        (e = c % 2),
          ...
          null !== f &&
            ...
            (f === !1 ||
              isNaN(f) ||
              L(W[e], _.toStepping(f), c === 3 - d.dir) === !1) &&
              B("update", e));
    }
    function N(a, b) {
      var c,
      ...
      for (
        b = void 0 === b ? !0 : !!b,
          d.dir && d.handles > 1 && h.reverse(),
          d.animate &&
            -1 !== $[0] &&
            e(Z, d.cssClasses.tap, d.animationDuration),
          c = W.length > 1 ? 3 : 1,
          1 === h.length && (c = 1),
          M(c, h),
          f = 0;
  ...
  (x.prototype.getMargin = function (a) {
    ...
    (x.prototype.toStepping = function (a) {
      return (
        (a = s(this.xVal, this.xPct, a)), this.direction && (a = 100 - a), a
      );
    }),
