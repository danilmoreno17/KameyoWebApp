    ...
    (f.prototype.init = function () {
      ...
      (f.prototype.build = function () {
          ...
          h.youtube || h.vimeo || h.dailymotion
            ? h.youtube
              ...
              ? e.core.s.loadVimeoThumbnail
                ? ((d = "//i.vimeocdn.com/video/error_" + g + ".jpg"),
                  (i = h.vimeo[1]))
                : (d = b)
              : h.dailymotion &&
        ...
        if (
          ...
          e.core.s.animateThumb &&
            e.core.$outer
              .find(".lg-thumb")
              .css({ width: e.thumbTotalWidth + "px", position: "relative" }),
          this.core.s.animateThumb &&
            e.$thumbOuter.css("height", e.core.s.thumbContHeight + "px"),
          e.core.s.dynamic)
        )
      ...
      (f.prototype.thumbkeyPress = function () {
        ...
        a(b).on("keydown.lg.thumb", function (a) {
          38 === a.keyCode
            ? (a.preventDefault(), c.core.$outer.addClass("lg-thumb-open"))
            : 40 === a.keyCode &&
              (a.preventDefault(), c.core.$outer.removeClass("lg-thumb-open"));
        });
      }),
      (f.prototype.destroy = function () {
        this.core.s.thumbnail &&
      ...
      var e = 1,
        ...
        h = function (d, f, h, i) {
          ...
          j = c.core.s.dynamic
            ...
            : c.core.$items.eq(h).attr("data-width") || f[0].naturalWidth || k;
          var l;
          c.core.$outer.hasClass("lg-zoomed")
            ...
            i
              ...
              : ((c.pageX = d.pageX || d.originalEvent.targetTouches[0].pageX),
        ...
        c.core.$slide.on("mousedown.lg.zoom", function (b) {
          ...
          a(b).on("mouseup.lg.zoom", function (a) {
            f &&
              ...
              !g ||
                (d.x === e.x && d.y === e.y) ||
                ((e = { x: a.pageX, y: a.pageY }), c.touchendZoom(d, e, h, i)),
              (g = !1)),
              c.core.$outer.removeClass("lg-grabbing").addClass("lg-grab");
          });
      }),
    ...
    var e = { hash: !0 },
      f = function (c) {
        return (
          (this.core = a(c).data("lightGallery")),
          (this.core.s = a.extend({}, e, this.core.s)),
          this.core.s.hash && ((this.oldHash = b.location.hash), this.init()),
          this
        );
      };
    (f.prototype.init = function () {
