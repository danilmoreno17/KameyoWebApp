...
(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof define === "function" && define.amd) define(["eve"], factory);
  else if (typeof exports === "object")
    exports["Raphael"] = factory(require("eve"));
  else root["Raphael"] = factory(root["eve"]);
      ...
      /***/ function (module, exports, __webpack_require__) {
	    ...
	    \*/
          paperproto.getElementByPoint = function (x, y) {
            ...
            target =
              target && target.raphael ? paper.getById(target.raphaelid) : null;
            return target;
          };
            ...
            animation = function () {
              ...
              for (; l < animationElements.length; l++) {
                ...
                if (e.initstatus) {
                  ...
                  e.status =
                    (e.prev + (e.percent - e.prev) * (time / ms)) / e.anim.top;
                }
                if (time < 0) {
                  continue;
                }
          ...
          elproto.resume = function (anim) {
            for (var i = 0; i < animationElements.length; i++)
              if (
                ...
                var e = animationElements[i];
                if (
                  eve("raphael.anim.resume." + this.id, this, e.anim) !== false
                ) {
                  delete e.paused;
