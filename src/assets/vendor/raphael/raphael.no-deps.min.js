!(function t(e, r) {
  "object" == typeof exports && "object" == typeof module
    ? (module.exports = r(require("eve")))
    : "function" == typeof define && define.amd
    ? define(["eve"], r)
    : "object" == typeof exports
    ? (exports.Raphael = r(require("eve")))
    : (e.Raphael = r(e.eve));
})(this, function (t) {
  return (function (t) {
    function e(i) {
    ...
    function (t, e, r) {
      ...
      (i = [r(2)]),
        (n = function (t) {
          function e(r) {
            if (e.is(r, "function"))
              return w ? r() : t.on("raphael.DOMload", r);
            if (e.is(r, Q))
              return e._engine.create[F](e, r.splice(0, 3 + e.is(r[0], $))).add(
                r
              );
          ...
          function p(t, r, i) {
            ...
            for (x = 0; c + 1 > x; x++)
              (v = e.findDotsAtSegment.apply(e, r.concat(x / c))),
                p.push({ x: v.x, y: v.y, t: x / c });
            for (x = 0; h > x; x++)
              for (var y = 0; c > y; y++) {
                var m = f[x],
                  b = f[x + 1],
                ...
                if (C) {
                  ...
                  S >= 0 &&
                    ...
                    (i
                      ? g++
                      : g.push({ x: C.x, y: C.y, t1: G(S, 1), t2: G(T, 1) }));
                }
              }
            return g;
          }
          ...
          function b(r, i, n, a, s, o) {
            ...
            var l,
              ...
              b = {};
            if (a)
              for (w = 0, B = Ne.length; B > w; w++) {
                var _ = Ne[w];
                if (_.el.id == i.id && _.anim == r) {
                  _.percent != n ? (Ne.splice(w, 1), (u = 1)) : (h = _),
            ...
            if (l) {
              if (h) (h.initstatus = a), (h.start = new Date() - h.ms * a);
                ...
                for (var C in l)
                  if (l[T](C) && (pt[T](C) || i.paper.customAttributes[T](C)))
                    switch (
                      ((v[C] = i.attr(C)),
                      null == v[C] && (v[C] = ft[C]),
                      (m[C] = l[C]),
                      ...
                      case "path":
                        var A = Qt(v[C], m[C]),
                          N = A[1];
                        for (
                          v[C] = A[0], b[C] = [], w = 0, B = v[C].length;
                          B > w;
                          w++
                        ) {
                          b[C][w] = [0];
                          for (var E = 1, M = v[C][w].length; M > E; E++)
                            b[C][w][E] = (N[w][E] - v[C][w][E]) / x;
                        }
                        break;
                      case "transform":
                        var L = i._,
                        ...
                        if (F)
                          for (
                            ...
                            for (
                              b[C][w] = [v[C][w][0]], E = 1, M = v[C][w].length;
                              M > E;
                              E++
                            )
                              b[C][w][E] = (m[C][w][E] - v[C][w][E]) / x;
                        else {
                          var z = i.matrix || new g(),
                            R = {
                ...
                if (!O)
                  if (((O = q(V).match(st)), O && 5 == O.length)) {
                    var W = O;
                    O = function (t) {
                      return y(t, +W[1], +W[2], +W[3], +W[4], x);
                    };
                  } else O = St;
                if (
          ...
          if (
            ...
            var Mt = A.doc.createElement("div"),
              Lt;
            if (
              ((Mt.innerHTML = '<v:shape adj="1"/>'),
              (Lt = Mt.firstChild),
              (Lt.style.behavior = "url(#default#VML)"),
              !Lt || "object" != typeof Lt.adj)
            )
              return (e.type = R);
            Mt = null;
          }
          (e.svg = !(e.vml = "VML" == e.type)),
            (e._Paper = E),
            (e.fn = M = E.prototype = e.prototype),
            (e._id = 0),
            (e._oid = 0),
            (e.is = function (t, e) {
              return (
          ...
          var Ft = (e.createUUID = (function (t, e) {
            return function () {
          ...
          e.setWindow = function (r) {
            t("raphael.setWindow", e, A.win, r),
              (A.win = r),
              (A.doc = A.win.document),
              e._engine.initWin && e._engine.initWin(A.win);
          };
          var Pt = function (t) {
              if (e.vml) {
                var r = /^\s+|\s+$/g,
          ...
          (e.getRGB = n(function (t) {
            ...
            if ("none" == t)
              return { r: -1, g: -1, b: -1, hex: "none", toString: a };
            !(xt[T](t.toLowerCase().substring(0, 2)) || "#" == t.charAt()) &&
              (t = Pt(t));
            var r,
              i,
              n,
            ...
            (e.parsePathString = function (t) {
              ...
              var i = {
                ...
                n = [];
              return (
                e.is(t, Q) && e.is(t[0], Q) && (n = Wt(t)),
                n.length ||
                  q(t).replace(yt, function (t, e, r) {
                    var a = [],
                      s = e.toLowerCase();
                    if (
            ...
            (e.parseTransformString = n(function (t) {
              ...
              var r = { r: 3, s: 4, t: 2, m: 6 },
                i = [];
              return (
                e.is(t, Q) && e.is(t[0], Q) && (i = Wt(t)),
                i.length ||
                  q(t).replace(mt, function (t, e, r) {
                    var n = [],
                      a = O.call(e);
                    r.replace(bt, function (t, e) {
                      e && n.push(+e);
          ...
          var Ot = (e.pathBBox = function (t) {
            ...
            Yt = (e._pathToRelative = function (t) {
              var r = Vt(t);
              if (r.rel) return Wt(r.rel);
              ...
              return (i.toString = e._path2string), (r.rel = Wt(i)), i;
            }),
            Gt = (e._pathToAbsolute = function (t) {
              var r = Vt(t);
              if (r.abs) return Wt(r.abs);
              if (
              ...
              for (
                ...
                if ((i.push((c = [])), (f = t[p]), f[0] != ct.call(f[0])))
                  switch (((c[0] = ct.call(f[0])), c[0])) {
                    ...
                    case "R":
                      for (
                        var g = [n, a][P](f.slice(1)), x = 2, v = g.length;
                        v > x;
                        x++
                      )
                        (g[x] = +g[x] + n), (g[++x] = +g[x] + a);
                  ...
                  (g = [n, a][P](f.slice(1))),
                    ...
                    (i = i[P](s(g, u))),
                    (c = ["R"][P](f.slice(-2)));
                else for (var y = 0, m = f.length; m > y; y++) c[y] = f[y];
                switch (c[0]) {
                  case "Z":
                    (n = o), (a = l);
                    break;
              ...
              return (i.toString = e._path2string), (r.abs = Wt(i)), i;
            }),
            Ht = function (t, e, r, i) {
              return [t, e, r, i, r, i];
            },
            ...
            Ut = function (t, e, r, i, a, s, o, l, h, u) {
              var c = (120 * U) / 180,
                ...
                d,
                g = n(function (t, e, r) {
                  var i = t * W.cos(r) - e * W.sin(r),
                    n = t * W.sin(r) + e * W.cos(r);
                  return { x: i, y: n };
                });
              if (u) (S = u[0]), (T = u[1]), (B = u[2]), (C = u[3]);
                ...
                var _ = r * r,
                  ...
                  B = (k * r * m) / i + (t + l) / 2,
                  C = (k * -i * y) / r + (e + h) / 2,
                  S = W.asin(((e - C) / i).toFixed(9)),
                  T = W.asin(((h - C) / i).toFixed(9));
                (S = B > t ? U - S : S),
                  (T = B > l ? U - T : T),
                  0 > S && (S = 2 * U + S),
                  0 > T && (T = 2 * U + T),
              ...
              if (H(A) > c) {
                ...
                (T = S + c * (o && T > S ? 1 : -1)),
                  (l = B + r * W.cos(T)),
                  (h = C + i * W.sin(T)),
                  (p = Ut(l, h, r, i, a, 0, o, E, M, [T, N, B, C]));
              }
              A = T - S;
              var L = W.cos(S),
                F = W.sin(S),
                ...
                Y = [l + q * R, h - D * z],
                G = [l, h];
              if (((O[0] = 2 * V[0] - O[0]), (O[1] = 2 * V[1] - O[1]), u))
                return [O, Y, G][P](p);
              p = [O, Y, G][P](p).join()[I](",");
            ...
            Zt = n(function (t, e, r, i, n, a, s, o) {
              var l = n - 2 * r + t - (s - 2 * n + r),
                h = 2 * (r - t) - 2 * (n - r),
                u = t - r,
                c = (-h + W.sqrt(h * h - 4 * l * u)) / 2 / l,
                f = (-h - W.sqrt(h * h - 4 * l * u)) / 2 / l,
                p = [e, o],
                d = [t, s],
                g;
              return (
                ...
                f > 0 &&
                  ...
                  p.push(g.y)),
                {
                  min: { x: G[F](0, d), y: G[F](0, p) },
                  max: { x: Y[F](0, d), y: Y[F](0, p) },
                }
              );
            }),
            Qt = (e._path2curve = n(
                  ...
                  var i = Gt(t),
                    ...
                    o = function (t, e, r) {
                      ...
                      switch ((!(t[0] in a) && (e.qx = e.qy = null), t[0])) {
                        case "M":
                          ...
                          break;
                        case "A":
                          t = ["C"][P](Ut[F](0, [e.x, e.y][P](t.slice(1))));
                          break;
                        case "S":
                          "C" == r || "S" == r
                    ...
                    l = function (t, e) {
                      if (t[e].length > 7) {
                        ...
                        t.splice(e, 1), (g = Y(i.length, (n && n.length) || 0));
                      }
                    },
            ...
            se = (e._extractTransform = function (t, r) {
              ...
              r = q(r).replace(/\.{3}|\u2026/g, t._.transform || R);
            ...
            le = (e._equaliseTransform = function (t, r) {
              ...
              for (
                ...
                if (
                  ...
                  return;
                for (
                  n[s] = [], a[s] = [], o = 0, l = Y(h.length, u.length);
                  l > o;
                  o++
                )
          ...
          (e._getContainer = function (t, r, i, n) {
            ...
            return (
              (a =
                null != n || e.is(t, "object") ? t : A.doc.getElementById(t)),
              null != a
                ? a.tagName
                  ? null == r
                    ? {
            ...
            (function (t) {
              ...
              (t.add = function (t, e, r, i, n, a) {
                ...
                (t.split = function () {
                  ...
                  return (
                    0 > s
                      ? ((t.rotate = e.deg(W.acos(s))),
                        0 > a && (t.rotate = 360 - t.rotate))
                      : (t.rotate = e.deg(W.asin(a))),
                    (t.isSimple = !(
                      +t.shear.toFixed(9) ||
            ...
            var he = function () {
              ...
              de = (function () {
                return A.doc.addEventListener
                  ? function (t, e, r, i) {
                      ...
                      if ((t.addEventListener(e, n, !1), z && V[e])) {
                        var a = function (e) {
                          for (
                            var n = pe(e),
                              a = e,
                      ...
                      return function () {
                        return (
                          ...
                          z && V[e] && t.removeEventListener(V[e], a, !1),
                          !0
                        );
                      };
                    }
                  ...
                  ? function (t, e, r, i) {
                      var n = function (t) {
                        t = t || A.win.event;
                        var e =
                            A.doc.documentElement.scrollTop ||
              ...
              xe = function (e) {
                for (
                  var r = e.clientX,
                    i = e.clientY,
                    n = A.doc.documentElement.scrollTop || A.doc.body.scrollTop,
                    a =
          ...
          (ye.drag = function (r, i, n, a, s, o) {
            function l(l) {
              ...
              if (((this._drag.id = l.identifier), z && l.touches))
              ...
              (this._drag.x = h + f),
                (this._drag.y = u + c),
                !ge.length && e.mousemove(xe).mouseup(ve),
                ge.push({
                  el: this,
                  move_scope: a,
                  start_scope: s,
            ...
            (M.path = function (t) {
              ...
              var r = e._engine.path(e.format[F](e, arguments), this);
            ...
            (M.text = function (t, r, i) {
              var n = e._engine.text(this, t || 0, r || 0, q(i));
              return this.__set__ && this.__set__.push(n), n;
            }),
            (M.set = function (t) {
              !e.is(t, "array") &&
          ...
          var _e = function (t) {
            var e = t.getBoundingClientRect(),
              ...
              l =
                e.left +
                (A.win.pageXOffset || n.scrollLeft || i.scrollLeft) -
                s;
            return { y: o, x: l };
          };
          (M.getElementByPoint = function (t, e) {
            ...
            (ye.isPointInside = function (t, r) {
              var i = (this.realPath = Nt[this.type](this));
              return (
                this.attr("transform") &&
            ...
            (ye.getBBox = function (t) {
              ...
              return t
                ? ((!e.dirty && e.bboxwt) ||
                    ((this.realPath = Nt[this.type](this)),
                ...
                : ((e.dirty || e.dirtyT || !e.bbox) &&
                    ((!e.dirty && this.realPath) ||
                      ((e.bboxwt = 0), (this.realPath = Nt[this.type](this))),
                    (e.bbox = Ot(Et(this.realPath, this.matrix))),
                    (e.bbox.toString = v),
                    (e.dirty = e.dirtyT = 0)),
                  e.bbox);
            }),
            ...
            (ye.glow = function (t) {
              ...
              var e = {
                ...
                i = this.paper,
                n = i.set(),
                a = this.realPath || Nt[this.type](this);
              a = this.matrix ? Et(a, this.matrix) : a;
              for (var s = 1; r + 1 > s; s++)
                n.push(
                  i.path(a).attr({
                    stroke: e.color,
          ...
          var Ae = (e.easing_formulas = {
            ...
            elastic: function (t) {
              return t == !!t
                ? t
                : X(2, -10 * t) * W.sin(((t - 0.075) * (2 * U)) / 0.3) + 1;
            },
            bounce: function (t) {
              var e = 7.5625,
                r = 2.75,
          ...
          (Ae.easeIn = Ae["ease-in"] = Ae["<"]),
            (Ae.easeOut = Ae["ease-out"] = Ae[">"]),
            (Ae.easeInOut = Ae["ease-in-out"] = Ae["<>"]),
            (Ae["back-in"] = Ae.backIn),
            (Ae["back-out"] = Ae.backOut);
          var Ne = [],
            Ee =
                          ...
                          switch (pt[y]) {
                            ...
                            case "colour":
                              d =
                                "rgb(" +
                                [
                                  Le(ot(l[y].r + v * s * h[y].r)),
                                  Le(ot(l[y].g + v * s * h[y].g)),
                                  Le(ot(l[y].b + v * s * h[y].b)),
                                ].join(",") +
                                ")";
                              break;
                            case "path":
                              ...
                              for (var m = 0, _ = l[y].length; _ > m; m++) {
                                d[m] = [l[y][m][0]];
                                for (var w = 1, k = l[y][m].length; k > w; w++)
                                  d[m][w] = +l[y][m][w] + v * s * h[y][m][w];
                                d[m] = d[m].join(j);
                              }
                              d = d.join(j);
                              break;
          ...
          (ye.animateWith = function (t, r, i, n, a, s) {
            ...
            for (var c = 0, f = Ne.length; f > c; c++)
              if (Ne[c].anim == r && Ne[c].el == t) {
                Ne[f - 1].start = Ne[c].start;
                break;
              }
            return o;
          }),
            ...
            (m.prototype.repeat = function (t) {
              var e = new m(this.anim, this.ms);
              return (e.del = this.del), (e.times = W.floor(Y(t, 0)) || 1), e;
            }),
            ...
            (ye.status = function (t, e) {
              ...
              for (n = Ne.length; n > i; i++)
                if (((a = Ne[i]), a.el.id == this.id && (!t || a.anim == t))) {
            ...
            (ye.pause = function (e) {
              for (var r = 0; r < Ne.length; r++)
                Ne[r].el.id != this.id ||
                  (e && Ne[r].anim != e) ||
                  (t("raphael.anim.pause." + this.id, this, Ne[r].anim) !==
                    !1 &&
                    (Ne[r].paused = !0));
              return this;
            }),
            ...
            (ye.stop = function (e) {
              for (var r = 0; r < Ne.length; r++)
                Ne[r].el.id != this.id ||
                  (e && Ne[r].anim != e) ||
                  (t("raphael.anim.stop." + this.id, this, Ne[r].anim) !== !1 &&
                    Ne.splice(r--, 1));
              return this;
            }),
          ...
          (Pe.push = function () {
            for (var t, e, r = 0, i = arguments.length; i > r; r++)
              (t = arguments[r]),
                !t ||
                  (t.constructor != ye.constructor && t.constructor != Fe) ||
                  ((e = this.items.length),
          ...
          return (
            ...
            (Pe.splice = function (t, e, r) {
              (t = 0 > t ? Y(this.length + t, 0) : t),
                (e = Y(0, G(this.length - t, e)));
              var i = [],
                n = [],
                a = [],
                s;
              ...
              for (s = 0; s < o + i.length; s++)
                this.items[t + s] = this[t + s] = o > s ? a[s] : i[s - o];
            ...
            (M.print = function (t, r, i, n, a, s, o, l) {
              ...
              if ((e.is(n, "string") && (n = this.getFont(n)), n)) {
                ...
                for (
                  var d = n.face.bbox[I](k),
                    g = +d[0],
                    x = d[3] - d[1],
                    v = 0,
                    y = +d[1] + ("baseline" == s ? x + +n.face.descent : x / 2),
                    m = 0,
                    b = h.length;
                  b > m;
                  m++
            ...
            (M.add = function (t) {
              if (e.is(t, "array"))
                for (var r = this.set(), i = 0, n = t.length, a; n > i; i++)
                  (a = t[i] || {}),
                    B[T](a.type) && r.push(this[a.type]().attr(a));
              return r;
            }),
          ...
          if (!t || t.svg) {
            ...
            var x = function (i, n) {
              ...
              v = function (e, n) {
                ...
                return (
                  x(d, { fill: m(u), opacity: 1, "fill-opacity": 1 }),
                  (v.fill = c),
                  (v.opacity = 1),
                  (v.fillOpacity = 1),
                  1
                ...
                if ("path" == i.type) {
                  ...
                  if (
                    ...
                    var A = t._g.doc.getElementById(T),
                      N;
                    A
                      ? (g[T]++, (N = A.getElementsByTagName("use")[0]))
                      : ((A = x(x("marker"), {
                          id: T,
                          markerHeight: B,
                          markerWidth: k,
                        ...
                        A.appendChild(N),
                        o.defs.appendChild(A),
                        (g[T] = 1)),
                      x(N, w);
                    var E = b * ("diamond" != v && "oval" != v);
                    a
                      ? ((y = i._.arrows.startdx * f || 0),
                        (m = t.getTotalLength(u.path) - E * f))
                      : ((y = E * f),
                        (m =
                    ...
                    switch (((u[d] = g), d)) {
                      ...
                      case "fill":
                        ...
                        if (F.error) {
                          if (
                            ...
                            if ("opacity" in u || "fill-opacity" in u) {
                              ...
                              if (P) {
                                var z = P.getElementsByTagName("stop");
                                x(z[z.length - 1], {
                                  "stop-opacity":
                        ...
                        F[e]("opacity") &&
                          x(l, {
                            "fill-opacity":
                              F.opacity > 1 ? F.opacity / 100 : F.opacity,
                          });
                      case "stroke":
                        (F = t.getRGB(g)),
                          l.setAttribute(d, F.hex),
                          "stroke" == d &&
                            F[e]("opacity") &&
                            x(l, {
                              "stroke-opacity":
                      ...
                      case "fill-opacity":
                        if (u.gradient) {
                          (P = t._g.doc.getElementById(
                            ...
                            P &&
                              ((z = P.getElementsByTagName("stop")),
                              x(z[z.length - 1], { "stop-opacity": g }));
                          break;
                        }
                      default:
                ...
                if (
                  ...
                  if (a[e]("text")) {
                    ...
                    for (
                      ...
                      p ? x(u[p], { dy: l * C, x: s.x }) : x(u[0], { dy: 0 });
                  x(o, { x: s.x, y: s.y }), (i._.dirty = 1);
                  var g = i._getBBox(),
                    v = s.y - (g.y + g.height / 2);
                  v && t.is(v, "finite") && x(u[0], { dy: v });
                }
              },
              T = function (t) {
                return t.parentNode &&
            ...
            (A.prototype = N),
              ...
              (t._engine.setViewBox = function (t, e, r, i, n) {
                ...
                for (
                  null == t
                    ...
                    x(this.canvas, { viewBox: c, preserveAspectRatio: h });
                  o && l;
              ...
              (t.prototype.remove = function () {
                ...
                for (var e in this)
                  this[e] =
                    "function" == typeof this[e] ? t._removedFactory(e) : null;
              });
            var E = t.st;
            for (var M in N)
              N[e](M) &&
          ...
          if (!t || t.vml) {
            ...
            var S = function (t, e, i) {
              ...
              T = function (n, l) {
                ...
                if (
                  (v && ((f.path = t._getPath[n.type](n)), (n._.dirty = 1)),
                ...
                if ("clip-rect" in l) {
                  var F = r(l["clip-rect"]).split(u);
                  if (4 == F.length) {
                    (F[2] = +F[2] + +F[0]), (F[3] = +F[3] + +F[1]);
                    var P = c.clipRect || t._g.doc.createElement("div"),
                      z = P.style;
                    (z.clip = t.format("rect({1}px {2}px {3}px {0}px)", F)),
                      c.clipRect ||
                        ((z.position = "absolute"),
                        (z.top = 0),
                        (z.left = 0),
                        (z.width = n.paper.width + "px"),
                        (z.height = n.paper.height + "px"),
              ...
              A = function (e, a, s) {
                ...
                if (((e = e.shape || e.node), x.length)) {
                  e.removeChild(s),
                    ...
                    (s.method = "none"),
                    (s.color = x[0].color),
                    (s.color2 = x[x.length - 1].color);
                  for (var v = [], y = 0, m = x.length; m > y; y++)
                    x[y].offset && v.push(x[y].offset + p + x[y].color);
                  (s.colors = v.length ? v.join() : "0% " + s.color),
                    "radial" == c
