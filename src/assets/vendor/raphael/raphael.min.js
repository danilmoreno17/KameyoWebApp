      ...
      (i = [r(2)]),
        (n = function (t) {
                    ...
                    switch (
                      ...
                      case "path":
                        ...
                        for (
                          ...
                          b[C][w] = [0];
                          for (var N = 1, M = v[C][w].length; M > N; N++)
                            b[C][w][N] = (E[w][N] - v[C][w][N]) / x;
                        }
                        break;
                      case "transform":
                        var L = i._,
                        ...
                        if (z)
                          for (
                            ...
                            for (
                              b[C][w] = [v[C][w][0]], N = 1, M = v[C][w].length;
                              M > N;
                              N++
                            )
                              b[C][w][N] = (m[C][w][N] - v[C][w][N]) / x;
                        else {
          ...
          (e.svg = !(e.vml = "VML" == e.type)),
            (e._Paper = N),
            (e.fn = M = N.prototype = e.prototype),
            (e._id = 0),
            (e._oid = 0),
            (e.is = function (t, e) {
              return (
          ...
          var Pt = function (t) {
            ...
            qt = function (t, r, i, n) {
              (t *= 255), (r *= 255), (i *= 255);
              var a = { r: t, g: r, b: i, hex: e.rgb(t, r, i), toString: It };
            ...
            Ut = function (t, e, r, i, a, s, o, l, h, u) {
              ...
              if (H(A) > c) {
                ...
                (T = S + c * (o && T > S ? 1 : -1)),
                  (l = B + r * Y.cos(T)),
                  (h = C + i * Y.sin(T)),
                  (p = Ut(l, h, r, i, a, 0, o, N, M, [T, E, B, C]));
              }
              A = T - S;
              var L = Y.cos(S),
                z = Y.sin(S),
            ...
            (ye.getBBox = function (t) {
              ...
              return t
                ...
                : ((e.dirty || e.dirtyT || !e.bbox) &&
                    ...
                    (e.bbox = Ot(Nt(this.realPath, this.matrix))),
                    (e.bbox.toString = v),
                    (e.dirty = e.dirtyT = 0)),
                  e.bbox);
            }),
        ...
        var a = "0.4.2",
          ...
          d = function (t, e) {
            ...
            var r = p,
              ...
              y = [];
            (c = t), (f = 0);
            for (var m = 0, b = a.length; b > m; m++)
              "zIndex" in a[m] &&
                (h.push(a[m].zIndex),
                a[m].zIndex < 0 && (g[a[m].zIndex] = a[m]));
            for (h.sort(u); h[s] < 0; )
              if (((l = g[h[s++]]), x.push(l.apply(e, n)), f))
                return (f = i), x;
            for (m = 0; b > m; m++)
              if (((l = a[m]), "zIndex" in l))
                if (l.zIndex == h[s]) {
                  ...
                  do
                    if ((s++, (l = g[h[s]]), l && x.push(l.apply(e, n)), f))
                      break;
                  while (l);
                } else g[l.zIndex] = l;
        ...
        (d._events = p),
          ...
          (d.on = function (t, e) {
            if (((t = String(t)), "function" != typeof e))
              return function () {};
            for (var r = t.split(o), i = p, n = 0, a = r.length; a > n; n++)
              (i = i.n),
                (i =
                  (i.hasOwnProperty(r[n]) && i[r[n]]) || (i[r[n]] = { n: {} }));
            ...
            function (t, e) {
              ...
              for (h = 0, u = r.length; u > h; h++)
                for (c = 0; c < g.length; c += a.length - 2) {
                  if (((a = [c, 1]), (i = g[c].n), r[h] != l))
                    i[r[h]] && a.push(i[r[h]]);
                  else for (n in i) i[s](n) && a.push(i[n]);
                  g.splice.apply(g, a);
                }
                ...
                if ("path" == i.type) {
                  ...
                  if (
                    ...
                    var A = t._g.doc.getElementById(T),
                      E;
                    A
                      ? (g[T]++, (E = A.getElementsByTagName("use")[0]))
                      : ((A = x(x("marker"), {
                          id: T,
                          markerHeight: B,
                          markerWidth: k,
