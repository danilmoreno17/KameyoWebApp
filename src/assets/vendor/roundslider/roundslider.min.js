...
(function ($, window, undefined) {
  ...
  function CreateRoundSlider(n, t) {
    for (var i, r, u, f = 0; f < this.length; f++)
      if (((i = this[f]), (r = $.data(i, pluginName)), r)) {
        if ($.isPlainObject(n))
          typeof r.option == "function"
            ? r.option(n)
            : i.id &&
              window[i.id] &&
              typeof window[i.id].option == "function" &&
              window[i.id].option(n);
        else if (typeof n == "string" && typeof r[n] == "function") {
          if ((n === "option" || n.indexOf("get") === 0) && t[2] === undefined)
            return r[n](t[1]);
          r[n](t[1], t[2]);
        }
      } else
        (u = new RoundSlider(i, n)),
          u._saveInstanceOnElement(),
          u._saveInstanceOnID(),
          u._raise("beforeCreate") !== !1
            ? (u._init(), u._raise("create"))
            : u._removeData();
    return this;
  }
  ...
  ($.fn[pluginName] = function (n) {
    ...
    (RoundSlider.prototype = {
      ...
      _init: function () {
        ...
        (this._isBrowserSupport = this._isBrowserSupported()),
          ...
          this.control.is("input") &&
            ...
            this._checkAngular()),
          (this._bindOnDrag = !1),
          (n = this._dataElement().attr("data-updateon")),
          typeof n == "string"
            ? n == "drag" && (this._bindOnDrag = !0)
      ...
      _initialize: function () {
        var n = (this.browserName = this.getBrowserName());
        (n && this.control.addClass("rs-" + n), this._isBrowserSupport) &&
          ((this._isReadOnly = !1),
          this._checkDataType(),
      ...
      _render: function () {
        if (
          ...
          var n = this.$createElement("div.rs-msg");
          n.html(
      ...
      _createLayers: function () {
        var i = this.options.width,
          t = this._start,
          n;
        (n = this.$createElement("div.rs-path rs-transition")),
          this._rangeSlider || this._showRange
            ? ((this.block1 = n.clone().addClass("rs-range-color").rsRotate(t)),
              (this.block2 = n
                .clone()
                .addClass("rs-range-color")
                .css("opacity", "0")
                .rsRotate(t)),
              (this.block3 = n.clone().addClass("rs-path-color").rsRotate(t)),
              (this.block4 = n
              ...
              this.block
                ...
                .addClass("rs-split"))
            : this.block.append(n.addClass("rs-path-color")),
      ...
      _appendTooltip: function () {
        this.container.children(".rs-tooltip").length === 0 &&
      ...
      _tooltipEditable: function () {
        if (this.tooltip && this.options.showTooltip) {
          var n;
          this.options.editableTooltip
            ? (this.tooltip.addClass("edit"), (n = "_bind"))
            : (this.tooltip.removeClass("edit"), (n = "_unbind")),
            this[n](this.tooltip, "click", this._editTooltip);
        }
      },
      _editTooltip: function () {
        if (this.tooltip.hasClass("edit") && !this._isReadOnly) {
          var n = parseFloat(this.tooltip.css("border-left-width")) * 2;
          (this.input = this.$createElement(
            "input.rs-input rs-tooltip-text"
          ).css({
            height: this.tooltip.outerHeight() - n,
            width: this.tooltip.outerWidth() - n,
          })),
            this.tooltip.html(this.input).removeClass("edit").addClass("hover"),
            this.input.focus().val(this._getTooltipValue(!0)),
      ...
      _setHandleValue: function (n) {
        ...
        this.options.sliderType != "min-range" &&
      ...
      _setRadius: function () {
        ...
        if (
          ...
          n.indexOf("quarter") === 0
            ? ((r = u = t),
              (f = n.split("-")),
              this.container.addClass(f[0] + " " + f[1] + " " + f[2]))
            : this.container.addClass("full " + n);
        (e = { height: r, width: u }),
          this.control.css(e),
      ...
      _border: function (n) {
        return n
          ...
          : parseFloat(this.block.css("border-top-width")) * 2;
      },
      ...
      _addSeperator: function (n, t) {
        var r = this.$createElement("span.rs-seperator rs-border"),
          u = this.options.width,
          f = this._border(),
          i = this.$createElement("span.rs-bar rs-transition " + t)
            .append(r)
            .rsRotate(n);
        return this.container.append(i), i;
      },
      _refreshSeperator: function () {
        var i = this._startLine.add(this._endLine),
          r = i.children().removeAttr("style"),
          n = this.options,
          u = n.width,
          f = this._border(),
          t = u + f;
        n.lineCap == "round" && n.circleShape != "full"
          ? (i.addClass("rs-rounded"),
            r.css({ width: t, height: t / 2 + 1 }),
            this._startLine
              .children()
              .css("margin-top", -1)
              .addClass(
                n.sliderType == "min-range" ? "rs-range-color" : "rs-path-color"
              ),
            this._endLine
              .children()
              .css("margin-top", t / -2)
              .addClass("rs-path-color"))
          : (i.removeClass("rs-rounded"),
            r
              .css({ width: t, "margin-top": this._border(!0) / -2 })
      ...
      _createHandle: function (n) {
        var t = this.$createElement("div.rs-handle rs-move"),
          u = this.options,
          f,
          r;
        (f = u.handleShape) != "round" && t.addClass("rs-handle-" + f),
          t.attr({ index: n, tabIndex: "0" });
        var i = this._dataElement()[0].id,
          i = i ? i + "_" : "",
          e =
            i +
            "handle" +
            (u.sliderType == "range" ? "_" + (n == 1 ? "start" : "end") : "");
        return (
          t.attr({ role: "slider", "aria-label": e }),
          (r = this.$createElement("div.rs-bar rs-transition")
            .css("z-index", "7")
            .append(t)
            .rsRotate(this._start)),
          r.addClass(
            u.sliderType == "range" && n == 2 ? "rs-second" : "rs-first"
          ),
          this.container.append(r),
          this._refreshHandle(),
          (this.bar = r),
          (this._active = n),
          n != 1 && n != 2 && (this["_handle" + n] = this._handleDefaults()),
          this._bind(t, "focus", this._handleFocus),
          this._bind(t, "blur", this._handleBlur),
          t
        );
      },
      ...
      _activeHandleBar: function (n) {
        return (
          (n = n != undefined ? n : this._active),
          $(this.container.children("div.rs-bar")[n - 1])
        );
      },
      _handleArgs: function (n) {
        n = n != undefined ? n : this._active;
        var t = this["_handle" + n];
        return {
          element: this._activeHandleBar(n).children(),
          index: n,
          isActive: n == this._active,
      ...
      _raiseEvent: function (n) {
        ...
        if (t !== this.options.value)
          return (
            (this["_pre" + n] = this.options.value),
            this._updateTooltip(),
            (n == "change" || (this._bindOnDrag && n == "drag")) &&
              this._updateHidden(),
            this._raise(n, {
      ...
      _elementDown: function (n) {
        var i, r, u, t, f;
        if (!this._isReadOnly)
          if (((i = $(n.target)), i.hasClass("rs-handle"))) this._handleDown(n);
          else {
            var e = this._getXY(n),
              o = this._getCenterPoint(),
              s = this._getDistance(e, o),
              h = this.block.outerWidth() / 2,
              c = h - (this.options.width + this._border());
            s >= c &&
              s <= h &&
              (n.preventDefault(),
              (r = this.control.find(".rs-handle.rs-focus")),
              this.control.attr("tabindex", "0").focus().removeAttr("tabindex"),
              i.hasClass("rs-seperator")
                ? ((t = i.parent().hasClass("rs-start")
                    ? this.options.min
                    : this.options.max),
                  (u = this._valueToAngle(t)))
                : ((f = this._getAngleValue(e, o)),
                  (u = f.angle),
                  (t = f.value)),
              this._rangeSlider &&
                ((r = this.control.find(".rs-handle.rs-focus")),
                (this._active =
                  r.length == 1
                    ? parseFloat(r.attr("index"))
                    : this._handle2.value - t < t - this._handle1.value
                    ? 2
                    : 1),
                (this.bar = this._activeHandleBar())),
              this._changeSliderValue(t, u),
              this._raiseEvent("change"));
          }
      },
      ...
      _handleKeyDown: function (n) {
        ...
        this._isReadOnly ||
          (((t = n.keyCode),
          (r = this.keys),
          t == 27 && this._handles().blur(),
          t >= 35 && t <= 40) &&
            (t >= 37 && t <= 40 && this._removeAnimation(),
            (u = this["_handle" + this._active]),
            n.preventDefault(),
            t == r.UP || t == r.RIGHT
              ? (i = this._round(this._limitValue(u.value + this.options.step)))
              : t == r.DOWN || t == r.LEFT
              ? (i = this._round(
                  this._limitValue(u.value - this._getMinusStep(u.value))
                ))
              : t == 36
              ? (i = this._getKeyValue("Home"))
              : t == 35 && (i = this._getKeyValue("End")),
            (f = this._valueToAngle(i)),
            this._changeSliderValue(i, f),
            this._raiseEvent("change")));
      },
      ...
      _elementScroll: function (n) {
        if (!this._isReadOnly) {
          ...
          ((u = i.wheelDelta
            ...
            : 0),
          u != 0) &&
            (this._updateActiveHandle(n),
            (r = this["_handle" + this._active]),
            (t =
              r.value +
              (u > 0 ? this.options.step : -this._getMinusStep(r.value))),
            (t = this._limitValue(t)),
            (f = this._valueToAngle(t)),
            this._removeAnimation(),
            this._changeSliderValue(t, f),
            this._raiseEvent("change"),
            this._addAnimation());
        }
      },
      ...
      _changeSliderValue: function (n, t) {
        var u = this._oriAngle(t),
          i = this._limitAngle(t);
        if (this._rangeSlider || this._showRange) {
          if (
            (this._active == 1 && u <= this._oriAngle(this._handle2.angle)) ||
            (this._active == 2 && u >= this._oriAngle(this._handle1.angle)) ||
            this._invertRange
          ) {
            (this["_handle" + this._active] = { angle: t, value: n }),
            ...
            var r =
              ...
              f = "1",
              e = "0";
            r <= 180 && !(r < 0 && r > -180) && ((f = "0"), (e = "1")),
              this.block2.css("opacity", f),
              this.block3.css("opacity", e),
      ...
      _updateARIA: function (n) {
        var i = this.options.min,
          r = this.options.max,
          t;
        this.bar.children().attr({ "aria-valuenow": n }),
          this.options.sliderType == "range"
            ? ((t = this._handles()),
              t.eq(0).attr({ "aria-valuemin": i }),
              t.eq(1).attr({ "aria-valuemax": r }),
              this._active == 1
                ? t.eq(1).attr({ "aria-valuemin": n })
                : t.eq(0).attr({ "aria-valuemax": n }))
            : this.bar
                .children()
                .attr({ "aria-valuemin": i, "aria-valuemax": r });
      },
      _checkKO: function () {
        var f = this._dataElement().data("bind"),
          t,
          i,
          r,
          n,
        ...
        if (typeof f == "string" && typeof ko == "object") {
          if (
            ((t = ko.dataFor(this._dataElement()[0])), typeof t == "undefined")
          )
            return !0;
          for (i = f.split(","), n = 0; n < i.length; n++)
            if (((u = i[n].split(":")), $.trim(u[0]) == "value")) {
              r = $.trim(u[1]);
              break;
            }
          r &&
      ...
      _checkAngular: function () {
        if (
          ...
          typeof angular.element == "function" &&
          ((this._ngName = this._dataElement().attr("ng-model")),
          typeof this._ngName == "string")
        ) {
          this._isAngular = !0;
          var n = this;
      ...
      _getAngleValue: function (n, t, i) {
        var u = Math.atan2(n.y - t.y, t.x - n.x),
          r = -u / (Math.PI / 180);
        return (
          r < this._start && (r += 360),
          (r = this._checkAngle(r, i)),
          this._processStepByAngle(r)
        );
      },
      _checkAngle: function (n, t) {
        var f = this._oriAngle(n),
          i = this["_handle" + this._active].angle,
          r = this._oriAngle(i),
          u;
        if (f > this._end) {
          if (!t) return i;
          n = this._start + (r <= this._end - r ? 0 : this._end);
        } else if (
          t &&
          ((u = this._handleDragDistance),
          this.isNumber(u) && Math.abs(f - r) > u)
        )
          return i;
        return n;
      },
      ...
      _processStepByValue: function (n) {
        var r = this.options.step,
          ...
          o;
        return (
          (e = (n - this.options.min) % r),
          (t = n - e),
          (u = this._limitValue(t + r)),
          (f = this._limitValue(t - r)),
          (i = n >= t ? (n - t < u - n ? t : u) : t - n > n - f ? t : f),
          (i = this._round(i)),
          (o = this._valueToAngle(i)),
          { value: i, angle: o }
        );
      },
      _round: function (n) {
      ...
      _limitAngle: function (n) {
        return (
          n > 360 + this._start && (n -= 360), n < this._start && (n += 360), n
        );
      },
      _limitValue: function (n) {
        return (
          n < this.options.min && (n = this.options.min),
      ...
      _updateHidden: function () {
        ...
        this._hiddenField.val(n),
          (this._isKO || this._isAngular) &&
            this._hiddenField.trigger("change"),
          this._isAngular && (this._scope()[this._ngName] = n);
      },
      ...
      _getTooltipPos: function () {
        var n = this.options.circleShape,
          t;
        if (n == "full" || n == "pie" || n.indexOf("custom") === 0)
          return {
      ...
      _validateEndAngle: function () {
        ...
        return (
          ...
          end <= this.options.startAngle && (end += 360),
          end
        );
      },
      ...
      _appendOverlay: function () {
        ...
        n == "pie"
          ...
          : (n == "custom-half" || n == "custom-quarter") &&
      ...
      _checkOverlay: function (n, t) {
        ...
        i.length == 0 &&
          ((i = this.$createElement("div" + n + " rs-transition rs-bg-color")),
      ...
      _checkDataType: function () {
        ...
        for (r in u.numberType)
          (n = u.numberType[r]),
            (t = i[n]),
            (i[n] = this.isNumber(t) ? parseFloat(t) : this.defaults[n]);
        for (r in u.booleanType)
          (n = u.booleanType[r]), (t = i[n]), (i[n] = t == "false" ? !1 : !!t);
        for (r in u.stringType)
          (n = u.stringType[r]), (t = i[n]), (i[n] = ("" + t).toLowerCase());
      },
      ...
      _updateStartEnd: function () {
        ...
        n != "full" &&
          (n.indexOf("quarter") != -1
            ...
            : n == "pie" && (this.options.endAngle = "+270"),
          n == "quarter-top-left" || n == "half-top"
            ? (this.options.startAngle = 0)
            : n == "quarter-top-right" || n == "half-right"
            ? (this.options.startAngle = 90)
            : n == "quarter-bottom-right" || n == "half-bottom"
            ? (this.options.startAngle = 180)
            : (n == "quarter-bottom-left" || n == "half-left") &&
      ...
      _analyzeModelValue: function () {
        var n = this.options.value,
          ...
          r = this.isNumber,
          i;
        n instanceof Array && (n = n.toString()),
          (i = typeof n == "string" ? n.split(",") : [n]),
          this._rangeSlider
            ? (u =
                typeof n == "string"
                  ? i.length >= 2
                    ? (r(i[0]) ? i[0] : t) + "," + (r(i[1]) ? i[1] : e)
                    : r(i[0])
                    ? t + "," + i[0]
                    : t + "," + t
                  : r(n)
                  ...
                  : t + "," + t)
            : typeof n == "string"
            ? ((f = i.pop()), (u = r(f) ? parseFloat(f) : t))
            : (u = r(n) ? parseFloat(n) : t),
          (this.options.value = u);
      },
      _validateModelValue: function () {
        ...
        if (this._rangeSlider) {
          ...
          (n = this._limitValue(n)),
            (t = this._limitValue(t)),
            this._invertRange || (n > t && (t = n)),
            (this._handle1 = this._processStepByValue(n)),
            (this._handle2 = this._processStepByValue(t)),
            (this.options.value =
              this._handle1.value + "," + this._handle2.value);
        } else
          (i = this._showRange ? 2 : this._active || 1),
            (this["_handle" + i] = this._processStepByValue(
              this._limitValue(r)
            )),
            this._showRange && (this._handle1 = this._handleDefaults()),
            (this.options.value = this["_handle" + i].value);
      },
      ...
      getBrowserName: function () {
        ...
        return (
          ...
          t.indexOf(" OPR/") >= 0
            ...
            ? (n = "firefox")
            : /*@cc_on!@*/ !1 && !document.documentMode
            ? window.StyleMedia
              ? (n = "edge")
              : t.indexOf("Safari") != -1 && t.indexOf("Chrome") == -1
              ? (n = "safari")
      ...
      _raise: function (n, t) {
        ...
        return (
          ...
          i &&
            ((t.type = n),
            typeof i == "string" && (i = window[i]),
            $.isFunction(i) &&
              ((r = i.call(this, t)), (r = r === !1 ? !1 : r))),
          this.control.trigger($.Event(n, t)),
          r
        );
      },
      ...
      _saveInstanceOnID: function () {
        var n = this.id;
        n && typeof window[n] != "undefined" && (window[n] = this);
      },
      _removeData: function () {
        var n = this._dataElement()[0];
        $.removeData && $.removeData(n, pluginName),
          n.id &&
            typeof window[n.id]._init == "function" &&
            delete window[n.id];
      },
      ...
      _set: function (n, t) {
        ...
        if ($.inArray(n, i.numberType) != -1) {
          ...
          $.inArray(n, i.booleanType) != -1
            ? (t = t == "false" ? !1 : !!t)
            : $.inArray(n, i.stringType) != -1 && (t = t.toLowerCase());
        if (this.options[n] != t) {
          this.options[n] = t;
          switch (n) {
            case "startAngle":
        ...
        if (this._getInstance() && this._isBrowserSupport) {
          if ($.isPlainObject(n)) {
            (n.min !== undefined || n.max !== undefined) &&
              (n.min !== undefined &&
                ((this.options.min = n.min), delete n.min),
              n.max !== undefined && ((this.options.max = n.max), delete n.max),
              n.value == undefined && this._set("value", this.options.value));
      ...
      getValue: function (n) {
        if (this.options.sliderType == "range" && this.isNumber(n)) {
          var t = parseFloat(n);
          ...
          if (this.isNumber(t))
            if (this.options.sliderType == "range") {
              var i = parseFloat(t),
                r = parseFloat(n);
              i == 1
                ? (n = r + "," + this._handle2.value)
                : i == 2 && (n = this._handle1.value + "," + r);
    ...
    ($.fn.rsRotate = function (n) {
      var t = this;
      return (
        t.css("-webkit-transform", "rotate(" + n + "deg)"),
        t.css("-moz-transform", "rotate(" + n + "deg)"),
        t.css("-ms-transform", "rotate(" + n + "deg)"),
        t.css("-o-transform", "rotate(" + n + "deg)"),
        t.css("transform", "rotate(" + n + "deg)"),
        t
      );
    }),
