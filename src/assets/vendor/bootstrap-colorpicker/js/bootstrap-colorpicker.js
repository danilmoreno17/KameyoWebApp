...
(function (factory) {
  ...
  Color.prototype = {
    ...
    setAlpha: function (a) {
      this.value.a =
        Math.round((parseInt((1 - a) * 100, 10) / 100) * 100) / 100;
    },
  ...
  var Colorpicker = function (element, options) {
    ...
    this.component =
      this.component !== false ? this.element.find(this.component) : false;
    if (this.component && this.component.length === 0) {
      this.component = false;
    }
    this.container =
      this.options.container === true ? this.element : this.options.container;
  ...
  Colorpicker.prototype = {
    ...
    updatePicker: function (val) {
      ...
      if (this.options.horizontal === false) {
        ...
        icns
          .eq(1)
          .css("top", sl.hue.maxTop * (1 - this.color.value.h))
          .end()
          .eq(2)
        ...
        icns
          .eq(1)
          .css("left", sl.hue.maxLeft * (1 - this.color.value.h))
          .end()
          .eq(2)
    ...
    mousedown: function (e) {
      ...
      var sl = this.options.horizontal
        ? this.options.slidersHorz
        : this.options.sliders;
    ...
    keyup: function (e) {
      if (e.keyCode === 38) {
        if (this.color.value.a < 1) {
          this.color.value.a =
            Math.round((this.color.value.a + 0.01) * 100) / 100;
        }
        this.update(true);
