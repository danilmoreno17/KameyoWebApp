...
!(function (a, b) {
  "function" == typeof define && define.amd
    ...
    ? (module.exports = b())
    : (a["Chartist.plugins.ctAxisTitle"] = b());
})(this, function () {
  return (
    (function (a, b, c) {
      "use strict";
          ...
          return (
            ...
            function (b) {
              b.on("created", function (b) {
                if (!a.axisX.axisTitle && !a.axisY.axisTitle)
                  throw new Error(
                ...
                if (
                  (a.axisX.axisTitle &&
                    b.axisX &&
                    ((d =
                      b.axisX.axisLength / 2 +
                      b.options.axisX.offset +
                      b.options.chartPadding.left),
                    (e = b.options.chartPadding.top),
                    "end" === b.options.axisX.position &&
                      (e += b.axisY.axisLength),
                    (f = new c.Svg("text")),
                    f.addClass(a.axisX.axisClass),
                    f.text(a.axisX.axisTitle),
                    f.attr({
                    ...
                    b.svg.append(f, !0)),
                  a.axisY.axisTitle && b.axisY)
                ) {
                  (d = 0),
                    (e = b.axisY.axisLength / 2 + b.options.chartPadding.top),
                    "end" === b.options.axisY.position &&
                      (d = b.axisX.axisLength);
                  var g =
                    "rotate(" +
                    (a.axisY.flipTitle ? -90 : 90) +
                    ", " +
                    d +
                    ", " +
                    e +
                    ")";
                  (f = new c.Svg("text")),
                    f.addClass(a.axisY.axisClass),
                    f.text(a.axisY.axisTitle),
                    f.attr({
