...
(function () {
  CKEDITOR.on("dialogDefinition", function (a) {
    ...
    a = a.data.definition;
    "link" == b
      ? (a.removeContents("target"),
        a.removeContents("upload"),
        a.removeContents("advanced"),
        (b = a.getContents("info")),
        b.remove("emailSubject"),
        b.remove("emailBody"))
      : "image" == b &&
        (a.removeContents("advanced"),
        (b = a.getContents("Link")),
        b.remove("cmbTarget"),
        (b = a.getContents("info")),
        b.remove("txtAlt"),
        b.remove("basic"));
  ...
  var l = {
    ...
    x = { strong: "b", b: "b", u: "u", em: "i", i: "i", code: "code", li: "*" },
    m = {
      strong: "b",
      em: "i",
      u: "u",
    ...
    y = { color: "color", size: "font-size" },
    z = { url: "href", email: "mailhref", quote: "cite", list: "listType" },
    n = CKEDITOR.dtd,
  ...
  CKEDITOR.BBCodeParser.prototype = {
    parse: function (a) {
      for (var b, c, h = 0; (b = this._.bbcPartsRegex.exec(a)); )
        if (
          ((c = b.index),
          c > h && ((h = a.substring(h, c)), this.onText(h, 1)),
          (h = this._.bbcPartsRegex.lastIndex),
          (c = (b[1] || b[3] || "").toLowerCase()) && !l[c])
        )
          this.onText(b[0]);
        else if (b[1]) {
          var f = l[c],
          ...
          if ((b = b[2]))
            if (
              ...
              var e = "",
                d = void 0;
              for (d in g) var u = (d + ":" + g[d]).replace(C, ";"), e = e + u;
              b.style = e;
  ...
  CKEDITOR.htmlParser.fragment.fromBBCode = function (a) {
      ...
      if (0 < g.length)
        for (var f = 0; f < g.length; f++) {
          var b = g[f],
            c = b.name,
            k = CKEDITOR.dtd[c],
            e = d.name && CKEDITOR.dtd[d.name];
          (e && !e[c]) ||
            (a && k && !k[a] && CKEDITOR.dtd[a]) ||
            ((b = b.clone()), (b.parent = d), (d = b), g.splice(f, 1), f--);
        }
    }
    function c(a, f) {
      var b = d.children.length,
        c = 0 < b && d.children[b - 1],
        b = !c && v.getRule(m[d.name], "breakAfterOpen"),
        c =
          c &&
          c.type == CKEDITOR.NODE_ELEMENT &&
          v.getRule(m[c.name], "breakAfterClose"),
        k = a && v.getRule(m[a], f ? "breakBeforeClose" : "breakBeforeOpen");
      e && (b || c || k) && e--;
      e && a in A && e++;
    ...
    function h(a, f) {
      ...
      a.parent = f;
      f.children.push(a);
      a.returnPoint && ((d = a.returnPoint), delete a.returnPoint);
    }
    var f = new CKEDITOR.BBCodeParser(),
      k = new CKEDITOR.htmlParser.fragment(),
      g = [],
      e = 0,
      d = k,
      u;
    f.onTagOpen = function (a, k) {
      ...
      if (CKEDITOR.dtd.$removeEmpty[a]) g.push(e);
      else {
        var w = d.name,
          p =
            w &&
            (CKEDITOR.dtd[w] ||
              (d._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span));
        if (p && !p[a]) {
          var p = !1,
            l;
          a == w
    ...
    f.onTagClose = function (a) {
      ...
      for (var b = [], c = [], e = d; e.type && e.name != a; )
        e._.isBlockLike || c.unshift(e), b.push(e), (e = e.parent);
      if (e.type) {
        ...
        c(),
          ...
          a.replace(/(\r\n|[\r\n])|[^\r\n]*/g, function (a, f) {
            if (void 0 !== f && f.length) e++;
              ...
              b != a.length &&
                h(new CKEDITOR.htmlParser.text(a.substring(b, a.length)), d);
            }
          });
    };
    for (
      f.parse(CKEDITOR.tools.htmlEncode(a));
      d.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT;

    )
      (a = d.parent), h(d, a), (d = a);
    return k;
  };
    ...
    proto: {
      ...
      openTagClose: function (a) {
        "br" == a
          ...
          : a in l &&
            (this.write("]"),
            this.getRule(a, "breakAfterOpen") && this.lineBreak(1));
      },
      ...
      closeTag: function (a) {
        a in l &&
          (this.getRule(a, "breakBeforeClose") && this.lineBreak(1),
          "*" != a && this.write("[/", a, "]"),
          this.getRule(a, "breakAfterClose") && this.lineBreak(1));
      },
      text: function (a) {
        this.write(a);
      },
  ...
  CKEDITOR.plugins.add("bbcode", {
    ...
    init: function (a) {
      ...
      var c = a.config,
        h = new CKEDITOR.htmlParser.filter();
      h.addRules({
        elements: {
          ...
          span: function (a) {
            ...
            if ((b = a.attributes.bbcode))
              "img" == b
                ? ((a.name = "img"),
                  (a.attributes.src = a.children[0].value),
                  (a.children = []))
                : "email" == b &&
                  ((a.name = "a"),
                  (a.attributes.href = "mailto:" + a.children[0].value)),
          ...
          ol: function (a) {
            a.attributes.listType
              ? "decimal" != a.attributes.listType &&
                (a.attributes.style =
                  "list-style-type:" + a.attributes.listType)
              : (a.name = "ul");
          ...
          smiley: function (a) {
            ...
            var b = a.attributes.desc,
              g =
                c.smiley_images[
                  CKEDITOR.tools.indexOf(c.smiley_descriptions, b)
                ],
              g = CKEDITOR.tools.htmlEncode(c.smiley_path + g);
            a.attributes = {
              src: g,
      ...
      a.dataProcessor.htmlFilter.addRules(
        {
          elements: {
            $: function (b) {
              var c = b.attributes,
                g = CKEDITOR.tools.parseCssText(c.style, 1),
                e,
                d = b.name;
              if (d in x) d = x[d];
              else if ("span" == d)
                if ((e = g.color))
                  (d = "color"), (e = CKEDITOR.tools.convertRgbToHex(e));
                else {
                  if ((e = g["font-size"]))
                    if ((c = e.match(/(\d+)%$/))) (e = c[1]), (d = "size");
                }
              else if ("ol" == d || "ul" == d) {
                if ((e = g["list-style-type"]))
                  switch (e) {
                    case "lower-alpha":
                      e = "a";
                      break;
                ...
                try {
                  var h = b.children[0],
                    l = b.children[1],
                    m = "cite" == h.name && h.children[0].value;
                ...
                if ((e = c.href))
                  -1 !== e.indexOf("mailto:")
                    ? ((d = "email"),
                      (b.children = [
                        new CKEDITOR.htmlParser.text(e.replace("mailto:", "")),
                      ]),
                      (e = ""))
                ...
                c = c.alt;
                if (g && -1 != g.indexOf(a.config.smiley_path) && c)
    ...
    afterInit: function (a) {
      ...
      a._.elementsPath &&
        ...
        b.push(function (b) {
          var h = b.getName(),
            f = m[h] || !1;
          "link" == f && 0 === b.getAttribute("href").indexOf("mailto:")
            ? (f = "email")
            : "span" == h
            ? b.getStyle("font-size")
              ? (f = "size")
              : b.getStyle("color") && (f = "color")
            : "img" == f &&
              (b = b.data("cke-saved-src") || b.getAttribute("src")) &&
              0 === b.indexOf(a.config.smiley_path) &&
              (f = "smiley");
          return f;
        });
    },
