...
(function () {
    ...
    function e() {
      ...
      if (this.deflated)
        ...
        var b = this.widget,
          ...
          b = b.data.hasCaption;
        if (d) {
          for (var l = 3; l--; ) c.removeClass(d[l]);
          "center" == e
            ? b && c.addClass(d[1])
            : "none" != e && c.addClass(d[q[e]]);
        } else
          "center" == e
            ? (b
              ...
              c.removeStyle("float"))
            : ("none" == e ? c.removeStyle("float") : c.setStyle("float", e),
              c.removeStyle("text-align"));
      }
    }
    var f = a.config.image2_alignClasses,
    ...
    return {
      ...
      data: function () {
        ...
        if (a.filter.checkFeature(d.dimension)) {
          ...
          c = this.parts.image;
          for (var f in d)
            d[f] ? c.setAttribute(f, d[f]) : c.removeAttribute(f);
        }
        this.oldData = CKEDITOR.tools.extend({}, this.data);
      },
      init: function () {
        var b = CKEDITOR.plugins.image2,
          c = this.parts.image,
          e = {
          ...
          g = c.getAscendant("a");
        g && this.wrapper.contains(g) && (this.parts.link = g);
        e.align ||
          ((c = e.hasCaption ? this.element : c),
          f
            ? (c.hasClass(f[0])
                ? (e.align = "left")
                : c.hasClass(f[2]) && (e.align = "right"),
              e.align ? c.removeClass(f[q[e.align]]) : (e.align = "none"))
            : ((e.align = c.getStyle("float") || "none"),
              c.removeStyle("float")));
        a.plugins.link &&
          this.parts.link &&
          ((e.link = b.getLinkAttributesParser()(a, this.parts.link)),
          (c = e.link.advanced) &&
            c.advCSSClasses &&
            (c.advCSSClasses = CKEDITOR.tools.trim(
              c.advCSSClasses.replace(/cke_\S+/, "")
            )));
        this.wrapper[(e.hasCaption ? "remove" : "add") + "Class"](
          "cke_image_nocaption"
        );
        this.setData(e);
      ...
      hasClass: function (a) {
        return m(this).hasClass(a);
      },
      removeClass: function (a) {
        m(this).removeClass(a);
      },
      getClasses: (function () {
        var a = new RegExp("^(" + [].concat(g, f).join("|") + ")$");
        return function () {
          var b = this.repository.parseElementClasses(
              m(this).getAttribute("class")
            ),
            e;
  ...
  function H(a) {
    var b = n(a),
      e = a.config.image2_captionedClass;
    return function (a, g) {
      ...
      if (
        ...
        (b(a)
          ...
          : "figure" == c && a.hasClass(e)
          ? (h = a.getFirst("img") || a.getFirst("a").getFirst("img"))
          : r(a) && (h = "a" == a.name ? a.children[0] : a),
        h)
      ) {
        for (var C in d)
          (d = h.attributes[C]) && d.match(J) && delete h.attributes[C];
        return a;
      }
    };
  }
  ...
  function n(a) {
    var b = a.config.image2_captionedClass,
      e = a.config.image2_alignClasses,
      f = { figure: 1, a: 1, img: 1 };
    return function (g) {
      ...
      } else if (a.enterMode == CKEDITOR.ENTER_P || !r(d)) return !1;
      return (
        e
          ? g.hasClass(e[1])
          : "center" ==
  ...
  function G(a) {
    var b = a.editor,
      e = b.editable(),
      f = b.document,
      g = (a.resizer = f.createElement("span"));
    ...
    g.on("mousedown", function (c) {
      ...
      l(
        ...
        function (a) {
          ...
          1 == A
            ...
            : w();
          15 <= t && 15 <= u
            ? (h.setAttributes({ width: t, height: u }), (z = !0))
            : (z = !1);
        },
        n
      );
      l(
        "mouseup",
        function () {
          for (var c; (c = n.pop()); ) c.removeListener();
          e.removeClass(r);
          g.removeClass("cke_image_resizing");
          z && (a.setData({ width: t, height: u }), b.fire("saveSnapshot"));
          z = !1;
        },
        n
      );
  ...
  function L(a) {
    ...
    return function (f) {
      ...
      if (g) {
        ...
        if (f in { right: 1, left: 1, center: 1 })
            ...
            b.changed.hasCaption &&
              ...
              g
                ? ((g = CKEDITOR.dom.element.createFromHtml(
                  ...
                  e(g, b.element),
                  c.replace(g.findOne("img")),
                  (b.element = g))
                : (c.replace(b.element), (b.element = c)));
          },
          link: function (b, c, d) {
            if (b.changed.link) {
              var e = b.element.is("img")
                  ? b.element
