  ...
  var e,
    ...
    m = function (c) {
      ...
      "a" == c.getName() &&
        ...
        e.hide(),
        (c = k.document.createElement("span")),
        c.setHtml(b),
        k.insertText(c.getText()));
    },
      ...
      for (
        ...
        for (var l = 0; l < c; l++, d++) {
          if ((h = b[d])) {
            h instanceof Array
              ? ((e = h[1]), (h = h[0]))
              : ((e = h.replace("\x26", "").replace(";", "").replace("#", "")),
                (e = n[e] || h));
            var m =
            ...
            f.push(
              '\x3ctd class\x3d"cke_dark_background" style\x3d"cursor: default" role\x3d"presentation"\x3e\x3ca href\x3d"javascript: void(0);" role\x3d"option" aria-posinset\x3d"' +
                ...
                '"',
              ' aria-setsize\x3d"' + g + '"',
              ' aria-labelledby\x3d"' + m + '"',
              ' class\x3d"cke_specialchar" title\x3d"',
              CKEDITOR.tools.htmlEncode(e),
