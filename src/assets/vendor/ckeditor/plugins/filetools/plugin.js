...
(function () {
  ...
  function m(a) {
    ...
    for (d = 0; d < a.length; d += 512) {
      e = a.slice(d, d + 512);
      f = Array(e.length);
      for (k = 0; k < e.length; k++) f[k] = e.charCodeAt(k);
      e = new Uint8Array(f);
      b.push(e);
    }
  ...
  CKEDITOR.plugins.add("filetools", {
    lang: "cs,da,de,de-ch,en,eo,eu,fr,gl,id,it,km,ko,ku,nb,nl,pl,pt-br,ru,sv,tr,ug,uk,zh,zh-cn",
    beforeInit: function (a) {
      a.uploadRepository = new g(a);
      a.on(
        "fileUploadRequest",
        function (a) {
          a = a.data.fileLoader;
          a.xhr.open("POST", a.uploadUrl, !0);
        },
        null,
        null,
        5
      ...
      a.on(
        ...
        function (a) {
          a = a.data.fileLoader;
          var b = new FormData();
          b.append("upload", a.file, a.fileName);
          b.append("ckCsrfToken", CKEDITOR.tools.getCsrfToken());
          a.xhr.send(b);
        },
        null,
        null,
      ...
      a.on(
        ...
        function (a) {
          ...
          try {
            ...
            f.uploaded
              ? ((e.fileName = f.fileName), (e.url = f.url))
              : a.cancel();
          } catch (k) {
  ...
  g.prototype = {
    create: function (a, c) {
      var b = this.loaders.length,
        d = new h(this.editor, a, c);
      d.id = b;
      this.loaders[b] = d;
      this.fire("instanceCreated", d);
      return d;
    },
    isFinished: function () {
    ...
    upload: function (a) {
      a
        ? ((this.uploadUrl = a),
          ...
          this.editor.fire("fileUploadRequest", { fileLoader: this }) &&
          ...
          if (((b.uploaded = b.uploadTotal), 200 > d.status || 299 < d.status))
            ...
            for (
              var a = { fileLoader: b },
                ...
                k = b.editor.fire("fileUploadResponse", a),
                g = 0;
              g < c.length;
              g++
            ) {
              var h = c[g];
              "string" === typeof a[h] && (b[h] = a[h]);
            }
            !1 === k ? b.changeStatus("error") : b.changeStatus("uploaded");
          }
      };
    },
  ...
  CKEDITOR.tools.extend(CKEDITOR.fileTools, {
    ...
    getUploadUrl: function (a, c) {
      ...
      return c && a[c + "UploadUrl"]
        ...
        ? a["filebrowser" + b(c, 1) + "UploadUrl"] + "\x26responseType\x3djson"
