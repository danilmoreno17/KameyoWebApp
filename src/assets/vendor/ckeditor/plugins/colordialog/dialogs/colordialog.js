...
CKEDITOR.dialog.add("colordialog", function (x) {
  ...
  function z(a) {
    ...
    "td" == a.getName() &&
      ...
      f.addClass("cke_colordialog_selected"),
      p.getContentElement("picker", "selectedColor").setValue(c));
  }
  function y() {
    f &&
      (f.removeClass("cke_colordialog_selected"),
  ...
  (function () {
    function a(a, d) {
      for (var w = a; w < a + 3; w++) {
        ...
        for (var e = d; e < d + 3; e++)
          for (var g = 0; 6 > g; g++) c(f.$, "#" + b[e] + b[g] + b[w]);
      }
    }
    function c(a, c) {
            ...
            children: [
              ...
              C,
              {
                ...
                children: [
                  ...
                  C,
                  { type: "button", id: "clear", label: e.clear, onClick: m },
                ],
              },
            ],
          },
