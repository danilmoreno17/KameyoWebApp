...
(function () {
  function C(a) {
    a = a.toUpperCase();
    for (var c = D.length, b = 0, f = 0; f < c; ++f)
      for (
        var d = D[f], e = d[1].length;
        a.substr(0, e) == d[1];
        a = a.substr(e)
      )
        b += d[0];
  ...
  function E(a) {
    a = a.toUpperCase();
    for (var c = 1, b = 1; 0 < a.length; b *= 26)
      (c += "ABCDEFGHIJKLMNOPQRSTUVWXYZ".indexOf(a.charAt(a.length - 1)) * b),
    ...
    H = (CKEDITOR.plugins.pastefromword = {
      utils: {
        ...
        getStyleComponents: (function () {
          var a = CKEDITOR.dom.element.createFromHtml(
            '\x3cdiv style\x3d"position:absolute;left:-9999px;top:-9999px;"\x3e\x3c/div\x3e',
            CKEDITOR.document
          );
      ...
      filters: {
        flattenList: function (a, c) {
          ...
          for (var d = a.children, e, k = 0; k < d.length; k++)
            if (((e = d[k]), e.name in CKEDITOR.dtd.$listItem)) {
              var l = e.attributes,
                g = e.children,
                n = g[0],
                h = g[g.length - 1];
              n.attributes &&
                n.attributes.style &&
                -1 < n.attributes.style.indexOf("mso-list") &&
                ((e.attributes.style = n.attributes.style),
                n.replaceWithChildren());
              h.name in CKEDITOR.dtd.$list &&
                (a.add(h, k + 1), --g.length || d.splice(k--, 1));
              e.name = "cke:li";
              ...
              H.filters.stylesFilter([
                [
                  ...
                  function (a) {
                    (a = a.match(/0$|\d+\.?\d*\w+/)) &&
                      (x = CKEDITOR.tools.convertToPx(a[0]));
                  },
                ],
                1 == c
                  ? [
        ...
        assembleList: function (a) {
          var c = a.children,
            ...
            l;
          a = [];
          for (var g, n, h, p, m, t, q = 0; q < c.length; q++)
            if (((b = c[q]), "cke:li" == b.name))
              if (
                ((b.name = "li"),
                (f = b.attributes),
                (h =
                ...
                d != e && (n = g = null);
                if (h) {
                  if (n && B[n][g].test(h[1])) (p = n), (m = g);
                  else
                    for (var u in B)
                      for (var y in B[u])
                        if (B[u][y].test(h[1]))
                          if ("ol" == u && /alpha|roman/.test(y)) {
                            if (
                              ((g = /roman/.test(y) ? C(h[1]) : E(h[1])),
                              !t || g < t)
                            )
                              (t = g), (p = u), (m = y);
                          } else {
                ...
                if (l) {
                  if (d > e)
                    a.push((l = new CKEDITOR.htmlParser.element(p))),
                      l.add(b),
                      k.add(l);
                  else {
                    if (d < e) {
            ...
            (b || "")
              ...
              .replace(
                ...
                function (b, e, g) {
                  ...
                  for (var n, h, p, m = 0; m < a.length; m++)
                    if (
                      a[m] &&
                      ((b = a[m][0]),
                      (n = a[m][1]),
        ...
        elementMigrateFilter: function (a, c) {
          return a
            ? function (b) {
                ...
                f.attributes &&
                  f.attributes["class"] &&
                  (b.classWhiteList = " " + f.attributes["class"] + " ");
              }
            : function () {};
        },
        ...
        return {
          ...
          elements: {
            ...
            $: function (a) {
              ...
              z in f &&
                e.style &&
                (e.style = l([[/^(:?width|height)$/, null, y]])(e.style) || "");
              if (z.match(/h\d/)) {
                a.filterChildren(c);
                if (u(a)) return;
                g(d["format_" + z])(a);
              } else if (z in b.$inline)
                a.filterChildren(c), q(a) && delete a.name;
            ...
            p: function (a) {
              if (
                ...
                (a.getStyle("mso-list") &&
                  !a.getStyle("mso-list").match(/^(none|skip)$/i))
              ) {
            ...
            font: function (a) {
              if (t(a.parent)) delete a.name;
                ...
                "font" == e.name
                  ...
                  : ((d = (d || "").split(";")),
                    b.color &&
                      ("#000000" != b.color && d.push("color:" + b.color),
                      delete b.color),
                    b.face && (d.push("font-family:" + b.face), delete b.face),
                    b.size &&
                      (d.push(
                        "font-size:" +
                          (3 < b.size
            ...
            span: function (a) {
              ...
              a.filterChildren(c);
              if (q(a)) return delete a.name, null;
              if (t(a)) {
                var b = a.firstChild(function (a) {
                ...
                b.style =
                  l([
                    ...
                    [
                      /^font-family$/,
                      null,
                      r ? null : n(d.font_style, "family"),
                    ],
                    [
                      /^font-size$/,
                      null,
                      r ? null : n(d.fontSize_style, "size"),
                    ],
                    [
                      /^color$/,
                      null,
                      r ? null : n(d.colorButton_foreStyle, "color"),
                    ],
                    [
                      /^background-color$/,
                      null,
                      r ? null : n(d.colorButton_backStyle, "color"),
                    ],
                  ])(e, a) || "";
            ...
            a: function (a) {
              var b = a.attributes;
              b.name && b.name.match(/ole_link\d+/i)
                ? delete a.name
                : b.href &&
                  b.href.match(/^file:\/\/\/[\S]+#/i) &&
          ...
          attributes: {
            ...
            class: function (a, b) {
              return b.classWhiteList &&
                -1 != b.classWhiteList.indexOf(" " + a + " ")
                ? a
                : !1;
            },
            bgcolor: k,
  ...
  CKEDITOR.cleanWord = function (a, c) {
    ...
    CKEDITOR.env.gecko &&
      (a = a.replace(
        /(\x3c!--\[if[^<]*?\])--\x3e([\S\s]*?)\x3c!--(\[endif\]--\x3e)/gi,
        "$1$2$3"
      ));
    CKEDITOR.env.webkit &&
      (a = a.replace(
        /(class="MsoListParagraph[^>]+>\x3c!--\[if !supportLists\]--\x3e)([^<]+<span[^<]+<\/span>)(\x3c!--\[endif\]--\x3e)/gi,
        "$1\x3cspan\x3e$2\x3c/span\x3e$3"
      ));
    var b = new J(),
      f = b.dataFilter;
