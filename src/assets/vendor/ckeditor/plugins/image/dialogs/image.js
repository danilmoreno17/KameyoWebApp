    ...
    function k(a) {
      if (!w) {
        ...
        if (c) {
          this.commit(1, c);
          a = [].concat(a);
          for (var d = a.length, f, g = 0; g < d; g++)
            (f = b.getContentElement.apply(b, a[g].split(":"))) &&
              f.setup(1, c);
        }
        w = 0;
      }
        ...
        b.lockRatio &&
          ...
          "true" == c.getCustomData("isReady") &&
            ("txtHeight" == this.id
              ? (a &&
                  "0" != a &&
                  (a = Math.round((a / c.$.height) * c.$.width)),
                isNaN(a) || b.setValueOf("info", "txtWidth", a))
              : (a &&
                  "0" != a &&
                  (a = Math.round((a / c.$.width) * c.$.height)),
    ...
    return {
      ...
      onShow: function () {
        ...
        this.imageEditMode &&
          ...
          (this.imageElement = this.cleanImageElement.clone(!0, !0)),
      ...
      onOk: function () {
        if (this.imageEditMode) {
          ...
          "image" == l && "input" == a && confirm(d.lang.image.button2Img)
            ? ((this.imageElement = d.document.createElement("img")),
              this.imageElement.setAttribute("alt", ""),
              d.insertElement(this.imageElement))
            : "image" != l && "img" == a && confirm(d.lang.image.img2Button)
        ...
        this.imageEditMode
          ? !this.linkEditMode && this.addLink
            ? (d.insertElement(this.linkElement),
              this.imageElement.appendTo(this.linkElement))
            : this.linkEditMode &&
              !this.addLink &&
              (d.getSelection().selectElement(this.linkElement),
              d.insertElement(this.imageElement))
          : this.addLink
          ? this.linkEditMode
      ...
      onLoad: function () {
        ...
        this.getContentElement("info", "ratioLock") &&
          (this.addFocusable(a.getById(y), 5),
          this.addFocusable(a.getById(t), 5));
        this.commitContent = v;
      },
      onHide: function () {
        this.preview && this.commitContent(8, this.preview);
        this.originalElement &&
          (this.originalElement.removeListener("load", u),
          this.originalElement.removeListener("error", h),
          this.originalElement.removeListener("abort", h),
                  ...
                  children: [
                    {
                      ...
                      onChange: function () {
                        ...
                        if (0 < b.length) {
                          ...
                          a.preview &&
                            ...
                            a.preview.setAttribute("src", x.$.src),
                            e(a));
                        } else
                          a.preview &&
                      ...
                      setup: function (a, b) {
                        if (1 == a) {
                          var c =
                            b.data("cke-saved-src") || b.getAttribute("src");
              ...
              commit: function (a, b) {
                1 == a
                  ? (this.getValue() || this.isChanged()) &&
                    b.setAttribute("alt", this.getValue())
                  : 4 == a
                  ? b.setAttribute("alt", this.getValue())
                  : 8 == a && b.removeAttribute("alt");
              },
            },
            {
              type: "hbox",
