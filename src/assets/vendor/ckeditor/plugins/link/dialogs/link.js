    ...
    return {
          ...
          elements: [
            {
              ...
              onChange: function () {
                var a = this.getDialog(),
                  ...
                  e = e && e.hidden;
                "url" == m
                  ? (g.config.linkShowTargetTab && a.showPage("target"),
                    e || a.showPage("upload"))
                  : (a.hidePage("target"), e || a.hidePage("upload"));
                for (e = 0; e < b.length; e++) {
                  var c = a.getContentElement("info", b[e]);
                  c &&
                    ((c = c.getElement().getParent().getParent()),
                    b[e] == m + "Options" ? c.show() : c.hide());
                }
                a.layout();
              },
              setup: function (a) {
                  ...
                  children: [
                    ...
                    },
                    {
                      ...
                      onKeyUp: function () {
                        ...
                        c
                          ? (this.setValue(b.substr(c[0].length)),
                            a.setValue(c[0].toLowerCase()))
                          : m.test(b) && a.setValue("");
                        this.allowOnChange = !0;
                      },
                      onChange: function () {
                      ...
                      validate: function () {
                        ...
                        return a.getContentElement("info", "linkType") &&
                          ...
                          ? !0
                          : !g.config.linkJavaScriptLinksAllowed &&
                            /javascript\:/.test(this.getValue())
                          ? (alert(c.invalidValue), !1)
                  ...
                  children: [
                    ...
                    },
                    {
                      ...
                      validate: CKEDITOR.dialog.validate.inlineStyle(
                        g.lang.common.invalidInlineStyle
                      ),
                      setup: h,
                      commit: l,
                    },
      ...
      onShow: function () {
        var a = this.getParentEditor(),
          b = a.getSelection(),
          c = null;
        (c = n.getSelectedLink(a)) && c.hasAttribute("href")
          ? b.getSelectedElement() || b.selectElement(c)
          : (c = null);
        a = n.parseLinkAttributes(a, c);
      ...
      onOk: function () {
        ...
        if (this._.selectedElement) {
          ...
          if (d == f || ("email" == a.type && -1 != f.indexOf("@")))
            e.setHtml(
          ...
          (b = b.getRanges()[0]),
            b.collapsed &&
              ((a = new CKEDITOR.dom.text(
                "email" == a.type
                  ? a.email.address
                  : c.set["data-cke-saved-href"],
                g.document
              )),
              b.insertNode(a),
              b.selectNodeContents(a)),
            (c = new CKEDITOR.style({ element: "a", attributes: c.set })),
