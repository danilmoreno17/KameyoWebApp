  ...
  function q(c, g) {
    ...
    u.prototype = {
      ...
      removeHighlight: function () {
        if (this._.highlightRange) {
          ...
          x.removeFromRange(this._.highlightRange, c);
      ...
      getNextCharacterRange: function (a) {
        var b, d;
        d = this._.cursors;
        d = (b = d[d.length - 1]) && b.textNode ? new n(q(b)) : this._.walker;
        return new u(d, a);
      },
      getCursors: function () {
    ...
    var D = /[.,"'?!;: \u0085\u00a0\u1680\u280e\u2028\u2029\u202f\u205f\u3000]/,
      A = function (a) {
        ...
        return (9 <= b && 13 >= b) || (8192 <= b && 8202 >= b) || D.test(a);
      },
      e = {
        searchRange: null,
        matchRange: null,
        find: function (a, b, d, f, e, E) {
          this.matchRange
          ...
          for (var k = new z(a, !b), l = 0, m = "%"; null !== m; ) {
            for (
              this.matchRange.moveNext();
              (m = this.matchRange.getEndCharacter());

            ) {
              l = k.feedCharacter(m);
              if (2 == l) break;
              this.matchRange.moveNext().hitMatchBoundary && k.reset();
            }
            if (2 == l) {
              if (d) {
                var h = this.matchRange.getCursors(),
                  p = h[h.length - 1],
                  h = h[0],
                  g = c.createRange();
                ...
                h = new n(h, !0);
                p = new n(p, !0);
                if (!A(h.back().character) || !A(p.next().character)) continue;
              }
        ...
        replaceCounter: 0,
        replace: function (a, b, d, f, e, g, k) {
          r = 1;
          a = 0;
          a = this.hasMatchOptionsChanged(b, f, e);
          if (
            !this.matchRange ||
            ...
            b.deleteContents();
            b.insertNode(d);
            k || (l.selectRanges([b]), c.fire("saveSnapshot"));
            this.matchRange.updateFromDomRange(b);
            k || this.matchRange.highlight();
    ...
    return {
              ...
              children: [
                ...
                },
                {
                  ...
                  onClick: function () {
                    ...
                    e.searchRange = t(1);
                    e.matchRange &&
                      (e.matchRange.removeHighlight(), (e.matchRange = null));
                    for (
                      c.fire("saveSnapshot");
                      e.replace(
                        a,
                    ...
                    e.replaceCounter
                      ? (alert(
                          f.replaceSuccessMsg.replace(/%1/, e.replaceCounter)
                        ),
                        c.fire("saveSnapshot"))
                      : alert(f.notFoundMsg);
                  },
        ...
        this.selectPage = CKEDITOR.tools.override(
          ...
          function (f) {
            return function (e) {
              ...
              var g = a._.tabs[e],
                k;
              k = "find" === e ? "txtFindWordChk" : "txtReplaceWordChk";
              b = a.getContentElement(
                e,
                "find" === e ? "txtFindFind" : "txtFindReplace"
              );
              a.getContentElement(e, k);
              g.initialized ||
                (CKEDITOR.document.getById(b._.inputId), (g.initialized = !0));
              if (c) {
                var l;
                e = "find" === e ? 1 : 0;
                var g = 1 - e,
                  ...
                  h = v.length;
                for (m = 0; m < h; m++)
                  (k = this.getContentElement(B[e], v[m][e])),
                    (l = this.getContentElement(B[g], v[m][g])),
      ...
      onShow: function () {
        e.searchRange = t();
        var a = this.getParentEditor().getSelection().getSelectedText(),
          b = this.getContentElement(
            g,
            "find" == g ? "txtFindFind" : "txtFindReplace"
          );
        b.setValue(a);
        b.select();
        this.selectPage(g);
        this[
          ("find" == g && this._.editor.readOnly ? "hide" : "show") + "Page"
        ]("replace");
      },
      onHide: function () {
        var a;
        e.matchRange &&
          e.matchRange.isMatched() &&
          (e.matchRange.removeHighlight(),
          c.focus(),
          (a = e.matchRange.toDomRange()) &&
