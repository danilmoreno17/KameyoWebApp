...
(function () {
  ...
  function p(a) {
    ...
    a.widgets.add("codeSnippet", {
      ...
      template:
        '\x3cpre\x3e\x3ccode class\x3d"' + b + '"\x3e\x3c/code\x3e\x3c/pre\x3e',
      dialog: "codeSnippet",
      ...
      data: function () {
        ...
        b &&
          a.lang != b.lang &&
          this.parts.code.removeClass("language-" + b.lang);
        a.lang &&
          (this.parts.code.addClass("language-" + a.lang), this.highlight());
      ...
      upcast: function (d, c) {
        if ("pre" == d.name) {
          for (var g = [], e = d.children, k, l = e.length - 1; 0 <= l; l--)
            (k = e[l]),
              (k.type == CKEDITOR.NODE_TEXT && k.value.match(q)) || g.push(k);
          var f;
          if (
            1 == g.length &&
            "code" == (f = g[0]).name &&
            1 == f.children.length &&
            f.children[0].type == CKEDITOR.NODE_TEXT
          ) {
            if ((g = a._.codesnippet.langsRegex.exec(f.attributes["class"])))
              c.lang = g[1];
            h.setHtml(f.getHtml());
            c.code = h.getValue();
            f.addClass(b);
      ...
      downcast: function (a) {
        ...
        c.add(
          new CKEDITOR.htmlParser.text(
            CKEDITOR.tools.htmlEncode(this.data.code)
          )
        );
        return a;
      },
  ...
  var n = !CKEDITOR.env.ie || 8 < CKEDITOR.env.version;
  CKEDITOR.plugins.add("codesnippet", {
    requires: "widget,dialog",
    lang: "ar,bg,ca,cs,da,de,de-ch,el,en,en-gb,eo,es,et,eu,fa,fi,fr,fr-ca,gl,he,hr,hu,id,it,ja,km,ko,ku,lt,lv,nb,nl,no,pl,pt,pt-br,ro,ru,sk,sl,sq,sv,th,tr,tt,ug,uk,vi,zh,zh-cn",
    icons: "codesnippet",
    hidpi: !0,
    ...
    afterInit: function (a) {
      var b = this.path;
      p(a);
      if (!a._.codesnippet.highlighter) {
  ...
  CKEDITOR.plugins.codesnippet = { highlighter: m };
  m.prototype.highlight = function () {
    var a = arguments;
    this.ready
