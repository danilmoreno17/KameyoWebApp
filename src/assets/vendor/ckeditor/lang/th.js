...
CKEDITOR.lang["th"] = {
  ...
  pastetext: { button: "วางแบบตัวอักษรธรรมดา", title: "วางแบบตัวอักษรธรรมดา" },
  pastefromword: {
    confirmCleanup:
  ...
  clipboard: {
    ...
    pasteMsg:
      "กรุณาใช้คีย์บอร์ดเท่านั้น โดยกดปุ๋ม (<strong>Ctrl/Cmd และ V</strong>)พร้อมๆกัน และกด <strong>OK</strong>.",
    securityMsg:
