...
CKEDITOR.lang["hi"] = {
  ...
  removeformat: { toolbar: "फ़ॉर्मैट हटायें" },
  pastetext: { button: "पेस्ट (सादा टॅक्स्ट)", title: "पेस्ट (सादा टॅक्स्ट)" },
  pastefromword: {
    confirmCleanup:
  ...
  maximize: { maximize: "मेक्सिमाईज़", minimize: "मिनिमाईज़" },
  ...
  horizontalrule: { toolbar: "हॉरिज़ॉन्टल रेखा इन्सर्ट करें" },
  format: {
    label: "फ़ॉर्मैट",
    panelTitle: "फ़ॉर्मैट",
    tag_address: "पता",
  ...
  clipboard: {
    ...
    securityMsg:
      "आपके ब्राउज़र की सुरक्षा आपके ब्राउज़र की सुरKश सैटिंग के कारण, एडिटर आपके क्लिपबोर्ड डेटा को नहीं पा सकता है. आपको उसे इस विन्डो में दोबारा पेस्ट करना होगा.",
    title: "पेस्ट",
  },
