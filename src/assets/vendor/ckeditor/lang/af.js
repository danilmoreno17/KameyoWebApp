...
CKEDITOR.lang["af"] = {
  ...
  removeformat: { toolbar: "Verwyder opmaak" },
  pastetext: {
  ...
  pastefromword: {
    confirmCleanup:
      "Die teks wat u wil plak lyk asof dit uit Word gekopiëer is. Wil u dit eers skoonmaak voordat dit geplak word?",
    error:
      "Die geplakte teks kon nie skoongemaak word nie, weens 'n interne fout",
    title: "Plak vanuit Word",
    toolbar: "Plak vanuit Word",
  },
  maximize: { maximize: "Maksimaliseer", minimize: "Minimaliseer" },
  magicline: { title: "Voeg paragraaf hier in" },
  ...
  elementspath: { eleLabel: "Elemente-pad", eleTitle: "%1 element" },
  contextmenu: { options: "Konteks Spyskaart-opsies" },
  clipboard: {
    copy: "Kopiëer",
    copyError:
      "U blaaier se sekuriteitsinstelling belet die kopiëringsaksie. Gebruik die sleutelbordkombinasie (Ctrl/Cmd+C).",
    cut: "Knip",
    cutError:
      "U blaaier se sekuriteitsinstelling belet die outomatiese knip-aksie. Gebruik die sleutelbordkombinasie (Ctrl/Cmd+X).",
    paste: "Plak",
    pasteArea: "Plak-area",
    pasteMsg:
      "Plak die teks in die volgende teks-area met die sleutelbordkombinasie (<STRONG>Ctrl/Cmd+V</STRONG>) en druk <STRONG>OK</STRONG>.",
    securityMsg:
      "Weens u blaaier se sekuriteitsinstelling is data op die knipbord nie toeganklik nie. U kan dit eers weer in hierdie venster plak.",
    title: "Byvoeg",
  },
  button: { selectedLabel: "%1 uitgekies" },
  ...
  common: {
    ...
    confirmNewPage:
      "Alle wysiginge sal verlore gaan. Is jy seker dat jy 'n nuwe bladsy wil laai?",
    confirmCancel:
