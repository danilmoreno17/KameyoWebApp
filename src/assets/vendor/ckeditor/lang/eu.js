...
CKEDITOR.lang["eu"] = {
  ...
  undo: { redo: "Berregin", undo: "Desegin" },
  toolbar: {
  ...
  specialchar: {
    ...
    title: "Hautatu karaktere berezia",
    toolbar: "Txertatu karaktere berezia",
  },
  sourcearea: { toolbar: "Iturburua" },
  scayt: {
  ...
  removeformat: { toolbar: "Kendu formatua" },
  pastetext: {
  ...
  indent: { indent: "Handitu koska", outdent: "Txikitu koska" },
  image: {
    alt: "Ordezko testua",
    border: "Ertza",
    btnUpload: "Bidali zerbitzarira",
    button2Img: "Hautatutako irudi-botoia irudi arrunt bihurtu nahi duzu?",
    hSpace: "HSpace",
    img2Button: "Hautatutako irudia irudi-botoi bihurtu nahi duzu?",
    ...
    titleButton: "Irudi-botoiaren propietateak",
    upload: "Kargatu",
  ...
  horizontalrule: { toolbar: "Txertatu marra horizontala" },
  format: {
    label: "Formatua",
  ...
  elementspath: { eleLabel: "Elementuen bidea", eleTitle: "%1 elementua" },
  contextmenu: { options: "Testuinguru-menuaren aukerak" },
  clipboard: {
    copy: "Kopiatu",
    copyError:
      "Zure web nabigatzailearen segurtasun ezarpenek ez dute baimentzen testuak automatikoki kopiatzea. Mesedez teklatua erabil ezazu (Ctrl/Cmd+C).",
    cut: "Ebaki",
    cutError:
      "Zure web nabigatzailearen segurtasun ezarpenek ez dute baimentzen testuak automatikoki moztea. Mesedez teklatua erabil ezazu (Ctrl/Cmd+X).",
    paste: "Itsatsi",
    pasteArea: "Itsasteko area",
    pasteMsg:
      "Mesedez teklatua erabiliz (<strong>Ctrl/Cmd+V</strong>) ondorengo eremuan testua itsatsi eta sakatu <strong>Ados</strong>.",
    securityMsg:
  ...
  button: { selectedLabel: "%1 (hautatuta)" },
  blockquote: { toolbar: "Aipamen blokea" },
  basicstyles: {
    bold: "Lodia",
    italic: "Etzana",
    strike: "Marratua",
  ...
  common: {
    ...
    confirmCancel:
      "Aukera batzuk aldatu dituzu. Ziur zaude elkarrizketa-koadroa itxi nahi duzula?",
    options: "Aukerak",
    target: "Helburua",
    ...
    invalidCssLength:
      '"%1" eremurako zehaztutako balioak zenbaki positibo bat izan behar du, CSS neurri unitate batekin edo gabe (px, %, in, cm, mm, em, ex, pt edo pc).',
    invalidHtmlLength:
      '"%1" eremurako zehaztutako balioak zenbaki positibo bat izan behar du, HTML neurri unitate batekin edo gabe (px edo %).',
    invalidInlineStyle:
      'Lineako estiloan zehaztutako balioak "izen : balio" formatuko tupla bat edo gehiago izan behar dira, komaz bereiztuak.',
    cssLengthTooltip:
      "Sartu zenbaki bat edo zenbaki bat baliozko CSS unitate batekin (px, %, in, cm, mm, em, ex, pt, edo pc).",
