...
CKEDITOR.lang["sr-latn"] = {
  ...
  undo: { redo: "Ponovi akciju", undo: "Poni�ti akciju" },
  toolbar: {
  ...
  list: { bulletedlist: "Nenabrojiva lista", numberedlist: "Nabrojiva lista" },
  link: {
  ...
  indent: { indent: "Uvećaj levu marginu", outdent: "Smanji levu marginu" },
  image: {
  ...
  clipboard: {
    ...
    pasteMsg:
      "Molimo Vas da zalepite unutar donje povrine koristeći tastaturnu prečicu (<STRONG>Ctrl/Cmd+V</STRONG>) i da pritisnete <STRONG>OK</STRONG>.",
    securityMsg:
      "Zbog sigurnosnih postavki vašeg pregledača, editor nije u mogućnosti da direktno pristupi podacima u klipbordu. Potrebno je da zalepite još jednom u ovom prozoru.",
    title: "Zalepi",
  },
