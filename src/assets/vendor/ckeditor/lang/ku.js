...
CKEDITOR.lang["ku"] = {
  ...
  clipboard: {
    ...
    pasteMsg:
      "تکایە بیلکێنە لەناوەوەی ئەم سنوقە لەڕێی تەختەکلیلەکەت بە بەکارهێنانی کلیلی (<STRONG>Ctrl/Cmd+V</STRONG>) دووای کلیکی باشە بکە.",
    securityMsg:
      "بەهۆی شێوەپێدانی پارێزی وێبگەڕەکەت، سەرنووسەکه ناتوانێت دەستبگەیەنێت بەهەڵگیراوەکە ڕاستەوخۆ. بۆیه پێویسته دووباره بیلکێنیت لەم پەنجەرەیه.",
    title: "لکاندن",
  },
  button: { selectedLabel: "%1 (هەڵبژێردراو)" },
