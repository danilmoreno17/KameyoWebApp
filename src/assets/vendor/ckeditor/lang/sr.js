...
CKEDITOR.lang["sr"] = {
  ...
  undo: { redo: "Понови акцију", undo: "Поништи акцију" },
  toolbar: {
  ...
  list: { bulletedlist: "Ненабројива листа", numberedlist: "Набројиву листу" },
  link: {
  ...
  indent: { indent: "Увећај леву маргину", outdent: "Смањи леву маргину" },
  image: {
    alt: "Алтернативни текст",
    border: "Оквир",
    btnUpload: "Пошаљи на сервер",
    button2Img:
      "Да ли желите да промените одабрану слику дугмета као једноставну слику?",
    hSpace: "HSpace",
  ...
  clipboard: {
    ...
    pasteMsg:
      "Молимо Вас да залепите унутар доње површине користећи тастатурну пречицу (<STRONG>Ctrl/Cmd+V</STRONG>) и да притиснете <STRONG>OK</STRONG>.",
    securityMsg:
      "Због сигурносних подешавања претраживача, едитор не може да приступи оставу. Требате да га поново залепите у овом прозору.",
    title: "Залепи",
  },
