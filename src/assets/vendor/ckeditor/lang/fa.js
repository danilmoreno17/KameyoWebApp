...
CKEDITOR.lang["fa"] = {
  wsc: {
    ...
    ieSpellDownload:
      "بررسی کنندهٴ املا نصب نشده است. آیا میخواهید آن را هماکنون دریافت کنید؟",
  ...
  removeformat: { toolbar: "برداشتن فرمت" },
  pastetext: {
  ...
  pastefromword: {
    confirmCleanup:
      "متنی که میخواهید بچسبانید به نظر میرسد که از Word کپی شده است. آیا میخواهید قبل از چسباندن آن را پاکسازی کنید؟",
    error:
      "به دلیل بروز خطای داخلی امکان پاکسازی اطلاعات بازنشانی شده وجود ندارد.",
    title: "چسباندن از Word",
    toolbar: "چسباندن از Word",
  },
  maximize: { maximize: "بیشنه کردن", minimize: "کمینه کردن" },
  magicline: { title: "قرار دادن بند در اینجا" },
  list: { bulletedlist: "فهرست نقطه​ای", numberedlist: "فهرست شماره​دار" },
  link: {
  ...
  image: {
    ...
    button2Img:
      "آیا مایلید از یک تصویر ساده روی دکمه تصویری انتخاب شده استفاده کنید؟",
    hSpace: "فاصلهٴ افقی",
    img2Button:
      "آیا مایلید از یک دکمه تصویری روی تصویر انتخاب شده استفاده کنید؟",
  ...
  horizontalrule: { toolbar: "گنجاندن خط افقی" },
  format: {
    label: "قالب",
    panelTitle: "قالب بند",
    tag_address: "نشانی",
  ...
  elementspath: { eleLabel: "مسیر عناصر", eleTitle: "%1 عنصر" },
  contextmenu: { options: "گزینه​های منوی زمینه" },
  clipboard: {
    copy: "رونوشت",
    copyError:
      "تنظیمات امنیتی مرورگر شما اجازه نمیدهد که ویرایشگر به طور خودکار عملکردهای کپی کردن را انجام دهد. لطفا با دکمههای صفحه کلید این کار را انجام دهید (Ctrl/Cmd+C).",
    cut: "برش",
    cutError:
      "تنظیمات امنیتی مرورگر شما اجازه نمیدهد که ویرایشگر به طور خودکار عملکردهای برش را انجام دهد. لطفا با دکمههای صفحه کلید این کار را انجام دهید (Ctrl/Cmd+X).",
    paste: "چسباندن",
    pasteArea: "محل چسباندن",
    pasteMsg:
      "لطفا متن را با کلیدهای (<STRONG>Ctrl/Cmd+V</STRONG>) در این جعبهٴ متنی بچسبانید و <STRONG>پذیرش</STRONG> را بزنید.",
    securityMsg:
      "به خاطر تنظیمات امنیتی مرورگر شما، ویرایشگر نمیتواند دسترسی مستقیم به دادههای clipboard داشته باشد. شما باید دوباره آنرا در این پنجره بچسبانید.",
    title: "چسباندن",
  },
  button: { selectedLabel: "%1 (انتخاب شده)" },
  blockquote: { toolbar: "بلوک نقل قول" },
  basicstyles: {
    bold: "درشت",
    italic: "خمیده",
    strike: "خط‌خورده",
  ...
  common: {
    ...
    confirmNewPage:
      "هر تغییر ایجاد شده​ی ذخیره نشده از بین خواهد رفت. آیا اطمینان دارید که قصد بارگیری صفحه جدیدی را دارید؟",
    confirmCancel:
      "برخی از گزینه‌ها تغییر کرده‌اند. آیا واقعا قصد بستن این پنجره را دارید؟",
    options: "گزینه​ها",
    target: "مقصد",
    ...
    invalidHtmlLength:
      'عدد تعیین شده برای فیلد "%1" باید یک عدد مثبت با یا بدون یک واحد اندازه گیری HTML معتبر باشد (px or %).',
    invalidInlineStyle:
      'عدد تعیین شده برای سبک درون​خطی -Inline Style- باید دارای یک یا چند چندتایی با شکلی شبیه "name : value" که باید با یک ";" از هم جدا شوند.',
    cssLengthTooltip:
      "یک عدد برای یک مقدار بر حسب پیکسل و یا یک عدد با یک واحد CSS معتبر وارد کنید (px, %, in, cm, mm, em, ex, pt, or pc).",
