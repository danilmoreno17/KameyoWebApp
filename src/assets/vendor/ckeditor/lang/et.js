...
CKEDITOR.lang["et"] = {
  ...
  undo: { redo: "Toimingu kordamine", undo: "Tagasivõtmine" },
  toolbar: {
  ...
  removeformat: { toolbar: "Vormingu eemaldamine" },
  pastetext: {
  ...
  maximize: { maximize: "Maksimeerimine", minimize: "Minimeerimine" },
  magicline: { title: "Sisesta siia lõigu tekst" },
  list: { bulletedlist: "Punktloend", numberedlist: "Numberloend" },
  link: {
  ...
  indent: { indent: "Taande suurendamine", outdent: "Taande vähendamine" },
  image: {
  ...
  horizontalrule: { toolbar: "Horisontaaljoone sisestamine" },
  format: {
    label: "Vorming",
    panelTitle: "Vorming",
    tag_address: "Aadress",
  ...
  elementspath: { eleLabel: "Elementide asukoht", eleTitle: "%1 element" },
  contextmenu: { options: "Kontekstimenüü valikud" },
  clipboard: {
    copy: "Kopeeri",
    copyError:
      "Sinu veebisirvija turvaseaded ei luba redaktoril automaatselt kopeerida. Palun kasutage selleks klaviatuuri klahvikombinatsiooni (Ctrl/Cmd+C).",
    cut: "Lõika",
    cutError:
      "Sinu veebisirvija turvaseaded ei luba redaktoril automaatselt lõigata. Palun kasutage selleks klaviatuuri klahvikombinatsiooni (Ctrl/Cmd+X).",
    paste: "Aseta",
    pasteArea: "Asetamise ala",
    pasteMsg:
      "Palun aseta tekst järgnevasse kasti kasutades klaviatuuri klahvikombinatsiooni (<STRONG>Ctrl/Cmd+V</STRONG>) ja vajuta seejärel <STRONG>OK</STRONG>.",
    securityMsg:
      "Sinu veebisirvija turvaseadete tõttu ei oma redaktor otsest ligipääsu lõikelaua andmetele. Sa pead asetama need uuesti siia aknasse.",
    title: "Asetamine",
  },
  button: { selectedLabel: "%1 (Selected)" },
  blockquote: { toolbar: "Blokktsitaat" },
  basicstyles: {
    bold: "Paks",
    italic: "Kursiiv",
    strike: "Läbijoonitud",
  ...
  common: {
    ...
    invalidCssLength:
      '"%1" välja jaoks määratud väärtus peab olema positiivne täisarv CSS ühikuga (px, %, in, cm, mm, em, ex, pt või pc) või ilma.',
    invalidHtmlLength:
      '"%1" välja jaoks määratud väärtus peab olema positiivne täisarv HTML ühikuga (px või %) või ilma.',
    invalidInlineStyle:
      'Reasisese stiili määrangud peavad koosnema paarisväärtustest (tuples), mis on semikoolonitega eraldatult järgnevas vormingus: "nimi : väärtus".',
    cssLengthTooltip:
      "Sisesta väärtus pikslites või number koos sobiva CSS-i ühikuga (px, %, in, cm, mm, em, ex, pt või pc).",
