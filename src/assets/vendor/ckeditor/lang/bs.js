...
CKEDITOR.lang["bs"] = {
  ...
  removeformat: { toolbar: "Poništi format" },
  pastetext: {
  ...
  list: { bulletedlist: "Lista", numberedlist: "Numerisana lista" },
  link: {
  ...
  horizontalrule: { toolbar: "Ubaci horizontalnu liniju" },
  format: {
    label: "Format",
    panelTitle: "Format",
    tag_address: "Address",
  ...
  clipboard: {
    copy: "Kopiraj",
    copyError:
      "Sigurnosne postavke Vašeg pretraživaèa ne dozvoljavaju operacije automatskog kopiranja. Molimo koristite kraticu na tastaturi (Ctrl/Cmd+C).",
    cut: "Izreži",
    cutError:
      "Sigurnosne postavke vašeg pretraživaèa ne dozvoljavaju operacije automatskog rezanja. Molimo koristite kraticu na tastaturi (Ctrl/Cmd+X).",
    paste: "Zalijepi",
