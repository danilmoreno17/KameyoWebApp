...
CKEDITOR.lang["he"] = {
  ...
  pastetext: { button: "הדבקה כטקסט פשוט", title: "הדבקה כטקסט פשוט" },
  pastefromword: {
    confirmCleanup:
  ...
  clipboard: {
    ...
    pasteMsg:
      "נא להדביק בתוך הקופסה באמצעות (<b>Ctrl/Cmd+V</b>) וללחוץ על <b>אישור</b>.",
    securityMsg:
      "עקב הגדרות אבטחה בדפדפן, לא ניתן לגשת אל לוח הגזירים (Clipboard) בצורה ישירה. נא להדביק שוב בחלון זה.",
    title: "הדבקה",
  },
  button: { selectedLabel: "1% (סומן)" },
