...
CKEDITOR.lang["sl"] = {
  ...
  clipboard: {
    ...
    pasteMsg:
      "Prosimo, prilepite v sleči okvir s pomočjo tipkovnice (<strong>Ctrl/Cmd+V</strong>) in pritisnite V redu.",
    securityMsg:
      "Zaradi varnostnih nastavitev vašega brskalnika urejevalnik ne more neposredno dostopati do odložišča. Vsebino odložišča ponovno prilepite v to okno.",
    title: "Prilepi",
  },
  button: { selectedLabel: "%1 (Izbrano)" },
