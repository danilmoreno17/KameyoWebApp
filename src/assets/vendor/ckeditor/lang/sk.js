...
CKEDITOR.lang["sk"] = {
  ...
  clipboard: {
    ...
    pasteMsg:
      "Použitím klávesnice (<STRONG>Ctrl/Cmd+V</STRONG>) vložte text do rámčeka a stlačte OK.",
    securityMsg:
      "Kvôli bezpečnostným nastaveniam vášho prehliadača editor nemôže pristupovať k schránke na kopírovanie priamo. Vložte to preto do tohto okna.",
    title: "Vložiť",
  },
  button: { selectedLabel: "%1 (Vybrané)" },
