...
CKEDITOR.lang["it"] = {
  ...
  clipboard: {
    ...
    pasteArea: "Incolla",
    pasteMsg:
      "Incolla il testo all'interno dell'area sottostante usando la scorciatoia di tastiere (<STRONG>Ctrl/Cmd+V</STRONG>) e premi <STRONG>OK</STRONG>.",
    securityMsg:
  ...
  button: { selectedLabel: "%1 (selezionato)" },
