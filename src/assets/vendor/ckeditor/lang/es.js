...
CKEDITOR.lang["es"] = {
  ...
  sourcearea: { toolbar: "Fuente HTML" },
  scayt: {
  ...
  magicline: { title: "Insertar párrafo aquí" },
  ...
  clipboard: {
    ...
    pasteMsg:
      "Por favor pegue dentro del cuadro utilizando el teclado (<STRONG>Ctrl/Cmd+V</STRONG>);\r\nluego presione <STRONG>Aceptar</STRONG>.",
    securityMsg:
      "Debido a la configuración de seguridad de su navegador, el editor no tiene acceso al portapapeles.\r\nEs necesario que lo pegue de nuevo en esta ventana.",
    title: "Pegar",
  },
  button: { selectedLabel: "%1 (Seleccionado)" },
