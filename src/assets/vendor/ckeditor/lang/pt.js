...
CKEDITOR.lang["pt"] = {
  ...
  pastefromword: {
    confirmCleanup:
      "O texto que pretende colar parece ter sido copiado do Word. Deseja limpá-lo antes de colar?",
    error:
      "Não foi possivel limpar a informação colada decido a um erro interno.",
    title: "Colar do Word",
  ...
  image: {
    ...
    button2Img:
      "Deseja transformar o botão com imagem selecionado em uma imagem?",
    hSpace: "Esp. Horiz",
    img2Button:
      "Deseja transformar a imagem selecionada em um botão com imagem?",
  ...
  clipboard: {
    ...
    pasteMsg:
      "Por favor, cole dentro da seguinte caixa usando o teclado (<STRONG>Ctrl/Cmd+V</STRONG>) e carregue em <STRONG>OK</STRONG>.",
    securityMsg:
      "Devido ás definições de segurança do teu browser, o editor não pode aceder ao clipboard diretamente. É necessário que voltes a colar as informações nesta janela.",
    title: "Colar",
  },
  ...
  common: {
    ...
    cssLengthTooltip:
      "Insira um número para um valor em pontos ou um número com uma unidade CSS válida (px, %, in, cm, mm, em, ex, pt, ou pc).",
