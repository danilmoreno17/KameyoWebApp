...
CKEDITOR.lang["sq"] = {
  ...
  clipboard: {
    ...
    pasteMsg:
      "Ju lutemi hidhni brenda kutizës në vijim duke shfrytëzuar tastierën (<strong>Ctrl/Cmd+V</strong>) dhe shtypni Mirë.",
    securityMsg:
      "Për shkak të dhënave të sigurisë së shfletuesit tuaj, redaktuesi nuk është në gjendje të i qaset drejtpërdrejtë të dhanve të tabelës suaj të punës. Ju duhet të hidhni atë përsëri në këtë dritare.",
    title: "Hidhe",
  },
  ...
  common: {
    ...
    confirmNewPage:
      "Çdo ndryshim që nuk është ruajtur do humbasë. Je i sigurtë që dëshiron të krijosh një faqe të re?",
    confirmCancel:
      "Disa opsione kanë ndryshuar. Je i sigurtë që dëshiron ta mbyllësh dritaren?",
    options: "Opsione",
    target: "Objektivi",
    ...
    invalidInlineStyle:
      'Stili inline duhet të jetë një apo disa vlera të formatit "emër: vlerë", ndarë nga pikëpresje.',
    cssLengthTooltip:
      "Fut një numër për vlerën në pixel apo një numër me një njësi të vlefshme CSS (px, %, in, cm, mm, ex, pt, ose pc).",
