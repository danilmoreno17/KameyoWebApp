...
CKEDITOR.lang["ro"] = {
  ...
  elementspath: { eleLabel: "Calea elementelor", eleTitle: "%1 element" },
  ...
  clipboard: {
    ...
    pasteMsg:
      "Vă rugăm adăugaţi în căsuţa următoare folosind tastatura (<strong>Ctrl/Cmd+V</strong>) şi apăsaţi OK",
    securityMsg:
      "Din cauza setărilor de securitate ale programului dvs. cu care navigaţi pe internet (browser), editorul nu poate accesa direct datele din clipboard. Va trebui să adăugaţi din nou datele în această fereastră.",
    title: "Adaugă",
  },
  button: { selectedLabel: "%1 (Selectat)" },
  ...
  about: {
    ...
    moreInfo:
      "Pentru informații despre licență, vă rugăm vizitați web site-ul nostru:",
  ...
  common: {
    ...
    confirmCancel:
      "Câteva opțiuni au fost schimbate. Sigur doriți să închideți dialogul?",
    options: "Opțiuni",
    target: "Țintă",
    ...
    invalidCssLength:
      'Valoarea specificată pentru câmpul "%1" trebuie să fie un număr pozitiv cu sau fără o unitate de măsură CSS (px, %, in, cm, mm, em, ex, pt, sau pc).',
    invalidHtmlLength:
      'Valoarea specificată pentru câmpul "%1" trebuie să fie un număr pozitiv cu sau fără o unitate de măsură HTML (px sau %).',
    invalidInlineStyle:
    ...
    cssLengthTooltip:
      "Introduceți un număr în pixeli sau un număr cu o unitate de măsură CSS (px, %, in, cm, mm, em, ex, pt, sau pc).",
    unavailable:
