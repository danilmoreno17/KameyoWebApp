...
CKEDITOR.lang["mk"] = {
  ...
  pastetext: { button: "Paste as plain text", title: "Paste as Plain Text" },
  pastefromword: {
    confirmCleanup:
  ...
  clipboard: {
    ...
    pasteMsg:
      "Ве молиме да залепите во следниот квадрат користејќи ја тастатурата (<string>Ctrl/Cmd+V</string>) и да притиснете OK",
    securityMsg:
      "Опциите за безбедност на вашиот прелистувач не дозволуваат уредувачот директно да пристапи до копираните податоци. Потребно е повторно да се обидете во овој прозорец.",
    title: "Залепи (Paste)",
  },
