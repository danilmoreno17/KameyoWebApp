...
CKEDITOR.lang["fr"] = {
  ...
  clipboard: {
    ...
    pasteMsg:
      "Veuillez coller le texte dans la zone suivante en utilisant le raccourci clavier (<strong>Ctrl/Cmd+V</strong>) et cliquez sur OK.",
    securityMsg:
  ...
  button: { selectedLabel: "%1 (Sélectionné)" },
