...
CKEDITOR.lang["gu"] = {
  ...
  pastetext: { button: "પેસ્ટ (ટેક્સ્ટ)", title: "પેસ્ટ (ટેક્સ્ટ)" },
  pastefromword: {
    confirmCleanup:
  ...
  clipboard: {
    ...
    securityMsg:
      "તમારા બ્રાઉઝર ની સુરક્ષિત સેટિંગસના કારણે,એડિટર તમારા કિલ્પબોર્ડ ડેટા ને કોપી નથી કરી શકતો. તમારે આ વિન્ડોમાં ફરીથી પેસ્ટ કરવું પડશે.",
    title: "પેસ્ટ",
  },
