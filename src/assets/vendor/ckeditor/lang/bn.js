...
CKEDITOR.lang["bn"] = {
  ...
  undo: { redo: "পুনরায়  করি", undo: "আনডু" },
  toolbar: {
  ...
  removeformat: { toolbar: "ধরন-প্রকৃতি অপসারণ করি" },
  pastetext: {
  ...
  indent: { indent: "ইনডেন্ট বাড়াই", outdent: "ইনডেন্ট কমাও" },
  image: {
    alt: "বিকল্প টেক্সট",
    border: "বর্ডার",
  ...
  horizontalrule: { toolbar: "অনুভূমিক লাইন যোগ করি" },
  format: {
    label: "ধরন-প্রকৃতি",
  ...
  clipboard: {
    copy: "কপি",
    copyError:
      "আপনার ব্রাউজারের নিরাপত্তা সেটিংসমূহ এডিটরকে স্বয়ংক্রিয়ভাবে কপি করার প্রক্রিয়া চালনা করার অনুমতি দেয় না। অনুগ্রহপূর্বক এই কাজের জন্য কিবোর্ড ব্যবহার করুন (Ctrl/Cmd+C)।",
    cut: "কাট",
    cutError:
      "আপনার ব্রাউজারের সুরক্ষা সেটিংস এডিটরকে অটোমেটিক কাট করার অনুমতি দেয়নি। দয়া করে এই কাজের জন্য কিবোর্ড ব্যবহার করুন (Ctrl/Cmd+X)।",
    paste: "পেস্ট",
    pasteArea: "Paste Area",
    pasteMsg:
      "অনুগ্রহ করে নীচের বাক্সে কিবোর্ড ব্যবহার করে (<STRONG>Ctrl/Cmd+V</STRONG>) পেস্ট করুন এবং <STRONG>OK</STRONG> চাপ দিন",
    securityMsg:
