...
CKEDITOR.lang["zh"] = {
  ...
  pastetext: { button: "貼成純文字", title: "貼成純文字" },
  pastefromword: {
    confirmCleanup:
  ...
  clipboard: {
    ...
    pasteArea: "貼上區",
    pasteMsg:
      "請使用鍵盤快捷鍵 (<strong>Ctrl/Cmd+V</strong>) 貼到下方區域中並按下「確定」。",
    securityMsg:
      "因為瀏覽器的安全性設定，本編輯器無法直接存取您的剪貼簿資料，請您自行在本視窗進行貼上動作。",
    title: "貼上",
  },
  button: { selectedLabel: "%1 (已選取)" },
