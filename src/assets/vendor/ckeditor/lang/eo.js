...
CKEDITOR.lang["eo"] = {
  ...
  pastefromword: {
    confirmCleanup:
      "La teksto, kiun vi volas interglui, ŝajnas esti kopiita el Word. Ĉu vi deziras purigi ĝin antaŭ intergluo?",
    error: "Ne eblis purigi la intergluitajn datenojn pro interna eraro",
    title: "Interglui el Word",
    toolbar: "Interglui el Word",
  },
  maximize: { maximize: "Pligrandigi", minimize: "Malgrandigi" },
  magicline: { title: "Enmeti paragrafon ĉi-tien" },
  list: { bulletedlist: "Bula Listo", numberedlist: "Numera Listo" },
  link: {
  ...
  horizontalrule: { toolbar: "Enmeti Horizontalan Linion" },
  format: {
    label: "Formato",
  ...
  elementspath: { eleLabel: "Vojo al Elementoj", eleTitle: "%1 elementoj" },
  contextmenu: { options: "Opcioj de Kunteksta Menuo" },
  clipboard: {
    copy: "Kopii",
    copyError:
      "La sekurecagordo de via TTT-legilo ne permesas, ke la redaktilo faras kopiajn operaciojn. Bonvolu uzi la klavaron por tio (Ctrl/Cmd-C).",
    cut: "Eltondi",
    cutError:
      "La sekurecagordo de via TTT-legilo ne permesas, ke la redaktilo faras eltondajn operaciojn. Bonvolu uzi la klavaron por tio (Ctrl/Cmd-X).",
    paste: "Interglui",
    pasteArea: "Intergluoareo",
    pasteMsg:
      "Bonvolu glui la tekston en la jenan areon per uzado de la klavaro (<strong>Ctrl/Cmd+V</strong>) kaj premu OK",
    securityMsg:
      "Pro la sekurecagordo de via TTT-legilo, la redaktilo ne povas rekte atingi viajn datenojn en la poŝo. Bonvolu denove interglui la datenojn en tiun fenestron.",
    title: "Interglui",
  },
  button: { selectedLabel: "%1 (Selektita)" },
  blockquote: { toolbar: "Citaĵo" },
  basicstyles: {
    bold: "Grasa",
    italic: "Kursiva",
    strike: "Trastreko",
  ...
  common: {
    ...
    invalidCssLength:
      'La valoro indikita por la "%1" kampo devas esti pozitiva nombro kun aŭ sen valida CSSmezurunuo (px, %, in, cm, mm, em, ex, pt, or pc).',
    invalidHtmlLength:
      'La valoro indikita por la "%1" kampo devas esti pozitiva nombro kun aŭ sen valida HTMLmezurunuo (px or %).',
    invalidInlineStyle:
      'La valoro indikita por la enlinia stilo devas konsisti el unu aŭ pluraj elementoj kun la formato de "nomo : valoro", apartigitaj per punktokomoj.',
    cssLengthTooltip:
      "Entajpu nombron por rastrumera valoro aŭ nombron kun valida CSSunuo (px, %, in, cm, mm, em, ex, pt, or pc).",
