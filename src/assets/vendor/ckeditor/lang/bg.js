...
CKEDITOR.lang["bg"] = {
  ...
  undo: { redo: "Връщане на предишен статус", undo: "Възтанови" },
  toolbar: {
  ...
  sourcearea: { toolbar: "Изходен код" },
  scayt: {
  ...
  removeformat: { toolbar: "Премахване на форматирането" },
  pastetext: {
  ...
  horizontalrule: { toolbar: "Вмъкване на хоризонтална линия" },
  format: {
    label: "Формат",
    panelTitle: "Формат",
    tag_address: "Адрес",
  ...
  elementspath: { eleLabel: "Път за елементите", eleTitle: "%1 елемент" },
  contextmenu: { options: "Опции на контекстното меню" },
  clipboard: {
    copy: "Копирай",
    copyError:
      "Настройките за сигурност на вашия бразуър не разрешават на редактора да изпълни запаметяването. За целта използвайте клавиатурата (Ctrl/Cmd+C).",
    cut: "Отрежи",
    cutError:
      "Настройките за сигурност на Вашия браузър не позволяват на редактора автоматично да изъплни действията за отрязване. Моля ползвайте клавиатурните команди за целта (ctrl+x).",
    paste: "Вмъкни",
    pasteArea: "Зона за вмъкване",
    pasteMsg:
      "Вмъкнете тук съдъжанието с клавиатуарата (<STRONG>Ctrl/Cmd+V</STRONG>) и натиснете <STRONG>OK</STRONG>.",
    securityMsg:
      "Заради настройките за сигурност на Вашия браузър, редакторът не може да прочете данните от клипборда коректно.",
    title: "Вмъкни",
  },
  ...
  common: {
    ...
    confirmNewPage:
      "Всички незапазени промени ще бъдат изгубени. Сигурни ли сте, че желаете да заредите нова страница?",
    confirmCancel:
      "Някои от опциите са променени. Сигурни ли сте, че желаете да затворите прозореца?",
    options: "Опции",
    target: "Цел",
    ...
    invalidCssLength:
      'Стойността на полето "%1" трябва да бъде положително число с или без валидна CSS измервателна единица (px, %, in, cm, mm, em, ex, pt, или pc).',
    invalidHtmlLength:
      'Стойността на полето "%1" трябва да бъде положително число с или без валидна HTML измервателна единица (px или %).',
    invalidInlineStyle:
      'Стойността на стилa трябва да съдържат една или повече двойки във формат "name : value", разделени с двоеточие.',
    cssLengthTooltip:
      "Въведете числена стойност в пиксели или друга валидна CSS единица (px, %, in, cm, mm, em, ex, pt, или pc).",
