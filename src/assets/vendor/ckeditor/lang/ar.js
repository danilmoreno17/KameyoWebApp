...
CKEDITOR.lang["ar"] = {
  ...
  removeformat: { toolbar: "إزالة التنسيقات" },
  pastetext: { button: "لصق كنص بسيط", title: "لصق كنص بسيط" },
  pastefromword: {
    confirmCleanup:
  ...
  magicline: { title: "إدراج فقرة هنا" },
  list: {
  ...
  elementspath: { eleLabel: "مسار العنصر", eleTitle: "عنصر 1%" },
