...
CKEDITOR.lang["ko"] = {
  ...
  pastetext: { button: "텍스트로 붙여넣기", title: "텍스트로 붙여넣기" },
  pastefromword: {
    confirmCleanup:
  ...
  clipboard: {
    ...
    pasteArea: "붙여넣기 범위",
    pasteMsg:
      "키보드(<strong>Ctrl/Cmd+V</strong>)를 이용해서 상자안에 붙여넣고 <strong>확인</strong> 를 누르세요.",
    securityMsg:
      "브라우저 보안 설정으로 인해, 클립보드에 직접 접근할 수 없습니다. 이 창에 다시 붙여넣기 하십시오.",
    title: "붙여넣기",
  },
  button: { selectedLabel: "%1 (선택됨)" },
