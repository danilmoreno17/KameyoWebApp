  ...
  <div id="main-content">
    <div class="container-fluid">
      ...
      <div class="row clearfix">
        <div
          v-for="basicLine in iotLineChartDetails"
          :key="basicLine.title"
          class="col-lg-4 col-md-4 col-md-12"
        >
          <analitical-data
      ...
      <div class="row clearfix">
        <div
          v-for="system in systemToggle"
          :key="system.title"
          class="col-lg-6 col-md-6 col-md-12"
        >
          <system-widget
            :title="system.title"
      ...
      <div class="row clearfix">
        <div
          v-for="appliances in appliancStatusWidget"
          :key="appliances.title"
      ...
      <div class="row clearfix">
        <div
          v-for="lightsdetail in lightsIndoorDetail"
          :key="lightsdetail.title"
          class="col-lg-4 col-md-4 col-sm-12"
        >
          <appliances-widget
            ...
            data: [
              {
                value: 70,
                name: "Night 70%",
                itemStyle: { color: "rgb(247, 187, 199)" },
              },
              {
                value: 30,
                name: "Day 30%",
                itemStyle: { color: "rgb(176, 221, 145)" },
              },
            ],
          },
        ],
