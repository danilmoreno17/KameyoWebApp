          ...
          <div class="card">
            <div class="body">
              <button
                ...
                @click="openModal"
                v-click-outside="openModalOutside"
              >
                Add New Event
              </button>
            </div>
