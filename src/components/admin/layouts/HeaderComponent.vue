  ...
  <nav class="navbar navbar-fixed-top">
    <div class="container-fluid">
      ...
      <div class="navbar-brand">
        <router-link to="/dashboard/index" v-if="toggleSidebarTheme == ''"
          ><img
            src="../../../assets/logo.svg"
            alt="Lucid Logo"
        ...
        <router-link
          to="/dashboard/index"
          v-if="toggleSidebarTheme == 'full-dark'"
          ><img
      ...
      <div class="navbar-right">
        ...
        <div id="navbar-menu">
          <ul class="nav navbar-nav">
            <!-- <li>
              <router-link
                to="/file-manager/file-documents"
            ...
            <li
              class="dropdown"
              v-bind:class="{ show: notificationMenu }"
            ...
            >
              ...
              <ul
                ...
                v-bind:class="{ show: notificationMenu }"
                :style="notificationMenu ? 'top: 100%;' : 'top: 80%;'"
              >
                <li class="header">
            ...
            >
              ...
              ></a>
              <ul
                class="dropdown-menu user-menu menu-icon"
                v-bind:class="{ show: dropActive }"
                :style="dropActive ? 'top: 100%;' : 'top: 80%;'"
              >
                <li class="menu-heading">ACCOUNT SETTINGS</li>
                <li>
                  <a href="javascript:void(0);"
                    ><i class="icon-note"></i> <span>Basic</span></a
                  >
                </li>
                <li>
                  <a href="javascript:void(0);"
                    ><i class="icon-equalizer"></i> <span>Preferences</span></a
                  >
                </li>
                <li>
                  <a href="javascript:void(0);"
                    ><i class="icon-lock"></i> <span>Privacy</span></a
                  >
                </li>
                <li>
                  <a href="javascript:void(0);"
                    ><i class="icon-bell"></i> <span>Notifications</span></a
                  >
                </li>
                <li class="menu-heading">BILLING</li>
                <li>
                  <a href="javascript:void(0);"
                    ><i class="icon-credit-card"></i> <span>Payments</span></a
                  >
                </li>
                <li>
                  <a href="javascript:void(0);"
                    ><i class="icon-printer"></i> <span>Invoices</span></a
                  >
                </li>
                <li>
                  <a href="javascript:void(0);"
                    ><i class="icon-refresh"></i> <span>Renewals</span></a
                  >
                </li>
              </ul>
            </li>
